...
,
    ...
    /* ---------- 7. Waiting for the Mahdi ---------- */
    {
      ...
      title: "Waiting for the Mahdi — and what the waiting has cost us",
      titleAr: "انتظارُ المهديّ — وما كلّفنا هذا الانتظار",
      lead: "This section is not about whether he comes. That question has its own honest entry on the Day of Judgement page — what is in Sahih Muslim, what is only in Abu Dawud and at-Tirmidhi, where Ibn Khaldun disagreed, and which of the famous details have no chain at all.\n\nThis section is about a **habit of mind** that has grown up beside the belief and is not part of it: that the repair of this ummah is somebody else's job, arriving on a date nobody knows, and that until then there is nothing to be done. That habit is not in any narration. And it is doing more damage than any enemy.",
      leadAr: "ليس هذا القسم في هل يخرج أم لا. فتلك مسألةٌ لها مدخلها المحرَّر في صفحة يوم القيامة: ما في صحيح مسلم، وما هو عند أبي داود والترمذي وحدهما، وأين خالف ابن خلدون، وأيُّ التفاصيل المشهورة لا إسناد له البتّة.\n\nوإنما هذا القسم في **عادةٍ ذهنيّة** نبتت إلى جانب الاعتقاد وليست منه: أنّ إصلاح هذه الأمّة عملُ غيرِنا، يأتي في يومٍ لا يعلمه أحد، وأنه لا شيء يُصنع حتى يأتي. وليست هذه العادة في خبرٍ من الأخبار. وهي تصنع بنا ما لا يصنعه عدوّ.",

      answer: "Nothing in any Mahdi narration says to stop working. Read them and the opposite is there: people go to him, take him out while he is unwilling, and pledge allegiance to him — which means a community was already standing, already organised, already willing, before he appeared. He is given to a people who are doing something. And when Isa عليه السلام descends in Sahih Muslim, he finds the imam of the Muslims already leading the prayer, and refuses to take his place. At the very end of all of it, ordinary Muslims are still doing ordinary work. The Prophet ﷺ himself — whose supplication was answered — still dug the trench, still wore armour, still sent scouts, still signed a treaty. If HIS asking needed the work beside it, ours does not need it less.",
      answerAr: "ليس في خبرٍ من أخبار المهديّ أن تُوقف العمل. بل اقرأها تجد ضدّه: يأتيه الناسُ فيُخرجونه وهو كاره فيبايعونه — ومعناه أنّ جماعةً كانت قائمةً منتظمةً راضيةً قبل ظهوره. فهو يُساق إلى قومٍ يعملون. وإذا نزل عيسى عليه السلام في صحيح مسلم وجد إمام المسلمين يصلّي بهم فأبى أن يتقدّمه. ففي آخر الأمر كلِّه مسلمون عاديّون يعملون عملًا عاديًّا. والنبيُّ ﷺ — وهو المستجابُ دعاؤه — حفر الخندق، ولبس الدرع، وبثّ العيون، وكتب الصلح. فإذا كان **سؤالُه** يحتاج إلى العمل معه، فسؤالُنا ليس أغنى عنه.",

      cards: [
        {
          id: "ms-wt-textsays",
          title: "Read the narrations again — they describe a community that is already standing",
          titleAr: "أعِد قراءة الأخبار — إنما تصف جماعةً قائمةً من قبل",
          body: "This is the part that is almost never quoted, and it is in the same narration everyone quotes from.\n\nIn Umm Salamah's report: **people come to him, take him out while he is unwilling, and pledge allegiance to him** between the Rukn and the Maqam. Every verb in that sentence has the people as its subject and him as its object. They go. They find him. They bring him out. He does not want it.\n\nHe does not raise the community. **The community raises him.**\n\nAnd it goes further. In Sahih Muslim, when Isa عليه السلام descends, the imam of the Muslims is **already leading the prayer** — and Isa refuses to lead it, and prays behind him. Think about what that scene requires: at the very end of history, there is a functioning congregation, in a mosque, with a leader in front of it, and the prayer is on time.\n\nSo the narrations do not describe a rescue. They describe a **handover** — and a handover needs someone standing there to hand it to.\n\n**Which turns the whole question around.** Not: when will he come? But: **if he came this year, what exactly would he find here?** People who had built something, trained something, learned something, held something together — or people who had spent forty years waiting?",
          bodyAr: "وهذا الموضع لا يكاد يُنقل، وهو في الرواية نفسها التي ينقل الناس منها.\n\nفي حديث أمّ سلمة: **يأتيه الناسُ فيُخرجونه وهو كاره فيبايعونه** بين الركن والمقام. وكلُّ فعلٍ في هذه الجملة فاعله الناس ومفعوله هو: يأتون، ويجدونه، ويُخرجونه، وهو لا يريد.\n\nفليس هو الذي يُقيم الجماعة. **بل الجماعةُ هي التي تُقيمه.**\n\nوثمّ ما هو أبلغ. ففي صحيح مسلم أنّ عيسى عليه السلام إذا نزل وجد إمام المسلمين **قائمًا يصلّي بهم**، فيأبى أن يتقدّم، ويصلّي خلفه. فتأمّل ما يقتضيه هذا المشهد: أنّ في آخر التاريخ جماعةً قائمة، في مسجد، لها إمامٌ بين يديها، والصلاة في وقتها.\n\nفالأخبارُ إذن لا تصف إنقاذًا، وإنما تصف **تسليمًا** — والتسليمُ يحتاج إلى من يقف ليُسلَّم إليه.\n\n**وهذا يقلب السؤال كلَّه.** فليس: متى يأتي؟ بل: **لو جاء هذا العام، فماذا كان سيجد ههنا بالضبط؟** أقومًا بنَوا شيئًا ودرّبوا شيئًا وتعلّموا شيئًا وحفظوا شيئًا مجتمعًا، أم قومًا أنفقوا أربعين سنةً في الانتظار؟",
          plain: "In plain words: the narrations say people go and find him and pledge to him while he does not want the job. So there is already a community there, organised enough to do that. He does not build them — they bring him. The question is not when he arrives. It is what he would find here if he did.",
          plainAr: "بعبارة أخرى: في الأخبار أنّ الناس يأتونه فيُخرجونه وهو كاره فيبايعونه. فثمّ جماعةٌ قائمةٌ من قبل، منتظمةٌ بقدر ما تصنع ذلك. فليس هو الذي يبنيهم، بل هم الذين يأتون به. فليس السؤال متى يأتي، وإنما ماذا كان سيجد ههنا لو جاء.",
          ref: "Sunan Abu Dawud 4286 — Umm Salamah; Sahih Muslim, Book of Faith — Isa praying behind the imam of the Muslims. See \"The awaited Mahdi\" on the Day of Judgement page for the full grading",
          refAr: "سنن أبي داود ٤٢٨٦ — عن أمّ سلمة؛ وصحيح مسلم، كتاب الإيمان — في صلاة عيسى خلف إمام المسلمين. وانظر «المهديّ المنتظَر» في صفحة يوم القيامة لتحرير الدرجات",
          strength: "Sahih for Muslim; the Mahdi narration is outside the two Sahihs — see the Day of Judgement page",
          strengthAr: "صحيحٌ ما عند مسلم؛ وحديثُ المهديّ خارج الصحيحين — انظر صفحة يوم القيامة"
        },
        {
          id: "ms-wt-prophet",
          title: "The one man whose supplication was answered still dug the trench",
          titleAr: "الرجلُ الوحيد المستجابُ دعاؤه حفر الخندق",
          body: "This is the argument that ends the discussion, and it needs no scholar to follow it.\n\nTake the person whose asking was answered — actually answered, without doubt. He asked Allah for victory at Badr until his cloak fell from his shoulders. And then look at what that same man **also** did:\n\n• At Badr he chose the ground, took the wells, and set the ranks with an arrow in his hand.\n• At Uhud he **wore two coats of mail**, and put fifty archers on a hill with an order not to leave it.\n• At the Trench he took a suggestion from a Persian companion and **had a ditch dug around the city** — men digging in cold and hunger, with stones tied to their stomachs.\n• Going to Madinah he **hired a guide who was not yet a Muslim**, hid in a cave for three nights, and sent someone to sweep the tracks behind them.\n• At Hudaybiyyah he **signed terms his own companions found bitter**, because the calculation was right.\n\nNone of that is the behaviour of a man who thought asking was enough. And he is the one whose asking was **certainly** heard.\n\nSo put the question the way it actually stands: **do we think our supplication is stronger than his?** Because if his needed the digging, the armour, the guide and the treaty beside it, then a man sitting still and raising his hands is not doing what the Prophet ﷺ did. He is doing half of it and calling it religion.\n\nAnd there is a hadith that settles the principle in three words. A man asked: shall I tie my camel and rely on Allah, or leave it loose and rely on Allah? He ﷺ said: **\"Tie it, and rely.\"** Not instead of. **And.**",
          bodyAr: "وهذه هي الحجّة التي تُنهي الكلام، ولا تحتاج إلى عالمٍ ليفهمها.\n\nخذ من كان دعاؤه مستجابًا — مستجابًا حقًّا بلا شكّ. فقد استنصر ربّه يوم بدرٍ حتى سقط رداؤه عن منكبيه. ثم انظر ماذا فعل ذلك الرجل نفسُه **أيضًا**:\n\n• في بدرٍ اختار المنزل، وسبق إلى الماء، وسوّى الصفوف بيده وفي يده قِدْح.\n• وفي أحدٍ **ظاهَر بين درعين**، وأقام خمسين راميًا على الجبل وأمرهم ألّا يبرحوه.\n• وفي الخندق أخذ برأي صاحبٍ فارسيّ **فحُفر خندقٌ حول المدينة** — رجالٌ يحفرون في البرد والجوع وقد ربطوا الحجر على بطونهم.\n• وفي الهجرة **استأجر دليلًا لم يكن مسلمًا بعد**، ومكث في الغار ثلاثًا، وأمر بأن تُعفّى الآثارُ خلفهم.\n• وفي الحديبية **كتب شروطًا وجد منها أصحابه في أنفسهم**، لأنّ الحساب كان صحيحًا.\n\nوليس شيءٌ من هذا فعلَ من يرى أنّ الدعاء يكفي. وهو الذي دعاؤه **مقطوعٌ** بإجابته.\n\nفضَعِ السؤال على وجهه: **أنظنّ دعاءنا أقوى من دعائه؟** فإن كان دعاؤه احتاج معه إلى الحفر والدرع والدليل والصلح، فرجلٌ قاعدٌ رافعٌ يديه ليس يفعل ما فعل النبيُّ ﷺ، وإنما يفعل نصفه ويسمّيه دينًا.\n\nوثمّ حديثٌ يحسم الأصل في كلمتين: سأله رجل: أعقِلُها وأتوكّل أم أُطلقها وأتوكّل؟ فقال: **«اعْقِلْهَا وَتَوَكَّلْ»**. لا «بدلًا من». بل **الواو**.",
          context: [
            { tag: "The law the whole matter rests on", tagAr: "القاعدةُ التي يقوم عليها الأمر كلُّه",
              ...
              how: "Read the order of it. The change in **them** comes first, and the change in **their condition** follows it. Not the other way round, and not at the same time. Whatever is being waited for, this verse says it is waiting on us.",
              howAr: "تأمّل الترتيب: التغييرُ **في أنفسهم** أوّلًا، وتغييرُ **ما بهم** تابعٌ له. لا العكس، ولا معًا. فمهما يكن المنتظَر، فهذه الآيةُ تقول إنه موقوفٌ علينا." }
          ],
          plain: "In plain words: the Prophet ﷺ, whose dua was definitely answered, still dug a trench, wore two coats of mail, hired a non-Muslim guide, and signed a treaty. If HIS asking needed work beside it, ours is not stronger than his. And a man asked him whether to tie his camel or just rely on Allah — he said: tie it AND rely.",
          plainAr: "بعبارة أخرى: النبيُّ ﷺ ودعاؤه مستجابٌ قطعًا، ومع ذلك حفر الخندق، وظاهَر بين درعين، واستأجر دليلًا غير مسلم، وكتب صلحًا. فإن كان **دعاؤه** يحتاج إلى العمل معه، فليس دعاؤنا أقوى منه. وسأله رجل: أأعقل ناقتي أم أتوكّل؟ فقال: اعقلها **و**توكّل.",
          ref: "Jami at-Tirmidhi 2517 — \"tie it and rely\", outside the two Sahihs, authenticated by al-Albani; Sahih al-Bukhari, Book of the Military Expeditions, on Badr, Uhud and the Trench; Sahih al-Bukhari, Book of Conditions, Hadith 2731-2732 on Hudaybiyyah; Surah Ar-Ra'd (13:11)",
          refAr: "جامع الترمذي ٢٥١٧ — «اعقلها وتوكّل»، خارج الصحيحين وصحّحه الألباني؛ وصحيح البخاري، كتاب المغازي، في بدرٍ وأُحدٍ والخندق؛ وصحيح البخاري، كتاب الشروط، حديث ٢٧٣١-٢٧٣٢ في الحديبية؛ وسورة الرعد (١٣:١١)",
          strength: "Sahih al-Bukhari and the Quran; at-Tirmidhi is outside the two Sahihs, authenticated by al-Albani",
          strengthAr: "صحيح البخاري والقرآن؛ والترمذي خارج الصحيحين، صحّحه الألباني"
        },
        {
          id: "ms-wt-sapling",
          title: "\"If the Hour comes while one of you has a sapling in his hand — let him plant it\"",
          titleAr: "«إن قامت الساعة وفي يد أحدكم فَسِيلة فليغرسها»",
          body: "Sit with that sentence for a moment, because it was built to be impossible to argue with.\n\nThe Hour is beginning. Not next year — **now**, in front of him. Nobody will ever eat from that tree. It will not grow. There is no outcome, no reward on earth, no one to see it.\n\n**And he is told to plant it anyway.**\n\nThere is no reading of that hadith under which waiting is a virtue. It removes every excuse a person could offer, because it removes the only thing an excuse can be built on: what is the point, it won't change anything. At the literal end of the world, with no possible result, the instruction is still to put the thing in the ground.\n\nSo the small work that seems pointless — the shop run honestly, the class taught properly, the child raised straight, the code written well, the appointment kept at nine — is not less than the great work. **In this hadith it is the only work there is,** and it is commanded at the one moment when it can achieve nothing.\n\nHonest note on the grading: this is not in al-Bukhari or Muslim. It is in Musnad Ahmad and in al-Bukhari's Al-Adab al-Mufrad, and al-Albani declared it authentic in As-Silsilah as-Sahihah. It is cited here by collection and by grader and **not by number**, because Musnad Ahmad cannot be checked mechanically against a primary text the way the two Sahihs can — which is the rule this site follows everywhere.",
          bodyAr: "قِف عند هذه الجملة قليلًا، فقد بُنيت على وجهٍ لا يُنازَع فيه.\n\nالساعةُ تقوم. لا في العام القادم، بل **الآن**، بين يديه. ولن يأكل من تلك النخلة أحد. ولن تنبت. ولا نتيجة، ولا أجرَ في الأرض، ولا من يراها.\n\n**ويُؤمر بغرسها مع ذلك.**\n\nوليس للحديث وجهٌ تكون فيه القعدةُ فضيلة. فقد رفع كلّ عذرٍ يمكن أن يُعتذر به، لأنه رفع الشيء الوحيد الذي يقوم عليه العذر: «وما الفائدة؟ لن يتغيّر شيء». ففي آخر الدنيا حقيقةً، ولا نتيجة ممكنة، يبقى الأمرُ أن يضع الشيء في الأرض.\n\nفالعملُ الصغير الذي يبدو بلا جدوى — دكّانٌ يُدار بأمانة، ودرسٌ يُلقى بإتقان، وولدٌ يُربّى مستقيمًا، وبرمجةٌ تُكتب محكَمة، وموعدٌ يُحفظ في التاسعة — ليس دون العمل الكبير. **بل هو في هذا الحديث العملُ كلُّه**، وقد أُمر به في اللحظة الوحيدة التي لا يُنتج فيها شيئًا.\n\nوتحرّرٌ في الدرجة: ليس هذا في البخاريّ ولا مسلم، وإنما في مسند أحمد وفي «الأدب المفرد» للبخاري، وصحّحه الألباني في «السلسلة الصحيحة». وقد عُزي ههنا بالكتاب والمصحّح **دون رقم**، لأنّ مسند أحمد لا يُمكن التحقّق منه آليًّا كما يُتحقّق من الصحيحين — وهذه قاعدةُ هذا الموقع في كلّ موضع.",
          plain: "In plain words: if the world is literally ending right now and you are holding a seedling, plant it. Nobody will eat from it. It will not grow. Plant it anyway. There is no version of that hadith in which sitting and waiting is the right answer.",
          plainAr: "بعبارة أخرى: إن كانت الدنيا تنتهي الساعة وفي يدك فَسيلة فاغرسها. لن يأكل منها أحد، ولن تنبت. اغرسها مع ذلك. وليس للحديث وجهٌ يكون فيه القعودُ والانتظارُ هو الجواب.",
          ref: "Musnad Ahmad and al-Bukhari's Al-Adab al-Mufrad — outside the two Sahihs, authenticated by al-Albani in As-Silsilah as-Sahihah. Cited by collection and grader, never by number; the wording was not machine-verified against a primary text",
          refAr: "مسند أحمد و«الأدب المفرد» للبخاري — خارج الصحيحين، وصحّحه الألباني في «السلسلة الصحيحة». عُزي بالكتاب والمصحّح لا بالرقم؛ ولم يُقابَل لفظُه آليًّا بأصلٍ مطبوع",
          strength: "Outside the two Sahihs — authenticated by al-Albani; not machine-verified",
          strengthAr: "خارج الصحيحين — صحّحه الألباني؛ ولم يُقابَل آليًّا"
        },
        {
          id: "ms-wt-cost",
          title: "What the waiting actually costs — said plainly",
          titleAr: "ماذا يُكلّف الانتظارُ حقًّا — بصراحة",
          body: "A belief that costs nothing is easy to hold. This one has a price, and it is worth naming it out loud.\n\n**It moves the responsibility somewhere you cannot be blamed.** If the repair is his job and his date, then nothing is your fault this year, or next year, or for a lifetime. That is the appeal, and it is why the idea survives. It is a very comfortable place to stand.\n\n**It makes every real plan look small.** Why build a university that takes thirty years, or an industry that takes fifty, when the whole board is about to be cleared anyway? Waiting does not merely fail to build. **It argues against building.**\n\n**It hands the initiative to whoever is not waiting.** Someone is filling every year you leave empty. They are not more intelligent than you. They simply did not believe the year was a waiting room.\n\n**It has been believed before, by people who were wrong.** Every century has had its group certain the time had come. Some of them acted on it. In 1979 men seized the Grand Mosque in Makkah declaring one of themselves the Mahdi, and it ended with hundreds of dead inside the Haram. That is not a warning about theology. It is a warning about what a person will do once he has decided he is standing at the end of history.\n\n**And it is the exact thing the Quran warned this ummah about.** Not waiting for the Mahdi specifically — waiting in general, and being many and weightless while doing it. There is a section on that on this page too, with the hadith in which he ﷺ said the nations would call each other to the ummah as diners call each other to a dish, and that we would be **many, like the foam of a flood.**",
          bodyAr: "الاعتقادُ الذي لا يُكلّف شيئًا يسهل حملُه. وهذا له ثمن، ويحسن أن يُسمّى صراحة.\n\n**ينقل المسؤوليّة إلى موضعٍ لا تُلام فيه.** فإذا كان الإصلاحُ عملَه وفي وقته، فليس عليك ذنبٌ هذا العام ولا الذي يليه ولا عمرًا كاملًا. وهذا هو المُغري فيه، وبه بقيت الفكرة. وهو موقفٌ مريحٌ جدًّا.\n\n**ويُصغّر كلَّ خطّةٍ حقيقيّة.** فلِمَ تبني جامعةً تحتاج ثلاثين سنة، أو صناعةً تحتاج خمسين، والرقعةُ كلُّها ستُمسح بعد قليل؟ فالانتظارُ لا يعجز عن البناء فحسب، **بل يُحاجّ ضدّه.**\n\n**ويُسلّم المبادرة لمن لا ينتظر.** فثمّ من يملأ كلّ سنةٍ تتركها فارغة. وليسوا أذكى منك، وإنما لم يظنّوا أنّ السنة قاعةُ انتظار.\n\n**وقد اعتُقد هذا من قبل، واعتقده مخطئون.** فما من قرنٍ إلا وفيه طائفةٌ أيقنت أنّ الوقت قد حان. وعمل بعضهم بمقتضاه: ففي سنة ١٣٩٩هـ احتلّ رجالٌ المسجدَ الحرام يدّعون أنّ فيهم المهديّ، فانتهى الأمر بمئاتٍ من القتلى في الحرم. وليس هذا تحذيرًا في العقيدة، وإنما هو تحذيرٌ ممّا يفعله المرء إذا استقرّ عنده أنه واقفٌ في آخر التاريخ.\n\n**وهو عينُ ما حُذّرت منه هذه الأمّة.** لا انتظارُ المهديّ بخصوصه، بل الانتظارُ عمومًا، والكثرةُ بلا وزنٍ معه. وفي هذه الصفحة قسمٌ في ذلك، وفيه حديثُه ﷺ أنّ الأمم تتداعى على هذه الأمّة كما تتداعى الأَكَلَةُ إلى قصعتها، وأنّا يومئذٍ **كثيرٌ، ولكن غُثاءٌ كغُثاء السيل.**",
          plain: "In plain words: waiting is comfortable because nothing is your fault. It makes long projects look pointless — why build a university if it is all about to end? It hands every year you skip to someone who did not skip it. And people have acted on it before: in 1979 men seized the Grand Mosque calling one of themselves the Mahdi, and hundreds died inside the Haram.",
          plainAr: "بعبارة أخرى: الانتظارُ مريحٌ لأنّ شيئًا لا يكون ذنبك. ويجعل المشاريع الطويلة تبدو بلا معنى — فلِمَ تبني جامعةً وكلُّ شيءٍ على وشك الانتهاء؟ ويُسلّم كلّ سنةٍ تتركها لمن لم يتركها. وقد عمل به قومٌ من قبل: ففي سنة ١٣٩٩هـ احتلّ رجالٌ الحرمَ يدّعون أنّ فيهم المهديّ، فمات مئاتٌ داخل الحرم.",
          ref: "See \"Why we fell, and the way back\" on this page for the hadith of the foam; the seizure of the Grand Mosque in 1979 is documented modern history, not scripture",
          refAr: "انظر «لماذا سقطنا وكيف نعود» في هذه الصفحة لحديث الغثاء؛ وواقعةُ الحرم سنة ١٣٩٩هـ تاريخٌ حديثٌ موثّق لا نصٌّ شرعيّ",
          strength: "hadith for the foam; the 1979 events are documented history",
          strengthAr: "حديثٌ في الغثاء؛ وأحداثُ سنة ١٣٩٩هـ تاريخٌ موثّق"
        },
        {
          id: "ms-wt-dua",
          title: "Asking without taking the means — the thing everybody recognises",
          titleAr: "السؤالُ بلا أخذٍ بالأسباب — وهذا يعرفه كلُّ أحد",
          body: "Here is the same mistake in a form nobody argues with, because everyone can see it.\n\nA man asks Allah, sincerely, for a strong body. He asks every day. And he eats badly, sleeps badly and does not move. Ask anyone what will happen and they will tell you: nothing will happen. Not because Allah cannot give it — but because **the asking was never joined to the doing**, and this world was built so that things come through their causes.\n\nEveryone sees it instantly in the body. Almost nobody sees it in the ummah.\n\nA people ask Allah for victory and dignity and unity. Sincerely. Every Friday. And they do not read, do not build, do not manufacture, do not maintain what they have, do not keep an appointment, do not finish what they start, and do not stop tearing at each other. **Then they wait for a man to arrive and make it all right.**\n\nIt is the same sentence. It is the same mistake at a larger size.\n\n**And the correction is not to stop asking.** Nobody here is saying pray less. The Prophet ﷺ asked until his cloak fell from his shoulders. The correction is that asking and working were never two options to choose between — they are the two halves of one act, and it is the Prophet ﷺ himself who performed both, every time, without exception.\n\n**Look at your week rather than your words.** Not what you say you want for this ummah. What did you actually do this week that a person who wanted that would have done? That question is uncomfortable, which is exactly what makes it useful.",
          bodyAr: "وهذا هو الخطأ نفسُه في صورةٍ لا ينازع فيها أحد، لأنّ الناس جميعًا يُبصرونها.\n\nرجلٌ يسأل الله بصدقٍ بدنًا قويًّا. يسأله كلّ يوم. ثم يُسيء الأكل والنوم ولا يتحرّك. سَلْ أيّ أحدٍ ماذا يكون؟ يقل لك: لا يكون شيء. لا لأنّ الله لا يقدر، بل لأنّ **السؤال لم يُقرن بالعمل**، ولأنّ هذه الدار بُنيت على أن تجري الأمورُ بأسبابها.\n\nويُبصر الناسُ هذا في البدن من فورهم. ولا يكاد أحدٌ يُبصره في الأمّة.\n\nقومٌ يسألون الله النصر والعزّ والوحدة. بصدق. في كلّ جمعة. ثم لا يقرؤون، ولا يبنون، ولا يصنعون، ولا يصونون ما بأيديهم، ولا يحفظون موعدًا، ولا يُتمّون ما بدؤوا، ولا يكفّون عن التمزّق. **ثم ينتظرون رجلًا يأتي فيُصلح ذلك كلّه.**\n\nهي الجملةُ نفسها. وهو الخطأ نفسُه في مقاسٍ أكبر.\n\n**وليس التصحيحُ أن تكفّ عن السؤال.** وليس ههنا من يقول: أقلّوا الدعاء. فقد استنصر النبيُّ ﷺ حتى سقط رداؤه. وإنما التصحيحُ أنّ الدعاء والعمل لم يكونا قطّ خيارين يُنتقى أحدهما، بل هما شطرا فعلٍ واحد، وقد فعلهما النبيُّ ﷺ نفسُه معًا في كلّ مرّةٍ بلا استثناء.\n\n**فانظر في أسبوعك لا في كلامك.** لا ما تقول إنك تريده لهذه الأمّة، بل: ما الذي فعلتَه هذا الأسبوع ممّا كان يفعله من يريد ذلك؟ وهذا سؤالٌ ثقيل، وبثقله ينفع.",
          plain: "In plain words: a man who asks Allah every day for a strong body while eating badly and never moving gets nothing — and everyone can see why. It is the same with an ummah that asks for victory every Friday and does not read, build, manufacture, maintain, finish anything or stop fighting itself. Keep asking. But asking and working were never two options.",
          plainAr: "بعبارة أخرى: رجلٌ يسأل الله كلّ يومٍ بدنًا قويًّا وهو يُسيء الأكل ولا يتحرّك لا ينال شيئًا — والناس جميعًا يرون العلّة. وكذلك أمّةٌ تسأل النصر كلّ جمعةٍ ولا تقرأ ولا تبني ولا تصنع ولا تصون ولا تُتمّ ولا تكفّ عن التنازع. فلا تدع السؤال، ولكنّ السؤال والعمل لم يكونا قطّ خيارين.",
          ref: "Surah Ar-Ra'd (13:11); the Prophet's ﷺ supplication at Badr — Sahih Muslim, Book of Jihad and Expeditions",
          refAr: "سورة الرعد (١٣:١١)؛ ودعاؤه ﷺ يوم بدر — صحيح مسلم، كتاب الجهاد والسير",
          strength: "quran and Sahih Muslim",
          strengthAr: "قرآن وصحيح مسلم"
        },
        {
          id: "ms-wt-instead",
          title: "So what do you do instead, this week",
          titleAr: "فماذا تصنع بدل ذلك، في أسبوعك هذا",
          body: "Nothing on this list needs a government, a scholar's permission, or anyone else to move first. Every one of them is inside one person's control, which is the only reason it is worth writing down.\n\n• **Be excellent at one thing.** Not busy at ten. One skill, done better than the people around you can do it. A community is made of people who are individually good at something, and there is no other way to make one.\n\n• **Finish what you started.** The project abandoned at seventy percent is the national habit named on the Golden Age page. Break it once and you will notice how rare finishing is.\n\n• **Learn something properly this year** — a real book, a real course, to the end. \"Read\" was the first word revealed, and it was an instruction, not a description.\n\n• **Do your work well when nobody is checking.** He ﷺ made doing a thing properly something Allah loves. Most of what is wrong is not a shortage of belief; it is work done badly by believers.\n\n• **Fix one relationship you have let break.** With a brother, a parent, a neighbour. The disunity of an ummah is made of exactly these, one at a time, and so is its repair.\n\n• **Move it off the screen.** An argument won online changed nobody. The man you insulted closed the app and had his dinner. Teach one person, feed one family, fix one thing that is actually in front of you — that is smaller, and it is the only kind that counts.\n\n• **Then ask Allah** — for that work, by name, and for this ummah. Ask hard. That is the half most people already do; it is the other half that is missing.\n\nAnd if he comes in your lifetime, you will be one of the people who was already standing.",
          bodyAr: "ليس في هذه القائمة ما يحتاج إلى حكومةٍ ولا إذنِ عالمٍ ولا أن يتحرّك غيرُك أوّلًا. وكلُّ بندٍ فيها داخلٌ في قدرة رجلٍ واحد، ولذلك وحده استحقّ أن يُكتب.\n\n• **أتقِن شيئًا واحدًا.** لا أن تنشغل بعشرة. مهارةٌ واحدةٌ تُحسنها أكثر ممّا يُحسنها من حولك. فالجماعةُ تُبنى من آحادٍ يُحسن كلٌّ منهم شيئًا، ولا سبيل غيره.\n\n• **وأتمِم ما بدأت.** فالمشروعُ المتروك عند سبعين في المئة عادةٌ مذكورةٌ في صفحة العصر الذهبيّ. اكسِرها مرّةً تُبصر كم صار الإتمام عزيزًا.\n\n• **وتعلّم هذا العام شيئًا على وجهه** — كتابًا حقيقيًّا أو دورةً حقيقيّةً إلى آخرها. فـ«اقرأ» أوّلُ ما نزل، وهي أمرٌ لا وصف.\n\n• **وأحسِن عملك حين لا يراك أحد.** فقد جعل ﷺ إتقان العمل ممّا يحبّه الله. وأكثرُ الخلل ليس نقصًا في الإيمان، وإنما هو عملٌ سيّئٌ من مؤمنين.\n\n• **وأصلِح علاقةً واحدةً تركتَها تنقطع** — مع أخٍ أو والدٍ أو جار. فتفرّقُ الأمّة مركّبٌ من هذه واحدةً واحدة، وكذلك صلاحُها.\n\n• **وأخرِجها من الشاشة.** فجدالٌ رُبح على الإنترنت لم يغيّر أحدًا. والذي شتمتَه أغلق التطبيق وتعشّى. علّم رجلًا، أو أطعم بيتًا، أو أصلح شيئًا بين يديك حقًّا — وهو أصغر، وهو الوحيد الذي يُحتسب.\n\n• **ثم اسأل الله** — لذلك العمل باسمه، ولهذه الأمّة. وألِحّ. فهذا هو الشطر الذي يفعله أكثرُ الناس، وإنما الناقصُ الشطرُ الآخر.\n\nفإن جاء في عمرك كنتَ ممّن كان قائمًا من قبل.",
          plain: "In plain words: be genuinely good at one thing. Finish what you start. Learn something properly this year. Do your work well when nobody is watching. Fix one relationship you broke. Move it off the screen — teach one person, feed one family. Then ask Allah, hard. And if he comes in your lifetime, you will be one of the ones already standing.",
          plainAr: "بعبارة أخرى: أتقِن شيئًا واحدًا حقًّا. وأتمِم ما بدأت. وتعلّم هذا العام شيئًا على وجهه. وأحسِن عملك حين لا يراك أحد. وأصلِح علاقةً قطعتَها. وأخرِجها من الشاشة: علّم رجلًا، أو أطعم بيتًا. ثم اسأل الله وألِحّ. فإن جاء في عمرك كنتَ ممّن كان قائمًا.",
          ref: "See \"Why we fell, and the way back\" on this page, and \"Why we are behind\" on the Golden Age page, for the longer version of this list",
          refAr: "انظر «لماذا سقطنا وكيف نعود» في هذه الصفحة، و«لماذا نحن متأخّرون» في صفحة العصر الذهبيّ، لتفصيل هذه القائمة",
          strength: "the site's own summary, not a text",
          strengthAr: "خلاصةٌ من هذا الموقع، لا نصٌّ شرعيّ"
        }
      ],

      close: "One sentence to end on, and it is not this page's sentence — it is the Quran's.\n\n**\"Indeed, Allah will not change the condition of a people until they change what is in themselves.\"**\n\nRead the order one more time. The change in **them** is the condition. The change in **their state** is the result. Whoever is coming, and whenever, that verse was revealed to people who were told to get up — and it has not been repealed while we wait.",
      closeAr: "وجملةٌ واحدةٌ في الختام، وليست جملةَ هذه الصفحة، وإنما هي جملةُ القرآن.\n\n**﴿إِنَّ ٱللَّهَ لَا يُغَيِّرُ مَا بِقَوْمٍ حَتَّىٰ يُغَيِّرُوا۟ مَا بِأَنفُسِهِمْ﴾**\n\nوتأمّل الترتيب مرّةً أخرى: التغييرُ **في أنفسهم** هو الشرط، وتغييرُ **ما بهم** هو الجواب. فأيًّا كان الآتي ومتى كان، فتلك الآيةُ نزلت على قومٍ قيل لهم: قوموا — ولم تُنسخ ونحن ننتظر."
    }
  ],
