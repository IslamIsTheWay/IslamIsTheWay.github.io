/* ============================================================
   ...
   ============================================================ */
const RECENT = [
  {"id": "comfort", "icon": "🌙", "title": "Night reading, bigger text, and one search", "blurb": "A dark theme for reading at night, a text size that holds across the whole site, one search in the header of every page — and the home page now opens on what you were last reading.", "href": "index.html", "cta": "See for yourself", "at": "2026-09-22"},
