...
const RECENT = [
  ...
  {"id": "golden", "icon": "🏛️", "title": "The Golden Age of Islam", "blurb": "41 of the men and women who built it — algebra, optics, surgery, the hospital, the university — with the Latinised name Europe gave each of them, what Europe built on their work, and the documented cases where the credit went elsewhere. Every claim says how strong its evidence is, the same way every hadith on this site does.", "href": "golden.html", "cta": "See What We Built", "at": "2026-09-16"},
  {"id": "stories", "icon": "📖", "title": "Stories of the Prophet ﷺ", "blurb": "57 stories, every one found in the text of Sahih al-Bukhari or Sahih Muslim before it was written here — none from memory. The classical Arabic words in each story are explained in plain modern Arabic and English, and the eight stories about the Dajjal are linked together as one series, each with its own plain-words box.", "href": "stories.html", "cta": "Read the Stories", "at": "2026-09-16"},
  {"id": "judgement", "icon": "⏳", "title": "The Day of Judgement", "blurb": "Fifteen stages in the order they happen: death and the soul, the grave and its questions, the Trumpet, the standing, the seven under the shade, the settling of what people owe each other, the Records, the Scales, the Bridge, and the gates. 64 referenced points and 54 passages of the Quran.", "href": "judgement.html", "cta": "See the Stages", "at": "2026-09-16"},
  {"id": "guidance", "icon": "🕌", "title": "What to Say, and When", "blurb": "The worship reference: how each act of worship is performed, what is said in it, and what to do when something goes wrong — with the evidence beside every ruling.", "href": "guidance.html", "cta": "Open the Worship Reference", "at": "2026-09-16"},
  {"id": "verify", "icon": "✅", "title": "Check what you were told", "blurb": "Paste a hadith, a claim or a quotation and see whether this site can find it in the sources it carries, and how strong it is.", "href": "verify.html", "cta": "Check something", "at": "2026-09-16"},
  {"id": "sunnah", "icon": "🌿", "title": "199 Sunnah Practices", "blurb": "The Prophet's practice through an ordinary day — waking, eating, dressing, entering and leaving, sleeping — each with the hadith it comes from and its grading.", "href": "sunnah.html", "cta": "Browse the Sunnah", "at": "2026-09-14"},
