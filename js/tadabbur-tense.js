...
const TADABBUR_TENSE = {
  ...
  "8:17": {
    ...
    form: "**وَمَا رَمَيْتَ إِذْ رَمَيْتَ وَلَٰكِنَّ ٱللَّهَ رَمَىٰ** — you did not throw (negated perfect) when you threw (affirmed perfect) but Allah threw. Three uses of the one root ر-م-ي in eight words.",
    formAr: "﴿**وَمَا رَمَيْتَ إِذْ رَمَيْتَ وَلَٰكِنَّ ٱللَّهَ رَمَىٰ**﴾ — نفيُ الرمي، ثم إثباتُه، ثم إسنادُه إليه سبحانه. ثلاثةُ مواضع لمادّة (ر م ي) في ثمان كلمات.",
    why: "Read it slowly, because at first pass it looks like a contradiction: you did not throw — when you threw. The negation and the affirmation are of the same act, by the same person, in the same moment.\n\nAnd neither half is cancelled. **إِذْ رَمَيْتَ** confirms the throwing happened and that he ﷺ did it: the hand was his, the motion was his, the dust left his palm. **وَمَا رَمَيْتَ** denies the other thing — that the **effect** was his. A handful of dust does not reach an army.\n\nThis is a whole doctrine of action delivered in one sentence and without a single abstract noun. The deed is yours; you did it and you will be asked about it. The outcome is not yours. Most people go wrong at one end or the other — either they take credit for results they did not produce, or they excuse the deed because the result was out of their hands. **The verse separates the two by using one verb twice.**\n\nThe first clause of the verse does the same for the whole army: **فَلَمْ تَقْتُلُوهُمْ وَلَٰكِنَّ ٱللَّهَ قَتَلَهُمْ** — you did not kill them, but Allah killed them. Said to men who had fought all day at Badr.",
    whyAr: "اقرأها على مهل، فإنها تبدو في أوّل النظر متناقضة: ﴿وَمَا رَمَيْتَ﴾ ثم ﴿إِذْ رَمَيْتَ﴾ — نفيٌ وإثباتٌ للفعل الواحد من الفاعل الواحد في الوقت الواحد.\n\nولم يُبطَل أحدُ الشطرين. فـ﴿**إِذْ رَمَيْتَ**﴾ تثبت أنّ الرمي وقع وأنه ﷺ فعله: اليدُ يدُه، والحركةُ حركتُه، والترابُ خرج من كفّه. و﴿**وَمَا رَمَيْتَ**﴾ تنفي غير ذلك: أن يكون **الأثرُ** له. فقبضةُ ترابٍ لا تبلغ جيشًا.\n\nوهذه عقيدةٌ تامّة في العمل أُدّيت في جملةٍ واحدة بلا لفظٍ مجرَّد: العملُ لك، فعلتَه وستُسأل عنه؛ والنتيجةُ ليست لك. وأكثرُ الناس يزلّ في أحد الطرفين: إمّا أن ينسب إلى نفسه أثرًا لم يصنعه، وإمّا أن يعتذر عن العمل بأنّ الأثر ليس بيده. **ففصلت الآيةُ بينهما بفعلٍ واحدٍ كُرّر.**\n\nوصدرُ الآية يصنع ذلك بالجيش كلّه: ﴿**فَلَمْ تَقْتُلُوهُمْ وَلَٰكِنَّ ٱللَّهَ قَتَلَهُمْ**﴾ — قيلت لرجالٍ قاتلوا يومهم كلّه ببدر.",
  ...
  "65:3": {
    ...
    form: "**وَمَن يَتَّقِ ٱللَّهَ يَجْعَل لَّهُۥ مَخْرَجًۭا ۝ وَيَرْزُقْهُ مِنْ حَيْثُ لَا يَحْتَسِبُ** — a conditional **مَن** with the verb jussive (يَتَّقِ, its final ي dropped), and the answer jussive too (يَجْعَل, يَرْزُقْ). Then the following clause turns nominal: **وَمَن يَتَوَكَّلْ عَلَى ٱللَّهِ فَهُوَ حَسْبُهُۥ**.",
    formAr: "﴿**وَمَن يَتَّقِ ٱللَّهَ يَجْعَل لَّهُۥ مَخْرَجًۭا ۝ وَيَرْزُقْهُ مِنْ حَيْثُ لَا يَحْتَسِبُ**﴾ — ﴿مَن﴾ شرطيّة، وفعلُ الشرط مجزوم (﴿يَتَّقِ﴾ بحذف الياء)، وجوابُه مجزومٌ كذلك (﴿يَجْعَل﴾، ﴿يَرْزُقْ﴾). ثم انتقل ما بعده إلى الاسميّة: ﴿**وَمَن يَتَوَكَّلْ عَلَى ٱللَّهِ فَهُوَ حَسْبُهُۥ**﴾.",
    why: "In Arabic a conditional sentence puts both verbs in the jussive, and that shared ending is not decoration — it is the grammar tying the outcome to the condition. **يَتَّقِ** and **يَجْعَل** are welded together by their form. There is no gap in the sentence for the outcome to fail to arrive in.\n\nThen look at what the outcome is, and what it is not. It is **مَخْرَجًا** — a way out — indefinite, unnamed, unspecified. The verse does not say He will remove the difficulty; it says He will make a way out of it. And the provision comes **مِنْ حَيْثُ لَا يَحْتَسِبُ** — from where he does not reckon. Not more than he expects. From a direction he was not watching.\n\nAnd then the third clause changes shape entirely. Reliance does not get a jussive answer; it gets a **nominal** one: **فَهُوَ حَسْبُهُۥ** — He is his sufficiency. No verb, no time, nothing to wait for. Taqwa is answered with things that will be done; tawakkul is answered with something that already is.",
    whyAr: "الجملةُ الشرطيّة في العربية يُجزم فيها الفعلان، وليس ذلك الجزمُ زينةً، وإنما هو ربطُ النحوِ الجوابَ بالشرط. فـ﴿يَتَّقِ﴾ و﴿يَجْعَل﴾ ملحومان بصيغتهما، وليس في الجملة فُرجةٌ يتخلّف فيها الجواب.\n\nثم انظر ما الجواب وما ليس هو. هو ﴿**مَخْرَجًۭا**﴾ — نكرةٌ غيرُ مسمّاةٍ ولا محدودة. ولم تقل الآية: يرفع عنه الضيق، وإنما يجعل له منه مخرجًا. والرزقُ ﴿**مِنْ حَيْثُ لَا يَحْتَسِبُ**﴾ — لا أكثرَ ممّا يقدّر، بل من جهةٍ لم يكن يرقبها.\n\nثم تتغيّر الجملةُ الثالثة بناءً بالكلّيّة: فليس لجواب التوكّل فعلٌ مجزوم، وإنما جوابٌ **اسميّ**: ﴿**فَهُوَ حَسْبُهُۥ**﴾ — بلا فعلٍ ولا زمانٍ ولا شيءٍ يُنتظر. فالتقوى جوابُها أفعالٌ ستكون، والتوكّلُ جوابُه أمرٌ كائنٌ الآن.",
  ...
  "19:4": {
    ...
    headAr: "﴿وَٱشْتَعَلَ ٱلرَّأْسُ شَيْبًۭا﴾ — ولم يقل «رأسي»",
    form: "**وَهَنَ ٱلْعَظْمُ مِنِّى وَٱشْتَعَلَ ٱلرَّأْسُ شَيْبًۭا** — **ٱلْعَظْمُ** and **ٱلرَّأْسُ** are definite by the article, not by a possessive. Not عظمي, not رأسي. And **شَيْبًا** is an accusative of specification — flared up **as to** grey.",
    formAr: "﴿**وَهَنَ ٱلْعَظْمُ مِنِّى وَٱشْتَعَلَ ٱلرَّأْسُ شَيْبًۭا**﴾ — ﴿ٱلْعَظْمُ﴾ و﴿ٱلرَّأْسُ﴾ معرَّفان بالألف واللام لا بالإضافة، فلم يقل «عظمي» ولا «رأسي». و﴿**شَيْبًۭا**﴾ تمييز.",
    why: "Zakariyya عليه السلام is asking for a son as an old man, and this is how he describes the obstacle. Every word is chosen.\n\n**ٱلْعَظْمُ, singular and definite.** Not my bones — **the** bone. The singular of a thing that is everywhere in the body says the weakness is not in one place; it is in the structure. And the definite article rather than my puts a small distance between him and it: he is not complaining about himself, he is describing a condition.\n\n**ٱشْتَعَلَ — it caught fire.** The word for a flame taking hold. Grey does not creep in this verse; it spreads the way fire spreads through dry wood, and it does not go out.\n\n**شَيْبًا, indefinite and accusative.** The grammar makes greyness the respect in which the head flared, not the thing that flared. The head is the subject; the grey is what happened to it.\n\nAnd the third clause is why it is said at all: **وَلَمْ أَكُنۢ بِدُعَآئِكَ رَبِّ شَقِيًّا** — and I have never been, in supplicating You, unblessed. He lists what has gone wrong with his body and then, in the same sentence, says that asking You has never once failed me. **The request is made out of a track record.**",
    whyAr: "يسأل زكريّا عليه السلام الولدَ وهو شيخ، وهذه صفتُه للمانع. وكلُّ لفظٍ فيها مختار.\n\n**﴿ٱلْعَظْمُ﴾ مفردٌ معرَّف**: لم يقل «عظامي» بل «العظم». وإفرادُ ما هو منتشرٌ في البدن يفيد أنّ الوهن ليس في موضع، وإنما في البنية. والتعريفُ بالألف واللام دون الإضافة يجعل بينه وبينه فسحةً: فهو لا يشكو نفسه، وإنما يصف حالًا.\n\n**﴿ٱشْتَعَلَ﴾**: لفظُ أخذِ النار. فالشيبُ في هذه الآية لا يدبّ، وإنما ينتشر انتشارَ النار في اليابس، ولا ينطفئ.\n\n**﴿شَيْبًۭا﴾ نكرةٌ منصوبةٌ على التمييز**: فجعل النحوُ الشيبَ الجهةَ التي اشتعل فيها الرأسُ لا الذي اشتعل. فالرأسُ هو المسنَد إليه، والشيبُ ما وقع به.\n\nوالجملةُ الثالثة هي علّةُ القول كلِّه: ﴿**وَلَمْ أَكُنۢ بِدُعَآئِكَ رَبِّ شَقِيًّۭا**﴾. عدّد ما وهن من بدنه، ثم قال في الجملة نفسها إنّ سؤالك لم يُخيّبني قطّ. **فالسؤالُ صادرٌ عن تجربة.**",
  ...
  "2:187": {
    ...
    form: "**هُنَّ لِبَاسٌۭ لَّكُمْ وَأَنتُمْ لِبَاسٌۭ لَّهُنَّ** — two **nominal** sentences, no verb in either, with the same predicate and the pronouns exchanged.",
    formAr: "﴿**هُنَّ لِبَاسٌۭ لَّكُمْ وَأَنتُمْ لِبَاسٌۭ لَّهُنَّ**﴾ — جملتان **اسميّتان** لا فعل فيهما، الخبرُ واحدٌ والضمائرُ متبادلة.",
    ...
    plainAr: "بعبارة أخرى: ﴿هنّ لباسٌ لكم وأنتم لباسٌ لهنّ﴾. لا فعل فيها، فليس أمرًا تفعله، وإنما هو ما أنت عليه. وقيلت مرّتين بتبادل الجهتين ولم يختلف لفظٌ واحد، فلم يُرفع أحدُهما على الآخر. واللباسُ ألصقُ ما بك، وسِترُك، ودفؤك، وما تُعرف به.",
  ...
  "13:28": {
    ...
    form: "**تَطْمَئِنُّ قُلُوبُهُم بِذِكْرِ ٱللَّهِ** — ordinary order: verb, subject, then the cause. Then, one clause later: **أَلَا بِذِكْرِ ٱللَّهِ تَطْمَئِنُّ ٱلْقُلُوبُ** — the cause is moved to the **front**.",
    formAr: "﴿**تَطْمَئِنُّ قُلُوبُهُم بِذِكْرِ ٱللَّهِ**﴾ — على الأصل: فعلٌ ثم فاعلٌ ثم السبب. ثم بعد جملة: ﴿**أَلَا بِذِكْرِ ٱللَّهِ تَطْمَئِنُّ ٱلْقُلُوبُ**﴾ — **فقُدّم** السبب.",
    why: "The two clauses say what looks like the same thing, and the second one moves **بِذِكْرِ ٱللَّهِ** to the front. Fronting in Arabic is one of the plainest devices there is: what is moved forward is what is being confined. Not hearts find rest through the remembrance of Allah — but it is **by the remembrance of Allah** that hearts find rest, and by nothing else.\n\nThe change in the subject confirms it. The first clause says **قُلُوبُهُم** — their hearts, the believers just described. The second drops the possessive: **ٱلْقُلُوبُ**, hearts as such. The statement widens from a group to a fact about the organ.\n\nAnd **أَلَا** is placed in front of the whole thing — a particle Arabic uses to make a listener look up. The verse says the thing once as a description, and then again as a law, and marks the second so it is not read as repetition.",
    whyAr: "تقول الجملتان ما يبدو شيئًا واحدًا، وقد قُدّم في الثانية ﴿**بِذِكْرِ ٱللَّهِ**﴾. والتقديمُ في العربية من أظهر الأساليب: فالمقدَّمُ هو المقصورُ عليه. فليست «تطمئنّ القلوبُ بذكر الله»، بل «**بذكر الله** — لا بغيره — تطمئنّ القلوب».\n\nويؤكّده تغيّرُ الفاعل: فالأولى ﴿**قُلُوبُهُم**﴾ أي قلوبُ المذكورين، والثانية أسقطت الإضافة: ﴿**ٱلْقُلُوبُ**﴾ على العموم. فاتّسع الخبرُ من طائفةٍ إلى حقيقةٍ في هذا العضو.\n\nوصُدّرت الجملةُ كلُّها بـ﴿**أَلَا**﴾، وهي أداةُ تنبيهٍ تستوقف السامع. فقالت الآيةُ الأمرَ مرّةً وصفًا ثم أعادته حكمًا، ووسمت الثانية لئلّا تُقرأ تكرارًا.",
  ...
  "40:60": {
    ...
    form: "**ٱدْعُونِىٓ أَسْتَجِبْ لَكُمْ** — an **imperative** (ٱدْعُونِى) followed by a **jussive** (أَسْتَجِبْ, with a sukun on the final ب). In Arabic the jussive after a command is its answer, and the two are one construction.",
    formAr: "﴿**ٱدْعُونِىٓ أَسْتَجِبْ لَكُمْ**﴾ — فعلُ **أمر** ثم فعلٌ **مجزوم** في جواب الأمر (﴿أَسْتَجِبْ﴾ بالسكون). والمجزومُ بعد الأمر جوابُه، وهما تركيبٌ واحد.",
    why: "The response is not a separate sentence. It is grammatically bound to the command, the way the answer of a condition is bound to its condition — which means the verse does not say call upon Me, and I will respond; it says call upon Me — I respond, with nothing between them for the response to be delayed in.\n\nAnd notice what the verse does **not** say. It does not say and I will give you what you asked. **أَسْتَجِبْ** is to answer — and an answer may be the thing requested, or something better, or the same thing later, or protection from what you were asking for. The jussive guarantees the answer, not the item.\n\nThen the verse names the one thing that breaks it, and it is not sin: **إِنَّ ٱلَّذِينَ يَسْتَكْبِرُونَ عَنْ عِبَادَتِى** — those too proud for My worship. The opposite of du'a in this verse is not disobedience. It is arrogance — the refusal to ask.",
    whyAr: "ليس الجوابُ جملةً مستقلّة، وإنما هو مربوطٌ بالأمر نحوًا كما يُربط جوابُ الشرط بشرطه. فليس معنى الآية: ادعوني وسوف أستجيب، بل: ادعوني — أستجبْ، ولا فاصل بينهما تتأخّر فيه الاستجابة.\n\nوتأمّل ما **لم** تقله الآية: لم تقل «أُعطكم ما سألتم». و﴿**أَسْتَجِبْ**﴾ من الإجابة، والإجابةُ قد تكون عينَ المسؤول، وقد تكون خيرًا منه، وقد تكون تأخيرَه، وقد تكون صرفَ ما هو شرٌّ عنك ممّا سألتَه. فالجزمُ ضامنٌ للإجابة لا للمسؤول.\n\nثم سمّت الآيةُ الشيءَ الوحيد الذي ينقض هذا، وليس هو المعصية: ﴿**إِنَّ ٱلَّذِينَ يَسْتَكْبِرُونَ عَنْ عِبَادَتِى**﴾. فضدُّ الدعاء في هذه الآية ليس العصيان، وإنما الكِبْر — وهو الامتناعُ عن السؤال.",
  ...
  "2:4": {
    ...
    form: "**يُؤْمِنُونَ بِٱلْغَيْبِ وَيُقِيمُونَ ٱلصَّلَوٰةَ وَمِمَّا رَزَقْنَٰهُمْ يُنفِقُونَ** and **يُؤْمِنُونَ بِمَآ أُنزِلَ إِلَيْكَ** — all **imperfect**. Then the last clause turns: **وَبِٱلْءَاخِرَةِ هُمْ يُوقِنُونَ** — the pronoun **هُمْ** is inserted, and the object **بِٱلْءَاخِرَةِ** is moved to the front.",
    formAr: "﴿**يُؤْمِنُونَ بِٱلْغَيْبِ وَيُقِيمُونَ ٱلصَّلَوٰةَ وَمِمَّا رَزَقْنَٰهُمْ يُنفِقُونَ**﴾ و﴿**يُؤْمِنُونَ بِمَآ أُنزِلَ إِلَيْكَ**﴾ — كلُّها **مضارع**. ثم تتحوّل الأخيرة: ﴿**وَبِٱلْءَاخِرَةِ هُمْ يُوقِنُونَ**﴾ — فزيد الضميرُ ﴿هُمْ﴾ وقُدّم ﴿بِٱلْءَاخِرَةِ﴾.",
    why: "The first four are the imperfect, which in Arabic means renewed and repeated: believing, establishing the prayer, spending — none of these is done once. They are what a person keeps doing. The description is of a habit, not an event.\n\nThen the last item changes shape twice over. **بِٱلْءَاخِرَةِ** is fronted, which confines: it is the Hereafter, specifically, that they are certain of. And **هُمْ** is put in where the grammar does not need it — the verb يُوقِنُونَ already carries its subject. An unnecessary pronoun in Arabic is emphasis: they, these ones, are the certain.\n\nAnd the verb itself is different in kind. The others are things you do; **يَقِين** is a state you are in. So the passage lists four practices and closes on a condition — which is the order things actually happen in. The practices are what the certainty is built out of.",
    whyAr: "الأربعةُ الأولى مضارعة، والمضارعُ في العربية للتجدّد والتكرار: الإيمانُ وإقامةُ الصلاة والإنفاق، ليس شيءٌ منها يقع مرّة، وإنما هو ما يُداوم عليه المرء. فالوصفُ لعادةٍ لا لحادثة.\n\nثم تتغيّر الأخيرةُ من وجهين: فقُدّم ﴿**بِٱلْءَاخِرَةِ**﴾ والتقديمُ للحصر، أي بالآخرة على التعيين هم موقنون. وزيد ﴿**هُمْ**﴾ ولا يحتاجه النحوُ، فإنّ ﴿يُوقِنُونَ﴾ فيه ضميرُ فاعله. وزيادةُ الضمير في العربية توكيد: أي هؤلاء هم الموقنون.\n\nوالفعلُ نفسُه مخالفٌ في جنسه: فالأولى أعمالٌ تُعمل، و**اليقينُ** حالٌ يكون فيها المرء. فعدّد السياقُ أربعة أعمالٍ ثم ختم بحال، وهذا ترتيبُ الأمر في الواقع: فالأعمالُ هي التي يُبنى منها اليقين.",
    ifOther: "Put the four in the perfect — آمنوا وأقاموا الصلاة وأنفقوا — and they become things these people did, at some point, which tells you nothing about them now. And take **هُمْ** out of the last clause and the certainty becomes one more item on a list instead of the thing the list was building towards.",
    ifOtherAr: "فلو جُعلت الأربعةُ ماضيةً: «آمنوا وأقاموا الصلاة وأنفقوا» لصارت أمورًا فعلها هؤلاء في وقتٍ ما، ولا تُخبر عن حالهم الآن. ولو حُذف ﴿هُمْ﴾ من الأخيرة لصار اليقينُ بندًا آخر في القائمة، لا الغايةَ التي كانت القائمةُ تبني إليها.",
