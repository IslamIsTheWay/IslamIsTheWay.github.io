...
const TADABBUR_TENSE = {
  ...
  "12:60": {
    ...
    form: "**فَإِن لَّمۡ تَأۡتُونِي بِهِۦ** — the conditional particle **إِنْ** with a jussive verb: **if** you do not bring him. Nothing has happened yet. The apodosis, **فَلَا كَيۡلَ لَكُمۡ عِندِي**, is a negation of something in the future, not a report of something past.",
    formAr: "﴿**فَإِن لَّمۡ تَأۡتُونِي بِهِۦ**﴾ — أداة الشرط **إنْ** مع الفعل المجزوم: **إنْ** لم تأتوني. فلم يقع شيءٌ بعد. وجوابُ الشرط ﴿**فَلَا كَيۡلَ لَكُمۡ عِندِي**﴾ نفيٌ لأمرٍ مستقبل، لا إخبارٌ عن ماضٍ وقع.",
  ...
  "16:1": {
    ...
    form: "**أَتَىٰٓ أَمۡرُ ٱللَّهِ** — a **perfect** verb: the command of Allah **has come**. Followed immediately by **فَلَا تَسۡتَعۡجِلُوهُۚ** — **so do not be impatient for it**.",
    formAr: "﴿**أَتَىٰٓ أَمۡرُ ٱللَّهِ**﴾ — فعلٌ **ماضٍ**: أي **أتى** أمرُ الله. ثم يليه بلا فاصل: ﴿**فَلَا تَسۡتَعۡجِلُوهُۚ**﴾.",
  ...
  "54:1": {
    ...
    form: "**ٱقۡتَرَبَتِ ٱلسَّاعَةُ وَٱنشَقَّ ٱلۡقَمَرُ** — both **perfect**: the Hour **has** drawn near and the moon **has** split.",
    formAr: "﴿**ٱقۡتَرَبَتِ ٱلسَّاعَةُ وَٱنشَقَّ ٱلۡقَمَرُ**﴾ — كلاهما **ماضٍ**: اقتربت، وانشقّ.",
  ...
  "39:71": {
    ...
    form: "**وَسِيقَ ٱلَّذِينَ كَفَرُوٓاْ** and, two verses later, **وَسِيقَ ٱلَّذِينَ ٱتَّقَوۡاْ رَبَّهُمۡ** — **perfect** and **passive** both times, with **فُتِحَتۡ** (were opened) and **قِيلَ** (it was said) around them.",
    formAr: "﴿**وَسِيقَ ٱلَّذِينَ كَفَرُوٓاْ**﴾ ثم بعد آيتين ﴿**وَسِيقَ ٱلَّذِينَ ٱتَّقَوۡاْ رَبَّهُمۡ**﴾ — **ماضٍ مبنيٌّ للمجهول** في الموضعين، وحولهما ﴿**فُتِحَتۡ**﴾ و﴿**قِيلَ**﴾.",
  ...
  "81:1": {
    ...
    plainAr: "بعبارة أخرى: تُفتتح السورةُ بـ«إذا الشمس كُوّرت» — والإشارةُ إلى ما هو آتٍ — ثم كلُّ فعلٍ بعدها ماضٍ، وليس في واحدٍ منها ذكرُ من فعله. اثنتا عشرة واقعةً عظيمة، تنتهي كلُّ واحدةٍ في اللحظة التي تُذكر فيها، ولا تُرى يد. ثم تأتي الرابعة عشرة بعلّة ذلك كلّه: ﴿عَلِمَتۡ نَفۡسٞ مَّآ أَحۡضَرَتۡ﴾.",
  ...
  "2:15": {
    ...
    form: "They say **إِنَّمَا نَحۡنُ مُسۡتَهۡزِءُونَ** — an active participle in a **nominal** sentence. The answer is **ٱللَّهُ يَسۡتَهۡزِئُ بِهِمۡ** — a **verbal** sentence with an **imperfect** verb, and the divine name placed first.",
    formAr: "قالوا: ﴿**إِنَّمَا نَحۡنُ مُسۡتَهۡزِءُونَ**﴾ — اسمُ فاعلٍ في جملةٍ **اسميّة**. وجاء الجواب: ﴿**ٱللَّهُ يَسۡتَهۡزِئُ بِهِمۡ**﴾ — جملةٌ **فعليّة** فعلُها **مضارع**، وقد قُدّم لفظُ الجلالة.",
    why: "Two sentences, two different shapes, and the difference is the point.\n\n**Theirs is nominal.** إِنَّمَا نَحۡنُ مُسۡتَهۡزِءُونَ — **we are only mockers**. A nominal sentence states a condition, and a participle describes what someone **is**. It is a boast about identity, said behind closed doors, and it goes no further than the room.\n\n**The reply is verbal, and imperfect.** يَسۡتَهۡزِئُ — an act, and an act in the form Arabic uses for what is **ongoing and renewed**. Not that Allah mocked them once; that the answer keeps coming. And the next clause says what form it takes: **وَيَمُدُّهُمۡ فِي طُغۡيَٰنِهِمۡ يَعۡمَهُونَ** — He extends them in their transgression, wandering. The requital is that they are left to go on. That is the imperfect being exact: this is not an event, it is a condition running through their days.\n\n**And the name is placed first.** ٱللَّهُ يَسۡتَهۡزِئُ, not يَسْتَهْزِئُ ٱللَّهُ. Fronting the subject in Arabic focuses it. They said **we**; the reply begins **Allah**.",
    whyAr: "جملتان، وبناءان مختلفان، وفي الفرق المقصود.\n\n**فجملتُهم اسميّة**: ﴿إِنَّمَا نَحۡنُ مُسۡتَهۡزِءُونَ﴾. والجملةُ الاسميّة تقرّر حالًا، واسمُ الفاعل وصفٌ لما **هو عليه** صاحبُه. فهو افتخارٌ بالهُويّة قيل خلف الأبواب، ولم يجاوز المجلس.\n\n**والجوابُ فعليٌّ بالمضارع**: ﴿يَسۡتَهۡزِئُ﴾ — فعلٌ، وعلى الصيغة التي تُفيد في العربية **التجدّد والاستمرار**. فليس أنه استهزأ بهم مرّةً، بل إنّ الجواب متّصل. وقد بيّنت الجملةُ التي تليه صورتَه: ﴿**وَيَمُدُّهُمۡ فِي طُغۡيَٰنِهِمۡ يَعۡمَهُونَ**﴾. فالجزاءُ أن يُتركوا يمضون. وهذا هو المضارعُ في دقّته: ليس حدثًا، وإنما حالٌ تجري في أيّامهم.\n\n**وقُدّم الاسم:** ﴿ٱللَّهُ يَسۡتَهۡزِئُ﴾ لا «يستهزئ الله». والتقديمُ في العربية للاختصاص والعناية. قالوا «نحن»، فابتُدئ الجوابُ بـ«الله».",
  ...
  "22:63": {
    ...
    form: "**أَنزَلَ مِنَ ٱلسَّمَآءِ مَآءٗ** — **perfect**. Then, joined by a single **ف**: **فَتُصۡبِحُ ٱلۡأَرۡضُ مُخۡضَرَّةًۚ** — **imperfect**. One sentence, two tenses.",
    formAr: "﴿**أَنزَلَ مِنَ ٱلسَّمَآءِ مَآءٗ**﴾ — **ماضٍ**. ثم بفاءٍ واحدة: ﴿**فَتُصۡبِحُ ٱلۡأَرۡضُ مُخۡضَرَّةًۚ**﴾ — **مضارع**. جملةٌ واحدة، وزمنان.",
    why: "The tense changes exactly where the reality changes, and once you see it you will see it in a hundred places.\n\n**The rain fell.** A finite event with a start and an end — perfect tense, أَنزَلَ.\n\n**The earth turns green.** Not once. Every time it rains, everywhere it rains, for as long as there is earth and rain — so the verb moves to the imperfect, تُصۡبِحُ, which in Arabic carries renewal and repetition. The greening is not the second half of one event; it is what always follows.\n\nSo the verse gives you a single downpour and then, in one letter, opens it out into every spring that has ever happened. **The grammar is the argument.** A person who has seen it once has seen the proof, because the verb tells him it is not a once.",
    whyAr: "يتغيّر الزمنُ في الموضع الذي تتغيّر فيه الحقيقة، ومن أبصر هذا أبصره في مئة موضع.\n\n**فالمطرُ نزل**: حدثٌ محدودٌ له ابتداءٌ وانتهاء، فجاء بالماضي ﴿أَنزَلَ﴾.\n\n**والأرضُ تُصبح مخضرّة**: لا مرّةً واحدة، بل كلّما نزل الغيث، وحيثما نزل، ما دامت أرضٌ ومطر — فانتقل الفعلُ إلى المضارع ﴿تُصۡبِحُ﴾، وهو في العربية للتجدّد والتكرار. فليس الاخضرارُ شطرًا ثانيًا من حدثٍ واحد، وإنما هو ما يعقب أبدًا.\n\nفأعطتك الآيةُ غيثةً واحدة، ثم فتحتها بحرفٍ واحدٍ على كلّ ربيعٍ كان. **فالنحوُ هو الحجّة**: فمن رآها مرّةً فقد رأى الدليل، لأنّ الفعل أخبره أنها ليست مرّة.",
  ...
  "14:25": {
    ...
    form: "The tree is described with **nominal** clauses — **أَصۡلُهَا ثَابِتٞ وَفَرۡعُهَا فِي ٱلسَّمَآءِ** (no verb at all). Its fruit is described with an **imperfect** verb: **تُؤۡتِيٓ أُكُلَهَا كُلَّ حِينِۭ**.",
    formAr: "وُصفت الشجرةُ بجملٍ **اسميّة**: ﴿**أَصۡلُهَا ثَابِتٞ وَفَرۡعُهَا فِي ٱلسَّمَآءِ**﴾ — بلا فعل. ووُصف ثمرُها بفعلٍ **مضارع**: ﴿**تُؤۡتِيٓ أُكُلَهَا كُلَّ حِينِۭ**﴾.",
    why: "Look at which parts got verbs and which did not.\n\n**The root and the branch have none.** أَصۡلُهَا ثَابِتٞ — **its root is firm**. A nominal sentence in Arabic states something settled, with no time in it. Roots do not do; they are. Firmness is not an activity, and the sentence refuses to make it one.\n\n**The fruit gets a verb, and an imperfect one.** تُؤۡتِيٓ — **it gives**, continuously, and كُلَّ حِينِۭ removes any doubt about that: at every time. Giving is the one thing about a tree that is an activity, and it is the one thing described with a verb.\n\nSo the parable is built with grammar before it is built with words: **what is fixed is stated without a verb; what recurs is stated with the tense of recurrence.** That is a good word — settled at the root, and producing without a season.",
    whyAr: "انظر أيُّ أجزاءِ المَثَل أُعطي فعلًا وأيُّها لم يُعطَ.\n\n**فالأصلُ والفرعُ بلا فعل**: ﴿أَصۡلُهَا ثَابِتٞ﴾. والجملةُ الاسميّة في العربية تقرّر أمرًا مستقرًّا لا زمانَ فيه. والأصولُ لا تفعل، وإنما تكون. فالثباتُ ليس عملًا، وقد أبت الجملةُ أن تجعله عملًا.\n\n**والثمرُ أُعطي فعلًا، ومضارعًا**: ﴿تُؤۡتِيٓ﴾ — إيتاءً مستمرًّا، ثم ﴿كُلَّ حِينِۭ﴾ ترفع كلَّ احتمال. والإيتاءُ هو الشيء الوحيد في الشجرة الذي هو عمل، وهو الوحيد الذي وُصف بفعل.\n\nفالمَثَلُ مبنيٌّ بالنحو قبل أن يُبنى بالألفاظ: **ما ثبت قيل بلا فعل، وما تكرّر قيل بصيغة التكرار.** وتلك هي الكلمةُ الطيّبة: راسخةُ الأصل، معطيةٌ بلا موسم.",
  ...
  "4:28": {
    ...
    headAr: "﴿وَخُلِقَ ٱلۡإِنسَٰنُ ضَعِيفٗا﴾ — ولم يُذكر في الجملة خالق",
    form: "**يُرِيدُ ٱللَّهُ أَن يُخَفِّفَ عَنكُمۡۚ** — **active**, with the subject named: **Allah wants**. Then, immediately: **وَخُلِقَ ٱلۡإِنسَٰنُ ضَعِيفٗا** — **passive**: and man **was created** weak.",
    formAr: "﴿**يُرِيدُ ٱللَّهُ أَن يُخَفِّفَ عَنكُمۡۚ**﴾ — **مبنيٌّ للمعلوم**، والفاعلُ مسمًّى: ﴿ٱللَّهُ﴾. ثم بلا فاصل: ﴿**وَخُلِقَ ٱلۡإِنسَٰنُ ضَعِيفٗا**﴾ — **مبنيٌّ للمجهول**.",
    ...
    whyAr: "الشطران في الخالق نفسه، ولم يُسمَّ إلا في أحدهما. وهذا اختيار، وقد وقع في الآية الواحدة لئلّا يُغفل عن المقابلة.\n\n**فالتخفيفُ منسوب**: ﴿يُرِيدُ ٱللَّهُ أَن يُخَفِّفَ عَنكُمۡۚ﴾، فالرحمةُ موقَّعة.\n\n**والضعفُ غيرُ منسوب**: ﴿وَخُلِقَ ٱلۡإِنسَٰنُ ضَعِيفٗا﴾، فالفعلُ مبنيٌّ للمجهول ولا فاعل ظاهر. وقد نبّه أهلُ البلاغة على اطّراد هذا في القرآن: فما كان نعمةً وتخفيفًا نُسب إليه سبحانه صراحةً، وما يجده الإنسان في نفسه نقصًا ذُكر غيرَ منسوب، وإن كانت النسبةُ ثابتةً بداهةً.\n\nوتأمّل موقعَ الضعف من الجملة: فليس تعييرًا، وإنما هو **علّةُ الرحمة في الشطر الأوّل**. تقول الآية: يريد أن يخفّف عنكم — وقد خُلقتم ضعافًا. فالثانيةُ تعليلٌ للأولى.",
  ...
  "2:186": {
    ...
    headAr: "السؤالُ الوحيد الذي أُجيب في القرآن بلا ﴿قُلۡ﴾",
    form: "**وَإِذَا سَأَلَكَ عِبَادِي عَنِّي فَإِنِّي قَرِيبٌۖ** — and there is **no قُلۡ** between the question and the answer.",
    formAr: "﴿**وَإِذَا سَأَلَكَ عِبَادِي عَنِّي فَإِنِّي قَرِيبٌۖ**﴾ — وليس بين السؤال والجواب ﴿**قُلۡ**﴾.",
    why: "This is not about a tense; it is about a word that is **absent**, and the absence is only visible if you know the pattern it breaks.\n\nGo through the other places where people ask the Prophet ﷺ something. **يَسۡـَٔلُونَكَ عَنِ ٱلۡأَهِلَّةِۖ قُلۡ** — they ask you about the crescent moons, **say**. **يَسۡـَٔلُونَكَ عَنِ ٱلۡخَمۡرِ وَٱلۡمَيۡسِرِۖ قُلۡ**. **وَيَسۡـَٔلُونَكَ عَنِ ٱلرُّوحِۖ قُلِ**. **وَيَسۡـَٔلُونَكَ عَنِ ٱلۡجِبَالِ فَقُلۡ**. Every time, an instruction to relay: a question comes in, Allah gives His Messenger the answer, and the Messenger passes it on.\n\nThen comes the question about **Him**, and the قُلۡ is gone. **فَإِنِّي قَرِيبٌۖ** — **indeed I am near.** He answers directly, with no one standing in between.\n\nAnd the whole verse is built that way. Count the first-person pronouns: عِبَادِي، عَنِّي، فَإِنِّي، أُجِيبُ، دَعَانِ، لِي، بِي. Seven in one verse. **The subject is nearness, and the grammar is near.** Not \"tell them Allah is near\" — but **I am near**.",
    whyAr: "وليس هذا في زمنٍ، وإنما في لفظٍ **غائب**، ولا يُبصر غيابُه إلا لمن عرف النسق الذي خرق.\n\nتتبّع المواضع التي يُسأل فيها النبيُّ ﷺ: ﴿**يَسۡـَٔلُونَكَ عَنِ ٱلۡأَهِلَّةِۖ قُلۡ**﴾، ﴿**يَسۡـَٔلُونَكَ عَنِ ٱلۡخَمۡرِ وَٱلۡمَيۡسِرِۖ قُلۡ**﴾، ﴿**وَيَسۡـَٔلُونَكَ عَنِ ٱلرُّوحِۖ قُلِ**﴾، ﴿**وَيَسۡـَٔلُونَكَ عَنِ ٱلۡجِبَالِ فَقُلۡ**﴾. في كلّ مرّةٍ أمرٌ بالتبليغ: يَرِد السؤال، فيُعطي اللهُ رسولَه الجواب، فيبلّغه الرسول.\n\nثم جاء السؤال **عنه سبحانه**، فسقطت ﴿قُلۡ﴾: ﴿**فَإِنِّي قَرِيبٌۖ**﴾. أجاب بنفسه، ولا واسطة.\n\nوالآيةُ كلُّها على هذا البناء. عُدّ ضمائر المتكلّم فيها: ﴿عِبَادِي، عَنِّي، فَإِنِّي، أُجِيبُ، دَعَانِ، لِي، بِي﴾ — سبعةٌ في آية. **فالموضوعُ القربُ، والنحوُ قريب.** لا «قل لهم إنّ الله قريب»، بل «إنّي قريب».",
    ...
    plainAr: "بعبارة أخرى: في سائر القرآن إذا سأل الناسُ النبيَّ ﷺ قال الله له: ﴿قُلۡ﴾ فيبلّغ. وفي هذه الآية وحدها — والسؤالُ عن الله نفسه — سقطت «قل»، فأجاب السائلَ مباشرةً: «فإنّي قريب». فالآيةُ في القرب، وقد أسقطت اللفظ الذي كان يُدخل بينهما أحدًا.",
    ref: "Surah Al-Baqarah (2:186); compare 2:189, 2:215, 2:217, 2:219, 2:220, 2:222, 7:187, 17:85, 18:83, 20:105 — every one of them carries قُلۡ",
    refAr: "سورة البقرة (٢:١٨٦)؛ وقابلها بـ(٢:١٨٩) و(٢:٢١٥) و(٢:٢١٧) و(٢:٢١٩) و(٢:٢٢٠) و(٢:٢٢٢) و(٧:١٨٧) و(١٧:٨٥) و(١٨:٨٣) و(٢٠:١٠٥) — وفي كلٍّ منها ﴿قُلۡ﴾",
    strength: "quran"
  },
  ...
  "1:5": {
    ...
    form: "Verses 2-4 are **third person**: ٱلۡحَمۡدُ **لِلَّهِ** … ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ … مَٰلِكِ يَوۡمِ ٱلدِّينِ. Verse 5 is **second person**: **إِيَّاكَ** نَعۡبُدُ وَ**إِيَّاكَ** نَسۡتَعِينُ. The rhetoricians call the turn **iltifat**.",
    formAr: "الآيات (٢-٤) على الغَيبة: ﴿ٱلۡحَمۡدُ **لِلَّهِ**... ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ... مَٰلِكِ يَوۡمِ ٱلدِّينِ﴾. والآية (٥) على الخطاب: ﴿**إِيَّاكَ** نَعۡبُدُ وَ**إِيَّاكَ** نَسۡتَعِينُ﴾. ويسمّي البلاغيّون هذا النقل **الالتفات**.",
    why: "Three verses of praise are spoken **about** Him — the way you would describe someone to a third party. Then, without warning, the address turns and He is spoken **to**.\n\nThe placement is the meaning. The turn happens exactly after مَٰلِكِ يَوۡمِ ٱلدِّينِ. The reader has just said: Lord of all the worlds, the Most Merciful, Owner of the Day of Judgement. Having said those three things, he is no longer describing a distant subject — **he has talked himself into the presence of the one he is describing**, and the next thing out of his mouth is **You**.\n\n**And the object is put before the verb.** إِيَّاكَ نَعۡبُدُ, not نَعْبُدُكَ. Fronting in Arabic confines: not \"we worship You\" but \"**You** we worship\" — You and no one else. Then it is done a second time rather than joined: إِيَّاكَ نَسۡتَعِينُ. Two separate exclusions, because worship and dependence are two things a person divides up without noticing.",
    whyAr: "ثلاثُ آياتٍ من الثناء قيلت **عنه** سبحانه، كما يوصف الغائب لثالث. ثم يُنقل الخطابُ فجأةً فيُكلَّم **هو**.\n\nوفي موضع النقلة المعنى: فقد وقعت بعد ﴿مَٰلِكِ يَوۡمِ ٱلدِّينِ﴾ بعينه. وقد قال القارئُ لتوّه: ربُّ العالمين، الرحمنُ الرحيم، مالكُ يوم الدين. فمن قال هذه الثلاث لم يعد واصفًا غائبًا — **بل بلغ بثنائه حضرةَ من يصفه**، فكان أوّلَ ما ينطق به: ﴿إِيَّاكَ﴾.\n\n**وقُدّم المفعول على الفعل**: ﴿إِيَّاكَ نَعۡبُدُ﴾ لا «نعبدك». والتقديمُ في العربية للحصر: لا «نعبدك» بل «**إيّاك** نعبد» — أنت لا سواك. ثم أُعيد ولم يُعطف: ﴿إِيَّاكَ نَسۡتَعِينُ﴾ — حصران اثنان، لأنّ العبادة والاستعانة أمران يقسمهما المرءُ من حيث لا يشعر.",
  ...
  "10:22": {
    ...
    form: "**حَتَّىٰٓ إِذَا كُنتُمۡ فِي ٱلۡفُلۡكِ** — when **you** are in the ships. Then, in the same sentence: **وَجَرَيۡنَ بِهِم … وَفَرِحُواْ بِهَا … جَآءَتۡهَا رِيحٌ عَاصِفٞ** — and they sailed with **them** … and **they** rejoiced. Second person becomes third, mid-sentence.",
    formAr: "﴿**حَتَّىٰٓ إِذَا كُنتُمۡ فِي ٱلۡفُلۡكِ**﴾ — بخطاب المخاطب. ثم في الجملة نفسها: ﴿**وَجَرَيۡنَ بِهِم... وَفَرِحُواْ بِهَا... جَآءَتۡهَا رِيحٌ عَاصِفٞ**﴾ — بضمير الغائب. فانتقل من الخطاب إلى الغَيبة في وسط الجملة.",
    why: "The turn happens at a precise moment, and the moment is chosen.\n\nWhile the account is of Allah's favour — He it is who enables **you** to travel by land and sea — the reader is addressed directly. **You** are in the ship. The favour is put in your hands.\n\nThe instant the wind rises, the pronoun steps back: **they** rejoiced, the wave came upon **them**, **they** thought they were encircled, **they** called upon Allah with sincere devotion. **The reader is moved out of the boat and set on the shore, watching.**\n\nAnd there is a reason for that seat. From inside, a man in a storm making promises to God feels only like a man in a storm. From outside, you can see what he does — and you can see what he does afterwards, which the very next verse reports: **فَلَمَّآ أَنجَىٰهُمۡ إِذَا هُمۡ يَبۡغُونَ فِي ٱلۡأَرۡضِ** — when He saved them, at once they were transgressing. The shift of pronoun hands you the vantage point from which the pattern is visible, and the pattern is the point of the passage.",
    whyAr: "وقعت النقلةُ في لحظةٍ بعينها، واللحظةُ مقصودة.\n\nفما دام الكلامُ في الامتنان — ﴿هُوَ ٱلَّذِي يُسَيِّرُكُمۡ فِي ٱلۡبَرِّ وَٱلۡبَحۡرِۖ﴾ — فالقارئُ مخاطَبٌ بنفسه: **أنت** في الفلك، والنعمةُ موضوعةٌ في يدك.\n\nفلمّا هبّت الريحُ تراجع الضمير: ﴿وَفَرِحُواْ﴾، ﴿وَجَآءَهُمُ ٱلۡمَوۡجُ﴾، ﴿وَظَنُّوٓاْ أَنَّهُمۡ أُحِيطَ بِهِمۡ﴾، ﴿دَعَوُاْ ٱللَّهَ مُخۡلِصِينَ﴾. **فأُخرج القارئُ من السفينة وأُقيم على الشاطئ ناظرًا.**\n\nوللمقعد علّة: فمن كان في العاصفة لم يرَ من نفسه إلا رجلًا في عاصفة يَعِد. وأمّا من خارجها فيرى ما يصنع، ويرى ما يصنع بعدها — وهو ما تخبر به الآيةُ التي تليها: ﴿**فَلَمَّآ أَنجَىٰهُمۡ إِذَا هُمۡ يَبۡغُونَ فِي ٱلۡأَرۡضِ**﴾. فنقلةُ الضمير تُعطيك الموضعَ الذي يُبصَر منه النسق، والنسقُ هو مقصودُ السياق.",
  ...
  "12:15": {
    ...
    pair: {
      ...
      ar: "قَالَ هَلۡ عَلِمۡتُم مَّا فَعَلۡتُم بِيُوسُفَ وَأَخِيهِ إِذۡ أَنتُمۡ جَٰهِلُونَ ۝ قَالُوٓاْ أَءِنَّكَ لَأَنتَ يُوسُفُۖ قَالَ أَنَا۠ يُوسُفُ",
      ...
      how: "This is the promise of 12:15 being kept, and the clause **وَهُمۡ لَا يَشۡعُرُونَ** is kept with it — they have to ask who he is.",
      howAr: "هذا وقوعُ وعد (١٢:١٥)، ومعه قيدُه ﴿**وَهُمۡ لَا يَشۡعُرُونَ**﴾ — إذ اضطرّوا أن يسألوا من هو."
    },
  ...
  "94:6": {
    ...
    form: "**فَإِنَّ مَعَ ٱلۡعُسۡرِ يُسۡرًا ۝ إِنَّ مَعَ ٱلۡعُسۡرِ يُسۡرٗا** — **ٱلۡعُسۡرِ** carries the definite article both times; **يُسۡرٗا** is indefinite both times.",
    formAr: "﴿**فَإِنَّ مَعَ ٱلۡعُسۡرِ يُسۡرًا ۝ إِنَّ مَعَ ٱلۡعُسۡرِ يُسۡرٗا**﴾ — ﴿ٱلۡعُسۡرِ﴾ معرفةٌ بالألف واللام في الموضعين، و﴿يُسۡرٗا﴾ نكرةٌ في الموضعين.",
    why: "Both lines are repeated word for word, and the two nouns in them are not the same kind of noun.\n\n**ٱلۡعُسۡرِ is definite.** In Arabic, when a definite noun is repeated, the second is understood as the same one — الْعُسْر in the second verse is the very hardship named in the first. One hardship, mentioned twice.\n\n**يُسۡرًا is indefinite.** A repeated indefinite noun is understood as a second, different one. So: two eases.\n\nWhich is why the companions read it the way they did. Ibn Abbas رضي الله عنهما is reported to have said: **hardship will not overcome two eases** — and the same is reported from al-Hasan al-Basri and others, and Ibn Kathir carries it in his tafsir. The arithmetic is not devotional enthusiasm; it is what the definite article and its absence say.\n\nAnd note **مَعَ**, not بَعۡدَ. Not **after** hardship there is ease — **with** it. The relief is not queued behind the difficulty waiting for it to finish; it is in the same place at the same time.",
    whyAr: "الجملتان مكرّرتان بلفظهما، والاسمان فيهما ليسا من نوعٍ واحد.\n\n**فـ﴿ٱلۡعُسۡرِ﴾ معرفة.** وقاعدةُ العربية أنّ المعرفة إذا أُعيدت كانت الثانيةُ عينَ الأولى، فالعسرُ في الآية الثانية هو العسرُ المذكور في الأولى بعينه: عسرٌ واحدٌ ذُكر مرّتين.\n\n**و﴿يُسۡرٗا﴾ نكرة.** والنكرةُ إذا أُعيدت كانت الثانيةُ غيرَ الأولى: فيُسران.\n\nولذلك قرأها الصحابةُ على هذا الوجه: فقد رُوي عن ابن عباس رضي الله عنهما قوله: «لن يغلبَ عسرٌ يُسرين»، ورُوي مثلُه عن الحسن البصري وغيره، وأورده ابنُ كثير في تفسيره. فليس هذا الحسابُ حماسةَ واعظ، وإنما هو ما تقوله أداةُ التعريف وغيابُها.\n\nوتأمّل ﴿**مَعَ**﴾ لا «بعد»: فليس بعد العسر يسرٌ، بل **معه**. فليس الفرَجُ واقفًا في الصفّ خلف الشدّة ينتظر انقضاءها، وإنما هو في موضعها في وقتها.",
    ...
    plainAr: "بعبارة أخرى: «العسر» فيها الألف واللام في الموضعين، ومعناه في العربية أنه العسرُ الواحد بعينه. و﴿يُسۡرًا﴾ بلا ألفٍ ولام في الموضعين، ومعناه أنّ الثاني غيرُ الأوّل. فعسرٌ واحدٌ ويُسران. ومن هنا قولُ السلف: «لن يغلب عسرٌ يسرين». واللفظُ «**مع**» العسر لا «بعده».",
  ...
  "112:2": {
    ...
    form: "**قُلۡ هُوَ ٱللَّهُ أَحَدٌ ۝ ٱللَّهُ ٱلصَّمَدُ** — two **nominal** sentences, no verb in either. Then **لَمۡ يَلِدۡ وَلَمۡ يُولَدۡ** — verbs, and both **negated**. Then **وَلَمۡ يَكُن لَّهُۥ كُفُوًا أَحَدُۢ** — a negated verb of being.",
    formAr: "﴿**قُلۡ هُوَ ٱللَّهُ أَحَدٌ ۝ ٱللَّهُ ٱلصَّمَدُ**﴾ — جملتان **اسميّتان** لا فعل في واحدةٍ منهما. ثم ﴿**لَمۡ يَلِدۡ وَلَمۡ يُولَدۡ**﴾ — فعلان، وكلاهما **منفيّ**. ثم ﴿**وَلَمۡ يَكُن لَّهُۥ كُفُوًا أَحَدُۢ**﴾ — نفيُ الكون.",
    why: "A verb in Arabic carries time — it happened, it is happening, it will happen. A **nominal sentence has no verb and therefore no time in it at all.** It states what something simply is.\n\nSo when the surah that the Prophet ﷺ called equal to a third of the Quran comes to say what Allah is, it says it with no verbs: **هُوَ ٱللَّهُ أَحَدٌ ۝ ٱللَّهُ ٱلصَّمَدُ.** Nothing there began, and nothing there will end, because there is no verb in which a beginning or an ending could live.\n\nAnd when verbs finally appear, every one of them is **negated**. He did not beget. He was not begotten. There has not been for Him any equal. The affirmations are timeless and verbless; the verbs are used only to rule things out.\n\nThat is a whole doctrine of Allah delivered in fifteen words, and half of the work is done by which sentences were given verbs and which were not.",
    whyAr: "الفعلُ في العربية يحمل الزمان: وقع، أو يقع، أو سيقع. و**الجملةُ الاسميّة لا فعل فيها، فلا زمان فيها البتّة**، وإنما تقرّر ما الشيءُ عليه.\n\nفلمّا جاءت السورةُ التي جعلها النبي ﷺ تعدل ثلث القرآن تُخبر ما هو سبحانه، أخبرت بلا أفعال: ﴿**هُوَ ٱللَّهُ أَحَدٌ ۝ ٱللَّهُ ٱلصَّمَدُ**﴾. فلا شيء ههنا ابتدأ، ولا شيء ينتهي، إذ ليس ثمّ فعلٌ يسكنه ابتداءٌ أو انتهاء.\n\nفإذا ظهرت الأفعالُ أخيرًا فكلُّها **منفيّة**: ﴿لَمۡ يَلِدۡ﴾، ﴿وَلَمۡ يُولَدۡ﴾، ﴿وَلَمۡ يَكُن لَّهُۥ كُفُوًا أَحَدُۢ﴾. فالإثباتُ بلا زمانٍ ولا فعل، والأفعالُ لم تُستعمل إلا في النفي.\n\nفهذه عقيدةٌ تامّة في خمس عشرة كلمة، ونصفُ العمل فيها لاختيارِ أيّ الجمل أُعطي فعلًا وأيّها لم يُعطَ.",
  ...
  "7:44": {
    ...
    form: "**وَنَادَىٰٓ أَصۡحَٰبُ ٱلۡجَنَّةِ أَصۡحَٰبَ ٱلنَّارِ** — **perfect**: the people of the Garden **called out**. Then **قَالُواْ نَعَمۡۚ** — perfect again. Then **فَأَذَّنَ مُؤَذِّنُۢ** — perfect again.",
    formAr: "﴿**وَنَادَىٰٓ أَصۡحَٰبُ ٱلۡجَنَّةِ أَصۡحَٰبَ ٱلنَّارِ**﴾ — **ماضٍ**. ثم ﴿**قَالُواْ نَعَمۡۚ**﴾ — ماضٍ. ثم ﴿**فَأَذَّنَ مُؤَذِّنُۢ**﴾ — ماضٍ.",
    why: "An entire exchange that has not taken place yet, set down in the tense of a thing remembered. The people of the Garden call across; the people of the Fire answer with a single word — **نَعَمۡ**, yes; and an announcer announces between them.\n\nThe perfect does two things at once here. It makes the scene certain, as it does in every past-for-future. But it also makes it **overheard**. A future-tense prediction of a conversation is a description of a conversation. A past-tense report of one is a transcript, and the reader is in the position of somebody being told what was said.\n\nAnd the shortest word in it is the heaviest. They are asked whether they found what their Lord promised to be true, and the answer is one syllable: **نَعَمۡ**. There is nothing to add. Everything either side spent a life arguing about is settled by that word, and the Quran gives it no elaboration at all.",
    whyAr: "حوارٌ تامٌّ لم يقع بعد، أُثبت بزمن ما يُتذكَّر: ينادي أهلُ الجنّة، فيُجيب أهلُ النار بكلمة ﴿**نَعَمۡ**﴾، ثم يؤذّن مؤذّنٌ بينهم.\n\nوالماضي ههنا يصنع أمرين معًا: يُفيد التحقّق كشأنه في كلّ ماضٍ وقع موقع المستقبل، ويُفيد أيضًا أنّ الكلام **مسموع**. فالإخبارُ بالمستقبل عن حوارٍ وصفٌ لحوار، والإخبارُ بالماضي عنه نقلٌ لنصّه، فيصير القارئ في موضع من يُروى له ما قيل.\n\nوأقصرُ كلمةٍ فيه أثقلُها: سُئلوا أوجدوا ما وعد ربُّهم حقًّا، فكان الجوابُ حرفين: ﴿نَعَمۡ﴾. ولا مزيد. فكلُّ ما أفنى الفريقان فيه أعمارهما جدلًا تحسمه هذه الكلمة، ولم يزد القرآنُ عليها شيئًا.",
  ...
  /* ==========================================================
     SECOND ROUND. Same discipline: the form, why it is the
     right one here, what would change if it were the other,
     and plain words. Every quotation copied out of
     js/quran-text.js.
     ========================================================== */

  "36:82": {
    head: "\"Be\" — and then the imperfect, not the past",
    headAr: "﴿كُن﴾ — ثم المضارع لا الماضي",
    form: "**إِنَّمَآ أَمۡرُهُۥٓ إِذَآ أَرَادَ شَيۡـًٔا أَن يَقُولَ لَهُۥ كُن فَيَكُونُ** — the command **كُن** is answered by **فَيَكُونُ**, an **imperfect**. Not **فكان**, and it was.",
    formAr: "﴿**إِنَّمَآ أَمۡرُهُۥٓ إِذَآ أَرَادَ شَيۡـًٔا أَن يَقُولَ لَهُۥ كُن فَيَكُونُ**﴾ — جُعل جوابُ الأمر ﴿**كُن**﴾ قولَه ﴿**فَيَكُونُ**﴾ وهو **مضارع**، ولم يقل «فكان».",
    why: "Everything about the sentence says one instant: when He wills a thing, He says to it Be. The natural completion is a past verb — **and it was** — the way you would report an act that finished.\n\nThe verse does not use one. **فَيَكُونُ** is the imperfect, which in Arabic is the form of what is happening and goes on happening.\n\nThe reason is that the sentence is not describing one act of creation. It opens with **إِذَآ أَرَادَ شَيۡـًٔا** — whenever He wills a thing — which is a standing case, not an occasion. A past-tense answer would tie the whole statement to something already over. The imperfect keeps it true of every thing that has ever come into being and every thing that still will: the word goes out, and the thing comes to be, and that is not a story about the beginning of the world. It is a description of how existence works at this moment.",
    whyAr: "كلُّ ما في الجملة يشير إلى لحظةٍ واحدة: ﴿إِذَآ أَرَادَ شَيۡـًٔا أَن يَقُولَ لَهُۥ كُن﴾، والتتمّةُ التي يسبق إليها الذهنُ فعلٌ ماضٍ: «فكان»، كما يُخبَر عن فعلٍ انقضى.\n\nولم تأتِ الآيةُ به. و﴿**فَيَكُونُ**﴾ مضارع، وهو في العربية صيغةُ ما يقع ولا يزال يقع.\n\nوالعلّةُ أنّ الجملة ليست في خلقٍ واحد، فقد صُدّرت بـ﴿**إِذَآ أَرَادَ شَيۡـًٔا**﴾ وهو حالٌ مطّردة لا واقعةٌ معيّنة. ولو جاء الجوابُ ماضيًا لقُصر الكلامُ كلُّه على ما فُرغ منه. وأمّا المضارعُ فيُبقيه صادقًا في كلّ ما كان وكلّ ما سيكون: تخرج الكلمةُ فيكون الشيء — وليس هذا خبرًا عن بدء العالم، وإنما هو وصفٌ لكيفيّة قيام الوجود في هذه اللحظة.",
    ifOther: "**فكان** — and it was — closes the account. It becomes a report of creation as a finished event, something that happened once, long ago, to a universe that has been running on its own ever since. The imperfect denies exactly that. It says the word is still being spoken and things are still coming to be by it.",
    ifOtherAr: "و«فكان» تُغلق الخبر، فيصير إخبارًا عن الخلق حدثًا تامًّا وقع مرّةً في قديم الزمان، ثم بقي العالمُ يجري بنفسه. والمضارعُ يأبى هذا بعينه، ويقول: إنّ الكلمة تُقال، وإنّ الأشياء تكون بها، الآن.",
    plain: "In plain words: \"He says to it Be\" — and you expect \"and it was.\" The Quran says \"and it IS\", using the form that means it keeps happening. It is not describing one moment of creation in the past. It is describing how everything that exists is being held in existence right now.",
    plainAr: "بعبارة أخرى: ﴿أَن يَقُولَ لَهُۥ كُن﴾، فيسبق إلى ذهنك «فكان». وقال القرآن ﴿فَيَكُونُ﴾ بالصيغة التي تفيد الاستمرار. فليس وصفًا للحظةٍ من الخلق مضت، وإنما وصفٌ لِمَ يقوم به كلُّ موجودٍ الساعة.",
    ref: "Surah Ya-Sin (36:82); the same pairing at 2:117, 3:47, 3:59, 6:73, 16:40, 19:35, 40:68",
    refAr: "سورة يس (٣٦:٨٢)؛ ومثله في (٢:١١٧) و(٣:٤٧) و(٣:٥٩) و(٦:٧٣) و(١٦:٤٠) و(١٩:٣٥) و(٤٠:٦٨)",
    strength: "quran"
  },

  "8:17": {
    head: "The same verb denied and affirmed of the same man, in one breath",
    headAr: "الفعلُ الواحد يُنفى ويُثبت للرجل الواحد في نفَسٍ واحد",
    form: "**وَمَا رَمَيۡتَ إِذۡ رَمَيۡتَ وَلَٰكِنَّ ٱللَّهَ رَمَىٰ** — you did not throw (negated perfect) when you threw (affirmed perfect) but Allah threw. Three uses of the one root ر-م-ي in eight words.",
    formAr: "﴿**وَمَا رَمَيۡتَ إِذۡ رَمَيۡتَ وَلَٰكِنَّ ٱللَّهَ رَمَىٰ**﴾ — نفيُ الرمي، ثم إثباتُه، ثم إسنادُه إليه سبحانه. ثلاثةُ مواضع لمادّة (ر م ي) في ثمان كلمات.",
    why: "Read it slowly, because at first pass it looks like a contradiction: you did not throw — when you threw. The negation and the affirmation are of the same act, by the same person, in the same moment.\n\nAnd neither half is cancelled. **إِذۡ رَمَيۡتَ** confirms the throwing happened and that he ﷺ did it: the hand was his, the motion was his, the dust left his palm. **وَمَا رَمَيۡتَ** denies the other thing — that the **effect** was his. A handful of dust does not reach an army.\n\nThis is a whole doctrine of action delivered in one sentence and without a single abstract noun. The deed is yours; you did it and you will be asked about it. The outcome is not yours. Most people go wrong at one end or the other — either they take credit for results they did not produce, or they excuse the deed because the result was out of their hands. **The verse separates the two by using one verb twice.**\n\nThe first clause of the verse does the same for the whole army: **فَلَمۡ تَقۡتُلُوهُمۡ وَلَٰكِنَّ ٱللَّهَ قَتَلَهُمۡۚ** — you did not kill them, but Allah killed them. Said to men who had fought all day at Badr.",
    whyAr: "اقرأها على مهل، فإنها تبدو في أوّل النظر متناقضة: ﴿وَمَا رَمَيۡتَ﴾ ثم ﴿إِذۡ رَمَيۡتَ﴾ — نفيٌ وإثباتٌ للفعل الواحد من الفاعل الواحد في الوقت الواحد.\n\nولم يُبطَل أحدُ الشطرين. فـ﴿**إِذۡ رَمَيۡتَ**﴾ تثبت أنّ الرمي وقع وأنه ﷺ فعله: اليدُ يدُه، والحركةُ حركتُه، والترابُ خرج من كفّه. و﴿**وَمَا رَمَيۡتَ**﴾ تنفي غير ذلك: أن يكون **الأثرُ** له. فقبضةُ ترابٍ لا تبلغ جيشًا.\n\nوهذه عقيدةٌ تامّة في العمل أُدّيت في جملةٍ واحدة بلا لفظٍ مجرَّد: العملُ لك، فعلتَه وستُسأل عنه؛ والنتيجةُ ليست لك. وأكثرُ الناس يزلّ في أحد الطرفين: إمّا أن ينسب إلى نفسه أثرًا لم يصنعه، وإمّا أن يعتذر عن العمل بأنّ الأثر ليس بيده. **ففصلت الآيةُ بينهما بفعلٍ واحدٍ كُرّر.**\n\nوصدرُ الآية يصنع ذلك بالجيش كلّه: ﴿**فَلَمۡ تَقۡتُلُوهُمۡ وَلَٰكِنَّ ٱللَّهَ قَتَلَهُمۡۚ**﴾ — قيلت لرجالٍ قاتلوا يومهم كلّه ببدر.",
  ...
  "93:3": {
    head: "The object of the second verb is left off — and that is the mercy in it",
    headAr: "حُذف مفعولُ الفعل الثاني — وفي حذفه الرحمة",
    form: "**مَا وَدَّعَكَ رَبُّكَ وَمَا قَلَىٰ** — the first verb carries its object: وَدَّعَ**كَ**, He has not forsaken **you**. The second does not: **وَمَا قَلَىٰ** — and He has not… detested. The **كَ** is gone.",
    formAr: "﴿**مَا وَدَّعَكَ رَبُّكَ وَمَا قَلَىٰ**﴾ — الفعلُ الأوّل معه مفعولُه: ﴿وَدَّعَ**كَ**﴾. والثاني بلا مفعول: ﴿**وَمَا قَلَىٰ**﴾، فقد حُذفت الكاف.",
    why: "Revelation had paused. The Prophet ﷺ was being told by those around him that his Lord had left him. Then this surah came down.\n\nThe first denial keeps the pronoun: He has not forsaken **you**. It has to — the whole point is that the address is to him.\n\nThe second drops it. Grammatically the object is understood, and everyone reads it as and He has not detested you. But it is not said. The mufassirun note the delicacy: the word **قَلَىٰ** is the harsh one — to hate, to be repelled by — and the verse will not place it next to him even in order to deny it.\n\nAnd there is a second reason the scholars give, on the rhyme: the surah ends every verse on a long **ا** — ٱلضُّحَىٰ، سَجَىٰ، قَلَىٰ، ٱلۡأُولَىٰ، فَتَرۡضَىٰٓ، فَـَٔاوَىٰ، فَهَدَىٰ، فَأَغۡنَىٰ — and قَلَاكَ would have broken it. **Both readings hold, and neither cancels the other: the sound of the surah and the care in the sentence chose the same word.**",
    whyAr: "فتَر الوحي، وقيل له ﷺ ممّن حوله إنّ ربّه قد ودّعه. فنزلت السورة.\n\nفالنفيُ الأوّل أبقى الضمير: ﴿وَدَّعَ**كَ** رَبُّكَ﴾، ولا بدّ منه، فالمقصودُ أنّ الخطاب له.\n\nوالثاني حذفه. والمفعولُ مقدَّرٌ في الصناعة، والناسُ يقرؤونها: «وما قلاك». ولكنها لم تُقل. ونبّه المفسّرون على لطيفةٍ فيها: أنّ ﴿**قَلَىٰ**﴾ هو اللفظ الغليظ — البُغضُ والنفور — فأبت الآيةُ أن تُجاوره به ولو على وجه النفي.\n\nوذكر أهلُ العلم علّةً ثانية في الفاصلة: فالسورةُ كلُّها على ألفٍ في آخرها — ﴿ٱلضُّحَىٰ، سَجَىٰ، قَلَىٰ، ٱلۡأُولَىٰ، فَتَرۡضَىٰٓ، فَـَٔاوَىٰ، فَهَدَىٰ، فَأَغۡنَىٰ﴾ — و«قلاك» تكسرها. **والوجهان قائمان لا يُبطل أحدهما الآخر: فاختار جرسُ السورة وأدبُ الجملة اللفظَ نفسه.**",
  ...
  "65:3": {
    head: "The reward of taqwa is put in the jussive — grammatically bound to the condition",
    headAr: "جوابُ التقوى مجزوم — معلَّقٌ بالشرط في النحو نفسِه",
    form: "**وَمَن يَتَّقِ ٱللَّهَ يَجۡعَل لَّهُۥ مَخۡرَجٗا ۝ وَيَرۡزُقۡهُ مِنۡ حَيۡثُ لَا يَحۡتَسِبُۚ** — a conditional **مَن** with the verb jussive (يَتَّقِ, its final ي dropped), and the answer jussive too (يَجۡعَل, يَرْزُقْ). Then the following clause turns nominal: **وَمَن يَتَوَكَّلۡ عَلَى ٱللَّهِ فَهُوَ حَسۡبُهُۥٓۚ**.",
    formAr: "﴿**وَمَن يَتَّقِ ٱللَّهَ يَجۡعَل لَّهُۥ مَخۡرَجٗا ۝ وَيَرۡزُقۡهُ مِنۡ حَيۡثُ لَا يَحۡتَسِبُۚ**﴾ — ﴿مَن﴾ شرطيّة، وفعلُ الشرط مجزوم (﴿يَتَّقِ﴾ بحذف الياء)، وجوابُه مجزومٌ كذلك (﴿يَجۡعَل﴾، ﴿يَرۡزُقۡ﴾). ثم انتقل ما بعده إلى الاسميّة: ﴿**وَمَن يَتَوَكَّلۡ عَلَى ٱللَّهِ فَهُوَ حَسۡبُهُۥٓۚ**﴾.",
    why: "In Arabic a conditional sentence puts both verbs in the jussive, and that shared ending is not decoration — it is the grammar tying the outcome to the condition. **يَتَّقِ** and **يَجۡعَل** are welded together by their form. There is no gap in the sentence for the outcome to fail to arrive in.\n\nThen look at what the outcome is, and what it is not. It is **مَخۡرَجٗا** — a way out — indefinite, unnamed, unspecified. The verse does not say He will remove the difficulty; it says He will make a way out of it. And the provision comes **مِنۡ حَيۡثُ لَا يَحۡتَسِبُۚ** — from where he does not reckon. Not more than he expects. From a direction he was not watching.\n\nAnd then the third clause changes shape entirely. Reliance does not get a jussive answer; it gets a **nominal** one: **فَهُوَ حَسۡبُهُۥٓۚ** — He is his sufficiency. No verb, no time, nothing to wait for. Taqwa is answered with things that will be done; tawakkul is answered with something that already is.",
    whyAr: "الجملةُ الشرطيّة في العربية يُجزم فيها الفعلان، وليس ذلك الجزمُ زينةً، وإنما هو ربطُ النحوِ الجوابَ بالشرط. فـ﴿يَتَّقِ﴾ و﴿يَجۡعَل﴾ ملحومان بصيغتهما، وليس في الجملة فُرجةٌ يتخلّف فيها الجواب.\n\nثم انظر ما الجواب وما ليس هو. هو ﴿**مَخۡرَجٗا**﴾ — نكرةٌ غيرُ مسمّاةٍ ولا محدودة. ولم تقل الآية: يرفع عنه الضيق، وإنما يجعل له منه مخرجًا. والرزقُ ﴿**مِنۡ حَيۡثُ لَا يَحۡتَسِبُۚ**﴾ — لا أكثرَ ممّا يقدّر، بل من جهةٍ لم يكن يرقبها.\n\nثم تتغيّر الجملةُ الثالثة بناءً بالكلّيّة: فليس لجواب التوكّل فعلٌ مجزوم، وإنما جوابٌ **اسميّ**: ﴿**فَهُوَ حَسۡبُهُۥٓۚ**﴾ — بلا فعلٍ ولا زمانٍ ولا شيءٍ يُنتظر. فالتقوى جوابُها أفعالٌ ستكون، والتوكّلُ جوابُه أمرٌ كائنٌ الآن.",
  ...
  "19:4": {
    head: "\"The head has flared up with grey\" — and it is not my head",
    headAr: "﴿وَٱشۡتَعَلَ ٱلرَّأۡسُ شَيۡبٗا﴾ — ولم يقل «رأسي»",
    form: "**وَهَنَ ٱلۡعَظۡمُ مِنِّي وَٱشۡتَعَلَ ٱلرَّأۡسُ شَيۡبٗا** — **ٱلۡعَظۡمُ** and **ٱلرَّأۡسُ** are definite by the article, not by a possessive. Not عظمي, not رأسي. And **شَيۡبٗا** is an accusative of specification — flared up **as to** grey.",
    formAr: "﴿**وَهَنَ ٱلۡعَظۡمُ مِنِّي وَٱشۡتَعَلَ ٱلرَّأۡسُ شَيۡبٗا**﴾ — ﴿ٱلۡعَظۡمُ﴾ و﴿ٱلرَّأۡسُ﴾ معرَّفان بالألف واللام لا بالإضافة، فلم يقل «عظمي» ولا «رأسي». و﴿**شَيۡبٗا**﴾ تمييز.",
    why: "Zakariyya عليه السلام is asking for a son as an old man, and this is how he describes the obstacle. Every word is chosen.\n\n**ٱلۡعَظۡمُ, singular and definite.** Not my bones — **the** bone. The singular of a thing that is everywhere in the body says the weakness is not in one place; it is in the structure. And the definite article rather than my puts a small distance between him and it: he is not complaining about himself, he is describing a condition.\n\n**ٱشۡتَعَلَ — it caught fire.** The word for a flame taking hold. Grey does not creep in this verse; it spreads the way fire spreads through dry wood, and it does not go out.\n\n**شَيۡبٗا, indefinite and accusative.** The grammar makes greyness the respect in which the head flared, not the thing that flared. The head is the subject; the grey is what happened to it.\n\nAnd the third clause is why it is said at all: **وَلَمۡ أَكُنۢ بِدُعَآئِكَ رَبِّ شَقِيّٗا** — and I have never been, in supplicating You, unblessed. He lists what has gone wrong with his body and then, in the same sentence, says that asking You has never once failed me. **The request is made out of a track record.**",
    whyAr: "يسأل زكريّا عليه السلام الولدَ وهو شيخ، وهذه صفتُه للمانع. وكلُّ لفظٍ فيها مختار.\n\n**﴿ٱلۡعَظۡمُ﴾ مفردٌ معرَّف**: لم يقل «عظامي» بل «العظم». وإفرادُ ما هو منتشرٌ في البدن يفيد أنّ الوهن ليس في موضع، وإنما في البنية. والتعريفُ بالألف واللام دون الإضافة يجعل بينه وبينه فسحةً: فهو لا يشكو نفسه، وإنما يصف حالًا.\n\n**﴿ٱشۡتَعَلَ﴾**: لفظُ أخذِ النار. فالشيبُ في هذه الآية لا يدبّ، وإنما ينتشر انتشارَ النار في اليابس، ولا ينطفئ.\n\n**﴿شَيۡبٗا﴾ نكرةٌ منصوبةٌ على التمييز**: فجعل النحوُ الشيبَ الجهةَ التي اشتعل فيها الرأسُ لا الذي اشتعل. فالرأسُ هو المسنَد إليه، والشيبُ ما وقع به.\n\nوالجملةُ الثالثة هي علّةُ القول كلِّه: ﴿**وَلَمۡ أَكُنۢ بِدُعَآئِكَ رَبِّ شَقِيّٗا**﴾. عدّد ما وهن من بدنه، ثم قال في الجملة نفسها إنّ سؤالك لم يُخيّبني قطّ. **فالسؤالُ صادرٌ عن تجربة.**",
    ifOther: "Say my bones have weakened and my head has turned grey and every fact is preserved and the sentence is ordinary — a man reciting his ailments. What is lost is the fire, the structural sense of the singular, and the small dignity of the definite article. **Nothing in the meaning changed. All of the effect did.**",
    ifOtherAr: "فلو قيل: «وهنت عظامي وشاب رأسي» لبقيت الأخبارُ كلُّها وصارت الجملةُ عاديّة، رجلًا يعدّد عللَه. والذي يفوت: النارُ، ومعنى البنية في الإفراد، وذلك القدرُ من الوقار في التعريف. **لم يتغيّر من المعنى شيء، وتغيّر الأثرُ كلُّه.**",
    plain: "In plain words: he does not say \"my bones\" and \"my head\" — he says \"the bone\" and \"the head\", which puts a little distance between him and the complaint. And he does not say the head turned grey; he says it CAUGHT FIRE with grey. Then he finishes the sentence by saying that asking You has never once left him disappointed.",
    plainAr: "بعبارة أخرى: لم يقل «عظامي» ولا «رأسي»، بل «العظم» و«الرأس»، وفي ذلك فسحةٌ بينه وبين الشكوى. ولم يقل إنّ الرأس شاب، بل إنه **اشتعل** شيبًا. ثم ختم الجملةَ بأنّ سؤالك لم يُخيّبه مرّةً واحدة.",
    ref: "Surah Maryam (19:4); az-Zamakhshari, Al-Kashshaf, on ٱشتعل and the definite article here",
    refAr: "سورة مريم (١٩:٤)؛ والزمخشري في «الكشاف» عند «اشتعل» والتعريف ههنا",
    strength: "tafsir"
  },

  "2:187": {
    head: "Two nominal sentences, and each is the mirror of the other",
    headAr: "جملتان اسميّتان، كلٌّ منهما مرآةُ الأخرى",
    form: "**هُنَّ لِبَاسٞ لَّكُمۡ وَأَنتُمۡ لِبَاسٞ لَّهُنَّۗ** — two **nominal** sentences, no verb in either, with the same predicate and the pronouns exchanged.",
    formAr: "﴿**هُنَّ لِبَاسٞ لَّكُمۡ وَأَنتُمۡ لِبَاسٞ لَّهُنَّۗ**﴾ — جملتان **اسميّتان** لا فعل فيهما، الخبرُ واحدٌ والضمائرُ متبادلة.",
    why: "A verb would have made this an activity — something done, at a time, by one party to the other. There is no verb. A nominal sentence states what something **is**, with no time in it, and that is the claim: this is not what they do for each other, it is what they are to each other.\n\nThen the sentence is said twice with the pronouns swapped, and the two halves are identical in every other respect. Same word, same weight, no adjective on either side making one the greater. **The symmetry is total, and it is total on purpose** — in a verse that is about the most private part of a marriage.\n\nAnd look at the image chosen. **لِبَاس** — clothing. What is closest to the body, what covers what should not be seen, what protects from the cold, and what a person is known by. Every one of those is a thing a husband and wife are for one another, and the one word carries all of them at once without listing any.",
    whyAr: "لو جاء فعلٌ لصار الأمرُ عملًا يقع في وقتٍ من أحدهما بالآخر. ولا فعل ههنا. والجملةُ الاسميّة تقرّر ما الشيءُ **عليه** بلا زمان، وهذا هو المقصود: ليس هذا ما يصنعه كلٌّ منهما للآخر، بل هو ما هو له.\n\nثم أُعيدت الجملةُ بتبادل الضميرين، والشطران متطابقان فيما عدا ذلك: اللفظُ واحد، والوزنُ واحد، وليس في أحدهما نعتٌ يُفضّله. **فالتماثلُ تامّ، وتمامُه مقصود** — في آيةٍ موضوعُها أخصُّ ما في النكاح.\n\nوانظر الصورةَ المختارة: ﴿**لِبَاس**﴾ — وهو ألصقُ ما بالبدن، وسِترُ ما لا يُرى، ووقاءٌ من البرد، وما يُعرف به المرء. وكلُّ واحدةٍ من هذه يكونها الزوجان أحدُهما للآخر، ويحملها اللفظُ الواحد جميعًا من غير أن يُعدّد شيئًا منها.",
    ifOther: "Give it a verb — يستر بعضكم بعضًا, \"you cover one another\" — and it becomes a duty performed, which can be done well or badly or not at all. The verbless sentence is not describing a duty. And break the symmetry by adding one word to either side, and the verse stops saying the thing it is most remarkable for saying.",
    ifOtherAr: "فلو أُعطيت فعلًا: «يستر بعضكم بعضًا» لصارت واجبًا يُؤدّى، يُحسَن ويُساء ويُترك. والجملةُ الخالية من الفعل لا تصف واجبًا. ولو كُسر التماثلُ بزيادة لفظٍ في أحد الشطرين لسقط أعجبُ ما في الآية.",
    plain: "In plain words: \"they are clothing for you and you are clothing for them.\" No verb, so it is not something you do — it is something you are. And the sentence is said twice with the sides swapped and not one word different, so neither is placed above the other. Clothing is what is closest to you, what covers you, what warms you, and what you are recognised by.",
    plainAr: "بعبارة أخرى: ﴿هُنَّ لِبَاسٞ لَّكُمۡ وَأَنتُمۡ لِبَاسٞ لَّهُنَّۗ﴾. لا فعل فيها، فليس أمرًا تفعله، وإنما هو ما أنت عليه. وقيلت مرّتين بتبادل الجهتين ولم يختلف لفظٌ واحد، فلم يُرفع أحدُهما على الآخر. واللباسُ ألصقُ ما بك، وسِترُك، ودفؤك، وما تُعرف به.",
    ref: "Surah Al-Baqarah (2:187)",
    refAr: "سورة البقرة (٢:١٨٧)",
    strength: "quran"
  },

  "13:28": {
    head: "The same clause said twice, and the second time the words change places",
    headAr: "الجملةُ نفسُها مرّتين، وفي الثانية تتقدّم الكلمة",
    form: "**تَطۡمَئِنُّ قُلُوبُهُم بِذِكۡرِ ٱللَّهِۗ** — ordinary order: verb, subject, then the cause. Then, one clause later: **أَلَا بِذِكۡرِ ٱللَّهِ تَطۡمَئِنُّ ٱلۡقُلُوبُ** — the cause is moved to the **front**.",
    formAr: "﴿**تَطۡمَئِنُّ قُلُوبُهُم بِذِكۡرِ ٱللَّهِۗ**﴾ — على الأصل: فعلٌ ثم فاعلٌ ثم السبب. ثم بعد جملة: ﴿**أَلَا بِذِكۡرِ ٱللَّهِ تَطۡمَئِنُّ ٱلۡقُلُوبُ**﴾ — **فقُدّم** السبب.",
    why: "The two clauses say what looks like the same thing, and the second one moves **بِذِكۡرِ ٱللَّهِ** to the front. Fronting in Arabic is one of the plainest devices there is: what is moved forward is what is being confined. Not hearts find rest through the remembrance of Allah — but it is **by the remembrance of Allah** that hearts find rest, and by nothing else.\n\nThe change in the subject confirms it. The first clause says **قُلُوبُهُم** — their hearts, the believers just described. The second drops the possessive: **ٱلۡقُلُوبُ**, hearts as such. The statement widens from a group to a fact about the organ.\n\nAnd **أَلَا** is placed in front of the whole thing — a particle Arabic uses to make a listener look up. The verse says the thing once as a description, and then again as a law, and marks the second so it is not read as repetition.",
    whyAr: "تقول الجملتان ما يبدو شيئًا واحدًا، وقد قُدّم في الثانية ﴿**بِذِكۡرِ ٱللَّهِ**﴾. والتقديمُ في العربية من أظهر الأساليب: فالمقدَّمُ هو المقصورُ عليه. فليست «تطمئنّ القلوبُ بذكر الله»، بل «**بذكر الله** — لا بغيره — تطمئنّ القلوب».\n\nويؤكّده تغيّرُ الفاعل: فالأولى ﴿**قُلُوبُهُم**﴾ أي قلوبُ المذكورين، والثانية أسقطت الإضافة: ﴿**ٱلۡقُلُوبُ**﴾ على العموم. فاتّسع الخبرُ من طائفةٍ إلى حقيقةٍ في هذا العضو.\n\nوصُدّرت الجملةُ كلُّها بـ﴿**أَلَا**﴾، وهي أداةُ تنبيهٍ تستوقف السامع. فقالت الآيةُ الأمرَ مرّةً وصفًا ثم أعادته حكمًا، ووسمت الثانية لئلّا تُقرأ تكرارًا.",
  ...
  "40:60": {
    head: "A command, and the answer to it in the jussive — grammatically inseparable",
    headAr: "أمرٌ وجوابُه مجزوم — لا ينفصل أحدهما عن الآخر نحوًا",
    form: "**ٱدۡعُونِيٓ أَسۡتَجِبۡ لَكُمۡۚ** — an **imperative** (ٱدۡعُونِيٓ) followed by a **jussive** (أَسۡتَجِبۡ, with a sukun on the final ب). In Arabic the jussive after a command is its answer, and the two are one construction.",
    formAr: "﴿**ٱدۡعُونِيٓ أَسۡتَجِبۡ لَكُمۡۚ**﴾ — فعلُ **أمر** ثم فعلٌ **مجزوم** في جواب الأمر (﴿أَسۡتَجِبۡ﴾ بالسكون). والمجزومُ بعد الأمر جوابُه، وهما تركيبٌ واحد.",
    why: "The response is not a separate sentence. It is grammatically bound to the command, the way the answer of a condition is bound to its condition — which means the verse does not say call upon Me, and I will respond; it says call upon Me — I respond, with nothing between them for the response to be delayed in.\n\nAnd notice what the verse does **not** say. It does not say and I will give you what you asked. **أَسۡتَجِبۡ** is to answer — and an answer may be the thing requested, or something better, or the same thing later, or protection from what you were asking for. The jussive guarantees the answer, not the item.\n\nThen the verse names the one thing that breaks it, and it is not sin: **إِنَّ ٱلَّذِينَ يَسۡتَكۡبِرُونَ عَنۡ عِبَادَتِي** — those too proud for My worship. The opposite of du'a in this verse is not disobedience. It is arrogance — the refusal to ask.",
    whyAr: "ليس الجوابُ جملةً مستقلّة، وإنما هو مربوطٌ بالأمر نحوًا كما يُربط جوابُ الشرط بشرطه. فليس معنى الآية: ادعوني وسوف أستجيب، بل: ادعوني — أستجبْ، ولا فاصل بينهما تتأخّر فيه الاستجابة.\n\nوتأمّل ما **لم** تقله الآية: لم تقل «أُعطكم ما سألتم». و﴿**أَسۡتَجِبۡ**﴾ من الإجابة، والإجابةُ قد تكون عينَ المسؤول، وقد تكون خيرًا منه، وقد تكون تأخيرَه، وقد تكون صرفَ ما هو شرٌّ عنك ممّا سألتَه. فالجزمُ ضامنٌ للإجابة لا للمسؤول.\n\nثم سمّت الآيةُ الشيءَ الوحيد الذي ينقض هذا، وليس هو المعصية: ﴿**إِنَّ ٱلَّذِينَ يَسۡتَكۡبِرُونَ عَنۡ عِبَادَتِي**﴾. فضدُّ الدعاء في هذه الآية ليس العصيان، وإنما الكِبْر — وهو الامتناعُ عن السؤال.",
  ...
  "2:4": {
    head: "Four verbs in the imperfect, and then one clause that has none",
    headAr: "أربعةُ أفعالٍ بالمضارع، ثم جملةٌ لا فعل فيها",
    form: "**يُؤۡمِنُونَ بِٱلۡغَيۡبِ وَيُقِيمُونَ ٱلصَّلَوٰةَ وَمِمَّا رَزَقۡنَٰهُمۡ يُنفِقُونَ** and **يُؤۡمِنُونَ بِمَآ أُنزِلَ إِلَيۡكَ** — all **imperfect**. Then the last clause turns: **وَبِٱلۡأٓخِرَةِ هُمۡ يُوقِنُونَ** — the pronoun **هُمۡ** is inserted, and the object **بِٱلۡأٓخِرَةِ** is moved to the front.",
    formAr: "﴿**يُؤۡمِنُونَ بِٱلۡغَيۡبِ وَيُقِيمُونَ ٱلصَّلَوٰةَ وَمِمَّا رَزَقۡنَٰهُمۡ يُنفِقُونَ**﴾ و﴿**يُؤۡمِنُونَ بِمَآ أُنزِلَ إِلَيۡكَ**﴾ — كلُّها **مضارع**. ثم تتحوّل الأخيرة: ﴿**وَبِٱلۡأٓخِرَةِ هُمۡ يُوقِنُونَ**﴾ — فزيد الضميرُ ﴿هُمۡ﴾ وقُدّم ﴿بِٱلۡأٓخِرَةِ﴾.",
    why: "The first four are the imperfect, which in Arabic means renewed and repeated: believing, establishing the prayer, spending — none of these is done once. They are what a person keeps doing. The description is of a habit, not an event.\n\nThen the last item changes shape twice over. **بِٱلۡأٓخِرَةِ** is fronted, which confines: it is the Hereafter, specifically, that they are certain of. And **هُمۡ** is put in where the grammar does not need it — the verb يُوقِنُونَ already carries its subject. An unnecessary pronoun in Arabic is emphasis: they, these ones, are the certain.\n\nAnd the verb itself is different in kind. The others are things you do; **يَقِين** is a state you are in. So the passage lists four practices and closes on a condition — which is the order things actually happen in. The practices are what the certainty is built out of.",
    whyAr: "الأربعةُ الأولى مضارعة، والمضارعُ في العربية للتجدّد والتكرار: الإيمانُ وإقامةُ الصلاة والإنفاق، ليس شيءٌ منها يقع مرّة، وإنما هو ما يُداوم عليه المرء. فالوصفُ لعادةٍ لا لحادثة.\n\nثم تتغيّر الأخيرةُ من وجهين: فقُدّم ﴿**بِٱلۡأٓخِرَةِ**﴾ والتقديمُ للحصر، أي بالآخرة على التعيين هم موقنون. وزيد ﴿**هُمۡ**﴾ ولا يحتاجه النحوُ، فإنّ ﴿يُوقِنُونَ﴾ فيه ضميرُ فاعله. وزيادةُ الضمير في العربية توكيد: أي هؤلاء هم الموقنون.\n\nوالفعلُ نفسُه مخالفٌ في جنسه: فالأولى أعمالٌ تُعمل، و**اليقينُ** حالٌ يكون فيها المرء. فعدّد السياقُ أربعة أعمالٍ ثم ختم بحال، وهذا ترتيبُ الأمر في الواقع: فالأعمالُ هي التي يُبنى منها اليقين.",
    ifOther: "Put the four in the perfect — آمنوا وأقاموا الصلاة وأنفقوا — and they become things these people did, at some point, which tells you nothing about them now. And take **هُمۡ** out of the last clause and the certainty becomes one more item on a list instead of the thing the list was building towards.",
    ifOtherAr: "فلو جُعلت الأربعةُ ماضيةً: «آمنوا وأقاموا الصلاة وأنفقوا» لصارت أمورًا فعلها هؤلاء في وقتٍ ما، ولا تُخبر عن حالهم الآن. ولو حُذف ﴿هُمۡ﴾ من الأخيرة لصار اليقينُ بندًا آخر في القائمة، لا الغايةَ التي كانت القائمةُ تبني إليها.",
    plain: "In plain words: the first four things — believing, praying, spending — are in the form that means they keep doing them. It is a description of habits, not of things done once. Then the last one changes: an extra \"they\" is added that the grammar does not need, and \"in the Hereafter\" is moved to the front. Both are ways of saying: these, specifically, are the ones who are certain.",
    plainAr: "بعبارة أخرى: الأربعةُ الأولى — الإيمان والصلاة والإنفاق — بصيغةٍ معناها المداومة. فهو وصفُ عادةٍ لا وصفُ فعلةٍ وقعت. ثم تتغيّر الأخيرة: يُزاد ضميرٌ لا يحتاجه النحو، ويُقدَّم «بالآخرة». وكلاهما طريقةٌ في قول: هؤلاء على التعيين هم الموقنون.",
    ref: "Surah Al-Baqarah (2:2-5)",
    refAr: "سورة البقرة (٢:٢-٥)",
    strength: "quran"
  }
};
