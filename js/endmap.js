    ...
    /** ---------------------------------------------------- 4 **/
    {
      ...
      nodes: [
        { t: "The sun rises from the west, and repentance closes",
          ...
          detailAr: "إذا طلعت من مغربها **﴿لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ﴾** — ويُغلق البابُ الذي لم يزل مفتوحًا منذ البدء. وهذه هي الواقعةُ الوحيدة في الخريطة التي لا يُستدرك أثرُها بعمل.\n\nوبها يُفصل التباسٌ شائع: فالتوبةُ مقبولةٌ وعيسى عليه السلام في الأرض، والناسُ يؤمنون به — فلا يكون طلوعُ الشمس من مغربها قبل ذلك.",
