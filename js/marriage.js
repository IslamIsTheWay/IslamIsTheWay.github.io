...

    {
      ...
      items: [
        ...
        },
        {
          ...
          plainAr: "قال تعالى: ﴿وَءَاتُواْ ٱلنِّسَآءَ صَدُقَٰتِهِنَّ نِحۡلَةٗۚ﴾، ثم أتبعه بما يفصل في الملك: ﴿فَإِن طِبۡنَ لَكُمۡ عَن شَيۡءٖ مِّنۡهُ نَفۡسٗا فَكُلُوهُ هَنِيٓـٔٗا مَّرِيٓـٔٗا﴾. ولا يصحّ أن يقال لها أن تردَّ منه شيئًا إلا وهو مِلكُها تردُّه.\n\nفالمهرُ مالُها، وهي التي تقرّر فيمَ يُنفق. فإن أخذه أهلُها فقد أخذوا مالها، وحكمُ أخذ مال الغير لا يتغيّر لأنّ الآخذ قريب.",
          ...
          proofAr: "وَءَاتُواْ ٱلنِّسَآءَ صَدُقَٰتِهِنَّ نِحۡلَةٗۚ فَإِن طِبۡنَ لَكُمۡ عَن شَيۡءٖ مِّنۡهُ نَفۡسٗا فَكُلُوهُ هَنِيٓـٔٗا مَّرِيٓـٔٗا",
          ...
          noteAr: "ويلزم من هذا أمران يحسن التصريحُ بهما: أنه ليس ثمنًا، فالثمنُ ينقل مِلكَ شيء، وليست هي مملوكةً لأحد. وأنّ قوله ﴿طِبۡنَ﴾ يعني الطِّيبَ حقيقةً: فالزوجةُ التي تُضغط لتردَّه، أو يقال لها إنّ الأهل محتاجون، لم تتنازل عن شيء.",
      ...
      items: [
        {
          ...
          proofAr: "وَمِنۡ ءَايَٰتِهِۦٓ أَنۡ خَلَقَ لَكُم مِّنۡ أَنفُسِكُمۡ أَزۡوَٰجٗا لِّتَسۡكُنُوٓاْ إِلَيۡهَا وَجَعَلَ بَيۡنَكُم مَّوَدَّةٗ وَرَحۡمَةًۚ إِنَّ فِي ذَٰلِكَ لَأٓيَٰتٖ لِّقَوۡمٖ يَتَفَكَّرُونَ",
          ...
          exampleAr: "وثَمَّ وصفٌ لهما في موضعٍ آخر يحسن الوقوفُ عنده: ﴿هُنَّ لِبَاسٞ لَّكُمۡ وَأَنتُمۡ لِبَاسٞ لَّهُنَّۗ﴾ [البقرة ٢:١٨٧]. واللباسُ أقربُ ما إليك، وهو الذي يستر ما تكره أن يُرى، وهو الذي يقيك البرد. وهو أيضًا الذي ترى عيبَه قبل أن يراه أحد — ولا تُعلنه.",
        ...
        },
        {
          ...
          titleAr: "﴿وَعَاشِرُوهُنَّ بِٱلۡمَعۡرُوفِۚ﴾ — والجملة في ألّا تُلغيها",
          ...
          plainAr: "ليس الأمرُ «لا تظلموهنّ»، بل هو أعلى من ذلك: ﴿وَعَاشِرُوهُنَّ بِٱلۡمَعۡرُوفِۚ﴾ — في نسيج البيت اليوميّ العاديّ لا في الشدائد وحدها.\n\nثم تمضي الآيةُ إلى ما هو غايةٌ في الواقعيّة: ﴿فَإِن كَرِهۡتُمُوهُنَّ فَعَسَىٰٓ أَن تَكۡرَهُواْ شَيۡـٔٗا وَيَجۡعَلَ ٱللَّهُ فِيهِ خَيۡرٗا كَثِيرٗا﴾. والخطابُ لرجلٍ ليس راضيًا الآن، وهو وحده الذي يحتاج أن يسمعها.",
          ...
          proofAr: "وَعَاشِرُوهُنَّ بِٱلۡمَعۡرُوفِۚ فَإِن كَرِهۡتُمُوهُنَّ فَعَسَىٰٓ أَن تَكۡرَهُواْ شَيۡـٔٗا وَيَجۡعَلَ ٱللَّهُ فِيهِ خَيۡرٗا كَثِيرٗا",
      ...
      items: [
        {
          ...
          plainAr: "قبل أن يُنهى شيء أُمر بأمرين: أوّلهما أن يُصلحا بينهما: ﴿فَلَا جُنَاحَ عَلَيۡهِمَآ أَن يُصۡلِحَا بَيۡنَهُمَا صُلۡحٗاۚ وَٱلصُّلۡحُ خَيۡرٞۗ﴾. وسمّت الآيةُ نفسها العائقَ بصدق: ﴿وَأُحۡضِرَتِ ٱلۡأَنفُسُ ٱلشُّحَّۚ﴾. لم تقل القسوة، وإنما قالت الشحّ — وهو الامتناعُ عن آخر شبر.\n\nثم إن لم يقع ذلك فالتحكيم: ﴿حَكَمٗا مِّنۡ أَهۡلِهِۦ وَحَكَمٗا مِّنۡ أَهۡلِهَآ﴾. وتأمّل البناء: ليس شيخًا واحدًا حكيمًا، وإنما واحدٌ من كلِّ جهة، لئلّا يُحاكَم طرفٌ إلى أهل الطرف الآخر.",
          ...
          proofAr: "وَإِنۡ خِفۡتُمۡ شِقَاقَ بَيۡنِهِمَا فَٱبۡعَثُواْ حَكَمٗا مِّنۡ أَهۡلِهِۦ وَحَكَمٗا مِّنۡ أَهۡلِهَآ إِن يُرِيدَآ إِصۡلَٰحٗا يُوَفِّقِ ٱللَّهُ بَيۡنَهُمَآۗ",
          ...
          noteAr: "واقرأ الشرطَ في آخرها: ﴿إِن يُرِيدَآ إِصۡلَٰحٗا﴾. فليس التحكيمُ محكمةً تفرض حكمًا على اثنين قد عزما، وإنما هو عونٌ لاثنين يريدان أن يقفا.",
        ...
        },
        {
          ...
          plainAr: "الطلاقُ مباح، وليس بلوغُه سقوطًا في الأخلاق؛ فمن الأنكحة ما ينبغي أن ينتهي، وليس دينُ المرأة يقول لها ابقي في بيتٍ يُؤذيها.\n\nولكن للوجه صفةٌ منصوصة، ولا يكاد شيءٌ منها يُصنع في الواقع: أن يُطلَّق لأوّل العدّة، وأن تُحصى العدّة، وألّا تُخرج من بيتها ولا تخرج، ثم ﴿إِمۡسَاكُۢ بِمَعۡرُوفٍ أَوۡ تَسۡرِيحُۢ بِإِحۡسَٰنٖۗ﴾، وأن يُشهد ذوا عدل. ولا يحلّ أن يُؤخذ ممّا أُعطيت شيء.",
          ...
          proofAr: "ٱلطَّلَٰقُ مَرَّتَانِۖ فَإِمۡسَاكُۢ بِمَعۡرُوفٍ أَوۡ تَسۡرِيحُۢ بِإِحۡسَٰنٖۗ وَلَا يَحِلُّ لَكُمۡ أَن تَأۡخُذُواْ مِمَّآ ءَاتَيۡتُمُوهُنَّ شَيۡـًٔا",
          ...
          extraProofAr: "يَٰٓأَيُّهَا ٱلنَّبِيُّ إِذَا طَلَّقۡتُمُ ٱلنِّسَآءَ فَطَلِّقُوهُنَّ لِعِدَّتِهِنَّ وَأَحۡصُواْ ٱلۡعِدَّةَۖ ... لَا تُخۡرِجُوهُنَّ مِنۢ بُيُوتِهِنَّ وَلَا يَخۡرُجۡنَ ... لَا تَدۡرِي لَعَلَّ ٱللَّهَ يُحۡدِثُ بَعۡدَ ذَٰلِكَ أَمۡرٗا",
          ...
          noteAr: "تنبيهٌ في الجملة التي ينقلها الناسُ جميعًا: «أبغضُ الحلال إلى الله الطلاق». هي خارج الصحيحين، رواها ابن ماجه (٢٠١٨) وأبو داود، وفي إسنادها مقال، وضعّفها كثيرٌ من أهل الحديث أو أعلّوها بالإرسال. ولا حاجة إليها؛ فإنّ سورة الطلاق أوجبت عدّةً تمكث فيها في البيت، ثم قالت: ﴿لَعَلَّ ٱللَّهَ يُحۡدِثُ بَعۡدَ ذَٰلِكَ أَمۡرٗا﴾. فالإجراءُ كلُّه مبنيٌّ على تمكين الرجوع، وهذه هي الحجّة، وهي في القرآن.",
      ...
      items: [
        {
          ...
          plainAr: "ليست في صلاةٍ ولا في جنّة. أطولُ آيةٍ في القرآن — البقرة ٢:٢٨٢ — إجراءٌ مفصَّلٌ لتوثيق دَين: أن يُكتب، وأن يكتب بينهم كاتبٌ بالعدل، وأن يُملي الذي عليه الحقّ، وأن يُستشهد شهيدان، وألّا يُسأم من كتابته ﴿صَغِيرًا أَوۡ كَبِيرًا إِلَىٰٓ أَجَلِهِۦۚ﴾.\n\nوصرّحت بالعلّة: ﴿ذَٰلِكُمۡ أَقۡسَطُ عِندَ ٱللَّهِ وَأَقۡوَمُ لِلشَّهَٰدَةِ وَأَدۡنَىٰٓ أَلَّا تَرۡتَابُوٓاْ﴾. فليس الإسلامُ يجعل الكتابةَ علامةً على أنك تتّهم أخاك، وإنما يجعلها حفظًا له ولك من ذاكرةٍ لن تتّفق بعد ثلاث سنين.",
          ...
          proofAr: "يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُوٓاْ إِذَا تَدَايَنتُم بِدَيۡنٍ إِلَىٰٓ أَجَلٖ مُّسَمّٗى فَٱكۡتُبُوهُۚ ... وَلَا تَسۡـَٔمُوٓاْ أَن تَكۡتُبُوهُ صَغِيرًا أَوۡ كَبِيرًا إِلَىٰٓ أَجَلِهِۦۚ ذَٰلِكُمۡ أَقۡسَطُ عِندَ ٱللَّهِ وَأَقۡوَمُ لِلشَّهَٰدَةِ وَأَدۡنَىٰٓ أَلَّا تَرۡتَابُوٓاْ",
          ...
          keys: ["contracts", "write it down", "loan agreement", "business agreement", "witnesses",
                 "verbal agreement", "he denied the loan", "العقود", "كتابة الدين", "الشهود", "اتفاق شفهي",
                 "أنكر الدين", "write the debt down", "debt in writing", "lent money without writing",
                 "he owes me and denies", "كتابة القرض", "أقرضته ولم أكتب", "أنكر القرض"]
        },
        {
          id: "mg-keep", icon: "🔐",
          ...
          proofAr: "إِنَّ ٱللَّهَ يَأۡمُرُكُمۡ أَن تُؤَدُّواْ ٱلۡأَمَٰنَٰتِ إِلَىٰٓ أَهۡلِهَا وَإِذَا حَكَمۡتُم بَيۡنَ ٱلنَّاسِ أَن تَحۡكُمُواْ بِٱلۡعَدۡلِۚ",
          ...
          extraProofAr: "وَأَوۡفُواْ بِٱلۡعَهۡدِۖ إِنَّ ٱلۡعَهۡدَ كَانَ مَسۡـُٔولٗا",
          ...
          noteAr: "وثَمَّ كلمةٌ وصف بها القرآنُ عَقدَ النكاح يحسن الختمُ بها: قال في الذي أخذته الزوجةُ من زوجها: ﴿وَأَخَذۡنَ مِنكُم مِّيثَٰقًا غَلِيظٗا﴾ [النساء ٤:٢١]. وبهذا اللفظ نفسه وُصف الميثاقُ المأخوذ على النبيّين. فهذه طبقةُ هذا العقد في الثقل.",
