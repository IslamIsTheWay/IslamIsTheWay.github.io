      ...
      items: [
        {
          ...
          exampleAr: "وآيةُ الشورى تقرّر القاعدة في كلمات: ﴿لَيۡسَ كَمِثۡلِهِۦ شَيۡءٞۖ﴾. ومعنى ذلك أنّ كلَّ تشبيهٍ خطر لك — كملكٍ أو كوالدٍ أو كقاضٍ — فهو تشبيهٌ تستعين به على التفكير، لا وصفٌ له سبحانه.\n\nولهذا أيضًا أنفق القرآنُ في بيان ما يفعل أضعافَ ما أنفق في بيان ما هو. فأنت لا تُطيق إدراكه، وإنما تُطيق أن ترى فعله.",
          ...
          proofAr: "قُلۡ هُوَ ٱللَّهُ أَحَدٌ ۝ ٱللَّهُ ٱلصَّمَدُ ۝ لَمۡ يَلِدۡ وَلَمۡ يُولَدۡ ۝ وَلَمۡ يَكُن لَّهُۥ كُفُوًا أَحَدُۢ",
        ...
        },
        {
          ...
          plainAr: "﴿ٱلۡحَيُّ ٱلۡقَيُّومُۚ﴾ — الحيُّ الذي يقوم به كلُّ ما سواه. فكلُّ حيٍّ غيره يُمسكه شيء، وهو لا يُمسكه شيء.\n\n﴿لَا تَأۡخُذُهُۥ سِنَةٞ وَلَا نَوۡمٞۚ﴾ — فليس الكونُ يمضي بنفسه وهو ساكن. ولا يُترك شيءٌ لحظةً بلا رعاية.\n\n﴿لَّهُۥ مَا فِي ٱلسَّمَٰوَٰتِ وَمَا فِي ٱلۡأَرۡضِۗ﴾ — ومنه الذي تحسب أنك تملكه.\n\n﴿مَن ذَا ٱلَّذِي يَشۡفَعُ عِندَهُۥٓ إِلَّا بِإِذۡنِهِۦۚ﴾ — فليس لأحدٍ عليه سلطان، ولا وسيطَ يُتوسّل به.\n\n﴿يَعۡلَمُ مَا بَيۡنَ أَيۡدِيهِمۡ وَمَا خَلۡفَهُمۡۖ﴾ — ماضيك ومستقبلك معًا في آن.\n\n﴿وَلَا يُحِيطُونَ بِشَيۡءٖ مِّنۡ عِلۡمِهِۦٓ إِلَّا بِمَا شَآءَۚ﴾ — فكلُّ علمٍ ناله بشريٌّ قطُّ فقد أُعطيه.\n\n﴿وَسِعَ كُرۡسِيُّهُ ٱلسَّمَٰوَٰتِ وَٱلۡأَرۡضَۖ وَلَا يَـُٔودُهُۥ حِفۡظُهُمَاۚ﴾ — لا يشقّ عليه.",
        ...
        },
        {
          ...
          plainAr: "اقرأ ثلاث آياتٍ في آخر سورة الحشر تجد جملةً كبيرةً منها في موضعٍ واحد: ﴿ٱلۡمَلِكُ ٱلۡقُدُّوسُ ٱلسَّلَٰمُ ٱلۡمُؤۡمِنُ ٱلۡمُهَيۡمِنُ ٱلۡعَزِيزُ ٱلۡجَبَّارُ ٱلۡمُتَكَبِّرُۚ﴾، ثم ﴿ٱلۡخَٰلِقُ ٱلۡبَارِئُ ٱلۡمُصَوِّرُۖ﴾.\n\nوالأمرُ المقرون بالأسماء ليس حفظَها بل استعمالَها: ﴿وَلِلَّهِ ٱلۡأَسۡمَآءُ ٱلۡحُسۡنَىٰ فَٱدۡعُوهُ بِهَاۖ﴾ [الأعراف ١٨٠].\n\nفادعُ الرزّاق إذا ضاق بك المال، والشافي إذا مرضت، والغفّار إذا فعلتَ ما لا تستطيع أن تقوله بصوتٍ عالٍ. فالاسمُ الذي تحتاجه يدلّك على أيّها تقصد.",
          ...
          extraProofAr: "هُوَ ٱللَّهُ ٱلَّذِي لَآ إِلَٰهَ إِلَّا هُوَ ٱلۡمَلِكُ ٱلۡقُدُّوسُ ٱلسَّلَٰمُ ٱلۡمُؤۡمِنُ ٱلۡمُهَيۡمِنُ ٱلۡعَزِيزُ ٱلۡجَبَّارُ ٱلۡمُتَكَبِّرُۚ سُبۡحَٰنَ ٱللَّهِ عَمَّا يُشۡرِكُونَ",
        ...
        },
        {
          ...
          plainAr: "﴿وَلَا يُحِيطُونَ بِهِۦ عِلۡمٗا﴾ [طه ١١٠]. فعقلُك إنما جُعل لتناول المخلوقات. وكلُّ آلةٍ تفكّر بها — الزمانُ والمكانُ والحجمُ والقبلُ والبعد — مخلوقة، وهو خالقُها جميعًا.\n\nفمن قال «لا أستطيع أن أتصوّر الله» فلم يقع على إشكال، وإنما وقع على الجواب الصحيح.",
          ...
          proofAr: "يَعۡلَمُ مَا بَيۡنَ أَيۡدِيهِمۡ وَمَا خَلۡفَهُمۡ وَلَا يُحِيطُونَ بِهِۦ عِلۡمٗا",
...

    {
      ...
      items: [
        ...
        },
        {
          ...
          simpleAr: "وصف القرآنُ أنبياءَ زُلزلوا حتى قالوا جهرًا: ﴿مَتَىٰ نَصۡرُ ٱللَّهِۗ﴾. ولم يجعل ذلك ضعفًا، وإنما جعله الطريقَ المعتاد.",
          ...
          plainAr: "آيةُ البقرة من أقلّ ما يُقرأ في القرآن على قدره: ﴿أَمۡ حَسِبۡتُمۡ أَن تَدۡخُلُواْ ٱلۡجَنَّةَ وَلَمَّا يَأۡتِكُم مَّثَلُ ٱلَّذِينَ خَلَوۡاْ مِن قَبۡلِكُمۖ مَّسَّتۡهُمُ ٱلۡبَأۡسَآءُ وَٱلضَّرَّآءُ وَزُلۡزِلُواْ حَتَّىٰ يَقُولَ ٱلرَّسُولُ وَٱلَّذِينَ ءَامَنُواْ مَعَهُۥ مَتَىٰ نَصۡرُ ٱللَّهِۗ﴾.\n\nفالرسولُ هو الذي قالها. لا تابعٌ ضعيف، بل الرسول.\n\nويأتي الجوابُ في النَّفَس نفسه، لا عتابًا بل جوابًا: ﴿أَلَآ إِنَّ نَصۡرَ ٱللَّهِ قَرِيبٞ﴾.",
          ...
          proofAr: "أَمۡ حَسِبۡتُمۡ أَن تَدۡخُلُواْ ٱلۡجَنَّةَ وَلَمَّا يَأۡتِكُم مَّثَلُ ٱلَّذِينَ خَلَوۡاْ مِن قَبۡلِكُمۖ مَّسَّتۡهُمُ ٱلۡبَأۡسَآءُ وَٱلضَّرَّآءُ وَزُلۡزِلُواْ حَتَّىٰ يَقُولَ ٱلرَّسُولُ وَٱلَّذِينَ ءَامَنُواْ مَعَهُۥ مَتَىٰ نَصۡرُ ٱللَّهِۗ أَلَآ إِنَّ نَصۡرَ ٱللَّهِ قَرِيبٞ",
      ...
      items: [
        {
          ...
          simpleAr: "وصف القرآنُ قومًا نسوه فقال: ﴿فَتَحۡنَا عَلَيۡهِمۡ أَبۡوَٰبَ كُلِّ شَيۡءٍ حَتَّىٰٓ إِذَا فَرِحُواْ بِمَآ أُوتُوٓاْ أَخَذۡنَٰهُم بَغۡتَةٗ﴾. فاليُسرُ قد يكون عطاءً، وقد يكون حبلًا يُرخى.",
          ...
          plainAr: "وهذا الذي يسمّيه أهلُ العلم الاستدراج.\n\nوالآيةُ دقيقةٌ في الترتيب: أوّلًا ﴿نَسُواْ مَا ذُكِّرُواْ بِهِۦ﴾. ثم فُتحت أبوابُ كلِّ شيء. ثم فرحوا بها. ثم انتهى الأمرُ بغتة.\n\nوآيةُ المؤمنون تسألها سؤالًا: ﴿أَيَحۡسَبُونَ أَنَّمَا نُمِدُّهُم بِهِۦ مِن مَّالٖ وَبَنِينَ ۝ نُسَارِعُ لَهُمۡ فِي ٱلۡخَيۡرَٰتِۚ بَل لَّا يَشۡعُرُونَ﴾.\n\nوآيةُ آل عمران: ﴿وَلَا يَحۡسَبَنَّ ٱلَّذِينَ كَفَرُوٓاْ أَنَّمَا نُمۡلِي لَهُمۡ خَيۡرٞ لِّأَنفُسِهِمۡۚ إِنَّمَا نُمۡلِي لَهُمۡ لِيَزۡدَادُوٓاْ إِثۡمٗاۖ﴾.",
          ...
          proofAr: "فَلَمَّا نَسُواْ مَا ذُكِّرُواْ بِهِۦ فَتَحۡنَا عَلَيۡهِمۡ أَبۡوَٰبَ كُلِّ شَيۡءٍ حَتَّىٰٓ إِذَا فَرِحُواْ بِمَآ أُوتُوٓاْ أَخَذۡنَٰهُم بَغۡتَةٗ فَإِذَا هُم مُّبۡلِسُونَ",
          ...
          extraProofAr: "وَلَا يَحۡسَبَنَّ ٱلَّذِينَ كَفَرُوٓاْ أَنَّمَا نُمۡلِي لَهُمۡ خَيۡرٞ لِّأَنفُسِهِمۡۚ إِنَّمَا نُمۡلِي لَهُمۡ لِيَزۡدَادُوٓاْ إِثۡمٗاۖ وَلَهُمۡ عَذَابٞ مُّهِينٞ",
        ...
        },
        {
          ...
          proofAr: "إِنَّ ٱللَّهَ يُحِبُّ ٱلتَّوَّٰبِينَ وَيُحِبُّ ٱلۡمُتَطَهِّرِينَ",
          ref: "Surah Al-Baqarah (2:222)",
          refAr: "سورة البقرة (٢:٢٢٢)",
          strength: "The Quran",
          strengthAr: "القرآن الكريم",
          extraProof: "Indeed, He does not like the arrogant.",
          extraProofAr: "إِنَّهُۥ لَا يُحِبُّ ٱلۡمُسۡتَكۡبِرِينَ",
...

    {
      ...
      items: [
        ...
        },
        {
          ...
          plainAr: "قال ﷺ: «لن يُدخل الجنّة أحدًا عملُه». قالوا: ولا أنت يا رسول الله؟ قال: «ولا أنا، إلا أن يتغمّدني الله برحمةٍ منه».\n\nاقرأها متمهّلًا، فإنها الجملةُ التي يُحتجّ بها على ترك العمل، وليس فيها ذلك.\n\nإنما فيها أنّ العمل ليس ثمنًا. فالجنّةُ لا تُشترى، ولا يبتاعها مقدارٌ من صلاة. والقرآنُ نفسُه يقول: ﴿ٱدۡخُلُواْ ٱلۡجَنَّةَ بِمَا كُنتُمۡ تَعۡمَلُونَ﴾ [النحل ٣٢]، و﴿وَتِلۡكَ ٱلۡجَنَّةُ ٱلَّتِيٓ أُورِثۡتُمُوهَا بِمَا كُنتُمۡ تَعۡمَلُونَ﴾ [الزخرف ٧٢].",
          ...
          extraProofAr: "ٱلَّذِينَ تَتَوَفَّىٰهُمُ ٱلۡمَلَٰٓئِكَةُ طَيِّبِينَ يَقُولُونَ سَلَٰمٌ عَلَيۡكُمُ ٱدۡخُلُواْ ٱلۡجَنَّةَ بِمَا كُنتُمۡ تَعۡمَلُونَ",
      ...
      items: [
        {
          ...
          proofAr: "كُلُّ نَفۡسٖ ذَآئِقَةُ ٱلۡمَوۡتِۗ وَإِنَّمَا تُوَفَّوۡنَ أُجُورَكُمۡ يَوۡمَ ٱلۡقِيَٰمَةِۖ فَمَن زُحۡزِحَ عَنِ ٱلنَّارِ وَأُدۡخِلَ ٱلۡجَنَّةَ فَقَدۡ فَازَۗ وَمَا ٱلۡحَيَوٰةُ ٱلدُّنۡيَآ إِلَّا مَتَٰعُ ٱلۡغُرُورِ",
