...
const PILLARS = {
    ...
    /* ---------------- THE FIVE PILLARS OF ISLAM ---------------- */
    {
      ...
      items: [
        ...
        },
        {
          ...
          proofAr: "يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُواْ كُتِبَ عَلَيۡكُمُ ٱلصِّيَامُ كَمَا كُتِبَ عَلَى ٱلَّذِينَ مِن قَبۡلِكُمۡ لَعَلَّكُمۡ تَتَّقُونَ",
        ...
        },
        {
          ...
          proofAr: "وَلِلَّهِ عَلَى ٱلنَّاسِ حِجُّ ٱلۡبَيۡتِ مَنِ ٱسۡتَطَاعَ إِلَيۡهِ سَبِيلٗاۚ",
    ...
    /* ---------------- THE SIX PILLARS OF FAITH ---------------- */
    {
      ...
      items: [
        ...
        },
        {
          ...
          proofAr: "يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُوٓاْ ءَامِنُواْ بِٱللَّهِ وَرَسُولِهِۦ وَٱلۡكِتَٰبِ ٱلَّذِي نَزَّلَ عَلَىٰ رَسُولِهِۦ وَٱلۡكِتَٰبِ ٱلَّذِيٓ أَنزَلَ مِن قَبۡلُۚ",
        ...
        },
        {
          ...
          proofAr: "إِنَّا كُلَّ شَيۡءٍ خَلَقۡنَٰهُ بِقَدَرٖ",
  ...
  zakat: {
    ...
    recipients: {
      ...
      proofAr: "إِنَّمَا ٱلصَّدَقَٰتُ لِلۡفُقَرَآءِ وَٱلۡمَسَٰكِينِ وَٱلۡعَٰمِلِينَ عَلَيۡهَا وَٱلۡمُؤَلَّفَةِ قُلُوبُهُمۡ وَفِي ٱلرِّقَابِ وَٱلۡغَٰرِمِينَ وَفِي سَبِيلِ ٱللَّهِ وَٱبۡنِ ٱلسَّبِيلِۖ فَرِيضَةٗ مِّنَ ٱللَّهِۗ",
    ...
    virtues: {
      ...
      points: [
        ...
        { en: "**Allah replaces what you spend.** \"Whatever thing you spend, He will replace it, and He is the best of providers.\"",
          ar: "**والله يُخلف ما أنفقت.** ﴿وَمَآ أَنفَقۡتُم مِّن شَيۡءٖ فَهُوَ يُخۡلِفُهُۥۖ وَهُوَ خَيۡرُ ٱلرَّٰزِقِينَ﴾.",
        ...
        { en: "**He wipes out interest and grows charity.** \"Allah destroys interest and gives increase for charities.\"",
          ar: "**ويمحق الربا ويُنمي الصدقة.** ﴿يَمۡحَقُ ٱللَّهُ ٱلرِّبَوٰاْ وَيُرۡبِي ٱلصَّدَقَٰتِۗ﴾.",
