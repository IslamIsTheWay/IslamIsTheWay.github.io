...
},
{
  ...
  body: [
    ...
    { h: "For the other: the gates of the sky are not opened at all",
      ...
      ar: "ويُصعَد بالروح الخبيثة، <strong>فيُستفتح لها فلا يُفتح لها</strong>. ثمّ قرأ النبيُّ ﷺ: ﴿لَا تُفَتَّحُ لَهُمۡ أَبۡوَٰبُ ٱلسَّمَآءِ وَلَا يَدۡخُلُونَ ٱلۡجَنَّةَ حَتَّىٰ يَلِجَ ٱلۡجَمَلُ فِي سَمِّ ٱلۡخِيَاطِۚ﴾ [الأعراف: ٤٠].\n\nفيقول الله عزّ وجلّ: اكتبوا كتابه في سِجِّينٍ في الأرض السفلى، <strong>فتُطرح روحه طرحًا</strong>. ثمّ قرأ: ﴿وَمَن يُشۡرِكۡ بِٱللَّهِ فَكَأَنَّمَا خَرَّ مِنَ ٱلسَّمَآءِ فَتَخۡطَفُهُ ٱلطَّيۡرُ أَوۡ تَهۡوِي بِهِ ٱلرِّيحُ فِي مَكَانٖ سَحِيقٖ﴾ [الحج: ٣١].",
...
},
{
  ...
  body: [
    ...
    { h: "What the Quran says happens to the world",
      ...
      ar: "وصفه القرآن بآياتٍ قصارٍ متتابعة. فـ<strong>الجبال</strong> ﴿كَٱلۡعِهۡنِ ٱلۡمَنفُوشِ﴾ [القارعة: ٥]، و﴿وَسُيِّرَتِ ٱلۡجِبَالُ فَكَانَتۡ سَرَابًا﴾ [النبأ: ٢٠]. و<strong>البحار</strong> ﴿وَإِذَا ٱلۡبِحَارُ فُجِّرَتۡ﴾ [الانفطار: ٣]، ﴿وَإِذَا ٱلۡبِحَارُ سُجِّرَتۡ﴾ [التكوير: ٦]. و<strong>السماء</strong> ﴿فَإِذَا ٱنشَقَّتِ ٱلسَّمَآءُ فَكَانَتۡ وَرۡدَةٗ كَٱلدِّهَانِ﴾ [الرحمن: ٣٧]، و<strong>النجوم</strong> ﴿وَإِذَا ٱلنُّجُومُ ٱنكَدَرَتۡ﴾ [التكوير: ٢]. و<strong>الشمس والقمر</strong>: ﴿وَخَسَفَ ٱلۡقَمَرُ • وَجُمِعَ ٱلشَّمۡسُ وَٱلۡقَمَرُ﴾ [القيامة: ٨–٩].\n\nوأمّا الأرض: ﴿إِذَا زُلۡزِلَتِ ٱلۡأَرۡضُ زِلۡزَالَهَا • وَأَخۡرَجَتِ ٱلۡأَرۡضُ أَثۡقَالَهَا • وَقَالَ ٱلۡإِنسَٰنُ مَا لَهَا﴾ [الزلزلة: ١–٣].",
    ...
    { h: "And then no one is left",
      ...
      ar: "﴿وَنُفِخَ فِي ٱلصُّورِ فَصَعِقَ مَن فِي ٱلسَّمَٰوَٰتِ وَمَن فِي ٱلۡأَرۡضِ إِلَّا مَن شَآءَ ٱللَّهُۖ﴾ [الزمر: ٦٨].\n\nثمّ ﴿لِّمَنِ ٱلۡمُلۡكُ ٱلۡيَوۡمَۖ﴾ فلا يبقى مجيب، فيأتي الجواب: ﴿لِلَّهِ ٱلۡوَٰحِدِ ٱلۡقَهَّارِ﴾ [غافر: ١٦].",
...
},
{
  ...
  body: [
    { h: "Right hand, or behind the back",
      ...
      ar: "﴿فَأَمَّا مَنۡ أُوتِيَ كِتَٰبَهُۥ بِيَمِينِهِۦ • فَسَوۡفَ يُحَاسَبُ حِسَابٗا يَسِيرٗا • وَيَنقَلِبُ إِلَىٰٓ أَهۡلِهِۦ مَسۡرُورٗا • وَأَمَّا مَنۡ أُوتِيَ كِتَٰبَهُۥ وَرَآءَ ظَهۡرِهِۦ • فَسَوۡفَ يَدۡعُواْ ثُبُورٗا • وَيَصۡلَىٰ سَعِيرًا﴾ [الانشقاق: ٧–١٢].\n\nوفيما فيه: ﴿وَوُضِعَ ٱلۡكِتَٰبُ فَتَرَى ٱلۡمُجۡرِمِينَ مُشۡفِقِينَ مِمَّا فِيهِ وَيَقُولُونَ يَٰوَيۡلَتَنَا مَالِ هَٰذَا ٱلۡكِتَٰبِ لَا يُغَادِرُ صَغِيرَةٗ وَلَا كَبِيرَةً إِلَّآ أَحۡصَىٰهَاۚ وَوَجَدُواْ مَا عَمِلُواْ حَاضِرٗاۗ وَلَا يَظۡلِمُ رَبُّكَ أَحَدٗا﴾ [الكهف: ٤٩].",
      ...
      { head: "The number of gates",
        ...
        points: [
          ...
          { en: "It is <strong>Hell</strong> that has <strong>seven</strong> gates — <em>“It has seven gates”</em> (Surah Al-Hijr 15:44). The two numbers get swapped constantly.",
            ar: "وإنّما <strong>لجهنّم سبعة أبواب</strong> — ﴿لَهَا سَبۡعَةُ أَبۡوَٰبٖ﴾ [الحجر: ٤٤]. وكثيرًا ما يقع الخلط بين العددين." },
...
,
{
  ...
  body: [
    ...
    { h: "What is under it, and what is said in it",
      ...
      ar: "وُصفت الجنّات مرّةً بعد مرّةٍ بأنّها ﴿تَجۡرِي مِن تَحۡتِهَا ٱلۡأَنۡهَٰرُ﴾. وفي أصنافها: ﴿أَنۡهَٰرٞ مِّن مَّآءٍ غَيۡرِ ءَاسِنٖ وَأَنۡهَٰرٞ مِّن لَّبَنٖ لَّمۡ يَتَغَيَّرۡ طَعۡمُهُۥ وَأَنۡهَٰرٞ مِّنۡ خَمۡرٖ لَّذَّةٖ لِّلشَّٰرِبِينَ وَأَنۡهَٰرٞ مِّنۡ عَسَلٖ مُّصَفّٗىۖ﴾ [محمد: ١٥].\n\nوأمّا ما يُسمع فيها: ﴿لَا يَسۡمَعُونَ فِيهَا لَغۡوٗا وَلَا تَأۡثِيمًا • إِلَّا قِيلٗا سَلَٰمٗا سَلَٰمٗا﴾ [الواقعة: ٢٥–٢٦]، و﴿دَعۡوَىٰهُمۡ فِيهَا سُبۡحَٰنَكَ ٱللَّهُمَّ وَتَحِيَّتُهُمۡ فِيهَا سَلَٰمٞۚ وَءَاخِرُ دَعۡوَىٰهُمۡ أَنِ ٱلۡحَمۡدُ لِلَّهِ رَبِّ ٱلۡعَٰلَمِينَ﴾ [يونس: ١٠].\n\nوفي نزع ما كان بين الناس: ﴿وَنَزَعۡنَا مَا فِي صُدُورِهِم مِّنۡ غِلٍّ إِخۡوَٰنًا عَلَىٰ سُرُرٖ مُّتَقَٰبِلِينَ﴾ [الحجر: ٤٧].",
