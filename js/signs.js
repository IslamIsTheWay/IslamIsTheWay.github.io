...
const SIGNS_INTRO = {
  ...
  nobodyKnows: {
    ...
    ar: "ابدأ من هنا، فمن هذا الباب يدخل أكثرُ الخطأ فيما يُقال عن نهاية العالم.\n\nسُئل القرآنُ هذا السؤال صريحًا فأجاب صريحًا: ﴿يَسۡـَٔلُونَكَ عَنِ ٱلسَّاعَةِ أَيَّانَ مُرۡسَىٰهَاۖ قُلۡ إِنَّمَا عِلۡمُهَا عِندَ رَبِّيۖ﴾. وجُعلت في سورة لقمان في جملة خمسٍ لا يعلمها إلا الله.\n\nفمن أعلن سنةً، أو نزّل حربًا على حديث، أو أخبرك أنّا آخر جيلٍ يقينًا، فقد عارض آيةً محكمة. ويحسن علم هذا قبل قراءة علامةٍ واحدةٍ ممّا يأتي، فإنه الفرق بين أن تتعلّم ما قيل وأن تُروَّع بما لم يُقل.\n\nوقد سُئل النبيُّ ﷺ عن الساعة متى هي، فلم يُجب بموعد، وإنما ردّ السؤال: ماذا أعددتَ لها؟",
    verses: [
      {
        ar: "يَسۡـَٔلُونَكَ عَنِ ٱلسَّاعَةِ أَيَّانَ مُرۡسَىٰهَاۖ قُلۡ إِنَّمَا عِلۡمُهَا عِندَ رَبِّيۖ لَا يُجَلِّيهَا لِوَقۡتِهَآ إِلَّا هُوَۚ ثَقُلَتۡ فِي ٱلسَّمَٰوَٰتِ وَٱلۡأَرۡضِۚ لَا تَأۡتِيكُمۡ إِلَّا بَغۡتَةٗۗ",
      ...
      {
        ar: "إِنَّ ٱللَّهَ عِندَهُۥ عِلۡمُ ٱلسَّاعَةِ",
  ...
  orderDetail: {
    ...
    blocks: [
      ...
      },
      {
        ...
        ar: "هذا يحسم الترتيب بحجّةٍ يفهمها كلُّ أحد، ولا تتوقّف على قول عالم.\n\nضَعْ نصّين ثابتين أحدهما إلى جانب الآخر. الأوّل: أنّ الشمس إذا طلعت من مغربها ﴿لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ﴾ — وهو في صحيح مسلم، ومنقولٌ في آخر هذا القسم. والثاني: أنّ عيسى ابن مريم عليه السلام إذا نزل **آمن الناس**؛ قال الله في أهل الكتاب: ﴿وَإِن مِّنۡ أَهۡلِ ٱلۡكِتَٰبِ إِلَّا لَيُؤۡمِنَنَّ بِهِۦ قَبۡلَ مَوۡتِهِۦۖ﴾، وهو يحكم بهذا الدين ويكسر الصليب ويضع الجزية إذ لا يبقى من تُؤخذ منه.\n\nفالإيمانُ في زمن عيسى مقبولٌ معمولٌ به، وبعد طلوع الشمس من مغربها ليس كذلك. فلزم أن يكون نزولُ عيسى **قبل** طلوع الشمس من مغربها، ومعه الدجّالُ الذي يقتله، ويأجوجُ ومأجوجُ الذين يُفتح عنهم وهو في الأرض.\n\nوليس هذا ترجيحًا بين قولين، وإنما هما نصّان لا يمكن أن يصحّا معًا على الترتيب الآخر.",
        quote: "وَإِن مِّنۡ أَهۡلِ ٱلۡكِتَٰبِ إِلَّا لَيُؤۡمِنَنَّ بِهِۦ قَبۡلَ مَوۡتِهِۦۖ",
      ...
      },
      {
        ...
        ar: "وليس هذا في الترتيب، ولكنه موضعه، لأنه سببُ أهمّيّة الترتيب أصلًا.\n\nقال ﷺ: **ثَلَاثٌ إِذَا خَرَجْنَ ﴿لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ أَوۡ كَسَبَتۡ فِيٓ إِيمَٰنِهَا خَيۡرٗاۗ﴾: طُلُوعُ الشَّمْسِ مِنْ مَغْرِبِهَا، وَالدَّجَّالُ، وَدَابَّةُ الْأَرْضِ**.\n\nفليست هذه الآياتُ عدًّا تنازليًّا يُرقَب، وإنما هي حدُّ انغلاق باب القبول. وكلُّ ما تصفه بقيّةُ هذه الصفحة موجَّهٌ إلى ما يصنعه المرء **قبل ذلك**، وهو وحده الذي ما زال بيد أحد.",
        quote: "ثَلَاثٌ إِذَا خَرَجْنَ ﴿لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ﴾: طُلُوعُ الشَّمْسِ مِنْ مَغْرِبِهَا، وَالدَّجَّالُ، وَدَابَّةُ الْأَرْضِ",
...
const MAJOR_SIGNS = [
  ...
  },
  {
    ...
    points: [
      { en: "“Until, when Gog and Magog are let loose, and they descend rapidly from every height.”",
        ar: "﴿حَتَّىٰٓ إِذَا فُتِحَتۡ يَأۡجُوجُ وَمَأۡجُوجُ وَهُم مِّن كُلِّ حَدَبٖ يَنسِلُونَ﴾",
      ...
      { en: "Dhul-Qarnayn, having built the barrier, said: this is a mercy from my Lord — and when the promise of my Lord comes, He will level it. So the barrier's end is itself part of the appointed promise.",
        ar: "قال ذو القرنين لَمّا بنى السدّ: ﴿هَٰذَا رَحۡمَةٞ مِّن رَّبِّيۖ فَإِذَا جَآءَ وَعۡدُ رَبِّي جَعَلَهُۥ دَكَّآءَۖ﴾. فزوالُ السدّ نفسه من الوعد المضروب.",
      ...
      { en: "The barrier is in the Quran, and so is its end. Dhul-Qarnayn built it from iron and molten copper, and said the thing that matters: “this is a mercy from my Lord — and when the promise of my Lord comes, He will make it level.” The wall was never permanent. It was a delay with a stated expiry.",
        ar: "والسدُّ في القرآن، ونهايتُه فيه أيضًا. بناه ذو القرنين من زُبَر الحديد والقِطر، ثم قال الذي عليه المدار: ﴿هَٰذَا رَحۡمَةٞ مِّن رَّبِّيۖ فَإِذَا جَآءَ وَعۡدُ رَبِّي جَعَلَهُۥ دَكَّآءَۖ﴾. فما كان السدُّ دائمًا قطّ، وإنما هو تأجيلٌ مضروبٌ له أجل.",
  ...
  },
  {
    ...
    points: [
      ...
      { en: "The Quran states the same rule: on the day some of the signs of your Lord arrive, no soul will benefit from its faith if it had not believed before.",
        ar: "وقرّر القرآن الحكم نفسه: ﴿يَوۡمَ يَأۡتِي بَعۡضُ ءَايَٰتِ رَبِّكَ لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ﴾.",
  ...
  },
  {
    ...
    points: [
      { en: "“And when the word befalls them, We will bring forth for them a beast from the earth speaking to them, that the people were not certain of Our signs.”",
        ar: "﴿وَإِذَا وَقَعَ ٱلۡقَوۡلُ عَلَيۡهِمۡ أَخۡرَجۡنَا لَهُمۡ دَآبَّةٗ مِّنَ ٱلۡأَرۡضِ تُكَلِّمُهُمۡ أَنَّ ٱلنَّاسَ كَانُواْ بِـَٔايَٰتِنَا لَا يُوقِنُونَ﴾",
      ...
      { en: "The Quran names her and names what she does: “We will bring forth for them a beast from the earth, speaking to them, because the people were not certain of Our signs.” The reason given is not punishment — it is that certainty had gone.",
        ar: "سمّاها القرآن وسمّى فعلها: ﴿وَإِذَا وَقَعَ ٱلۡقَوۡلُ عَلَيۡهِمۡ أَخۡرَجۡنَا لَهُمۡ دَآبَّةٗ مِّنَ ٱلۡأَرۡضِ تُكَلِّمُهُمۡ أَنَّ ٱلنَّاسَ كَانُواْ بِـَٔايَٰتِنَا لَا يُوقِنُونَ﴾. والعلّةُ المذكورة ليست العقوبة، وإنما ذهابُ اليقين.",
        ref: "Surah An-Naml (27:82)" },
      { en: "Her appearance is one of the three the Prophet ﷺ named as closing the door: after them, faith brings no benefit to a soul that did not believe before. Which is what makes her a sign and not a wonder — she does not persuade anybody, because by then persuasion is finished.",
        ar: "وخروجُها إحدى الثلاث التي سمّاها النبيُّ ﷺ سادّاتٍ للباب: إذا وقعن ﴿لَا يَنفَعُ نَفۡسًا إِيمَٰنُهَا لَمۡ تَكُنۡ ءَامَنَتۡ مِن قَبۡلُ﴾. وبهذا صارت علامةً لا أُعجوبة، فهي لا تُقنع أحدًا، إذ الإقناعُ حينئذٍ قد انتهى.",
  ...
  },
  {
    ...
    points: [
      ...
      { en: "The Quran describes it in three short verses, and the third is the one to sit with: the smoke covers the people, they call it a painful punishment, and then they say — “Our Lord, remove the punishment from us; indeed, we are believers.” The belief arrives, and it arrives too late to be belief.",
        ar: "وصفه القرآن في ثلاث آياتٍ قصار، وثالثتُها موضعُ الوقوف: يغشى الدخانُ الناس، فيسمّونه عذابًا أليمًا، ثم يقولون: ﴿رَّبَّنَا ٱكۡشِفۡ عَنَّا ٱلۡعَذَابَ إِنَّا مُؤۡمِنُونَ﴾. فيأتي الإيمان، ويأتي متأخّرًا عن أن يكون إيمانًا.",
  ...
  },
  {
    id: "sg-sur",
    order: 9,
    name: "The Trumpet — where the signs end and the Day begins",
    nameAr: "الصُّور — وهنا تنتهي الأشراط ويبدأ اليوم",
    plain: "In plain words: the signs run out here and the Hour itself begins. Everything from this point on — the blast, the raising, the standing, and what follows — is what the fifteen stages at the top of this page describe.\n\nThe page tells your own journey first, from death onwards, and the end of the world second. In time, this is where the two meet: the last sign, and then the Day those stages describe.",
    plainAr: "بكلامٍ بسيط: تنتهي الأشراط ها هنا وتبدأ الساعة نفسها. وكلُّ ما بعد هذا الموضع — النفخُ والبعثُ والموقفُ وما يتبعه — هو الذي تصفه المراحلُ الخمس عشرة في أعلى هذه الصفحة.\n\nفالصفحةُ تبدأ برحلتك أنت من الموت فما بعده، ثم تذكر نهاية الدنيا. وفي الزمن هنا يلتقي الأمران: آخرُ الأشراط، ثم اليومُ الذي تصفه تلك المراحل.",
    lead: "The signs end and the Hour arrives. What happens after this is the fifteen stages at the top of this page.",
    leadAr: "تنتهي العلامات وتقوم الساعة. وما بعد هذا هو المراحلُ الخمس عشرة في أعلى هذه الصفحة.",
    points: [
      { en: "“And the Trumpet will be blown, and whoever is in the heavens and whoever is on the earth will fall dead, except whom Allah wills. Then it will be blown again, and at once they will be standing, looking on.” One blast ends everything; the second raises it.",
        ar: "﴿وَنُفِخَ فِي ٱلصُّورِ فَصَعِقَ مَن فِي ٱلسَّمَٰوَٰتِ وَمَن فِي ٱلۡأَرۡضِ إِلَّا مَن شَآءَ ٱللَّهُۖ ثُمَّ نُفِخَ فِيهِ أُخۡرَىٰ فَإِذَا هُمۡ قِيَامٞ يَنظُرُونَ﴾. نفخةٌ تُنهي كلّ شيء، وأخرى تُقيمه.",
        ref: "Surah Az-Zumar (39:68)" },
      { en: "“The day people will be like scattered moths, and the mountains like carded wool.”",
        ar: "﴿يَوۡمَ يَكُونُ ٱلنَّاسُ كَٱلۡفَرَاشِ ٱلۡمَبۡثُوثِ • وَتَكُونُ ٱلۡجِبَالُ كَٱلۡعِهۡنِ ٱلۡمَنفُوشِ﴾",
      ...
      { en: "The Quran gives it as two blasts with a gap between them: “And the Trumpet will be blown, and whoever is in the heavens and whoever is on the earth will fall dead, except whom Allah wills. Then it will be blown again, and at once they will be standing, looking on.” One blast ends everything; the second starts everything again.",
        ar: "جعله القرآنُ نفختين بينهما مهلة: ﴿وَنُفِخَ فِي ٱلصُّورِ فَصَعِقَ مَن فِي ٱلسَّمَٰوَٰتِ وَمَن فِي ٱلۡأَرۡضِ إِلَّا مَن شَآءَ ٱللَّهُۖ ثُمَّ نُفِخَ فِيهِ أُخۡرَىٰ فَإِذَا هُمۡ قِيَامٞ يَنظُرُونَ﴾. فنفخةٌ تُنهي كلَّ شيء، وأخرى تُعيده كلَّه.",
        ref: "Surah Az-Zumar (39:68)" },
  ...
  sections: [
    {
      ...
      ar: "﴿وُجُوهٞ يَوۡمَئِذٖ نَّاضِرَةٌ • إِلَىٰ رَبِّهَا نَاظِرَةٞ﴾. آيتان في سبع كلمات، أخذها أهل السنّة على ظاهرها: أنّ المؤمنين يرون ربّهم.\n\nوزادت سورة يونس اللفظ الذي وصله أهل العلم بها: ﴿لِّلَّذِينَ أَحۡسَنُواْ ٱلۡحُسۡنَىٰ وَزِيَادَةٞۖ﴾ — الحسنى وشيءٌ فوقها. وفسّر النبيُّ ﷺ الزيادة بالنظر إلى وجه الله، في صحيح مسلم.\n\nوهذا يقلب النظر في الباب كلّه: فليست الجنّة خاتمة الحساب، وإنما النظر.",
    ...
    },
    {
      ...
      ar: "﴿كـَلَّآ إِنَّهُمۡ عَن رَّبِّهِمۡ يَوۡمَئِذٖ لَّمَحۡجُوبُونَ﴾. واستدلّ الشافعيّ بهذه الآية على الأولى: أنّ الحجاب لَمّا جُعل عقوبةً دلّ على أنّ النظر ثواب، وإلا لم يكن في المنع منه شيء.\n\nوهذا استنباطُ عالمٍ من آيتين، منسوبٌ إليه باسمه، ويحسن أن يُعلم أنه استدلاله لا أنه نصُّ آية.",
    ...
    },
    {
      ...
      ar: "﴿حَتَّىٰٓ إِذَا جَآءَ أَحَدَهُمُ ٱلۡمَوۡتُ قَالَ رَبِّ ٱرۡجِعُونِ • لَعَلِّيٓ أَعۡمَلُ صَٰلِحٗا فِيمَا تَرَكۡتُۚ﴾. والجواب كلمةٌ واحدة: ﴿كـَلَّآ﴾.\n\nوتأمّل المسؤول: ليس مالًا، ولا عمرًا مطلقًا، بل أن يُردَّ ليعمل صالحًا. وهو أوجهُ ما يسأله سائل، ورُدّ، والردُّ أقصرُ كلمةٍ في الآية.\n\nوهذا هو الأثر العمليّ للباب كلّه: فما تقدّم وصفُ يومٍ لا يستطيع أحدٌ أن يستعدّ له فيه. وإنما يُعمل الآن، و«الآن» هو الذي يُسمّى هناك ﴿فِيمَا تَرَكۡتُۚ﴾.",
  ...
  stages: [
    {
      ...
      ar: "يُنفخ في الصور فيصعق ﴿مَن فِي ٱلسَّمَٰوَٰتِ وَمَن فِي ٱلۡأَرۡضِ إِلَّا مَن شَآءَ ٱللَّهُۖ﴾. لا هلاكًا على مهل، ولا عبر أجيال، بل عند صوت.\n\nولم يُسمّ القرآن المستثنَين، وقد ذُكرت في تعيينهم أقوال. والآية قالت ﴿إِلَّا مَن شَآءَ ٱللَّهُۖ﴾ ووقفت، وكذلك تقف هذه الصفحة.",
      verse: { ar: "وَنُفِخَ فِي ٱلصُّورِ فَصَعِقَ مَن فِي ٱلسَّمَٰوَٰتِ وَمَن فِي ٱلۡأَرۡضِ إِلَّا مَن شَآءَ ٱللَّهُۖ", en: "“And the Trumpet will be blown, and whoever is in the heavens and whoever is on the earth will fall dead, except whom Allah wills.”", ref: "Surah Az-Zumar (39:68)" },
      strength: "quran"
    },
    {
      ...
      plainAr: "بكلامٍ بسيط: أوّلُ ما يزول هو ما يجعله الناس مثَلًا في الثبات. تُسيَّر الجبال فتكون ﴿كَٱلۡعِهۡنِ ٱلۡمَنفُوشِ﴾، وتُسجَّر البحار، وتُطوى السماء.\n\nوالقرآن يختار في كلّ مرّةٍ الأشياء التي يُشير إليها المرء فيقول: هذه لا تزول.",
      ...
      verses: [
        { ar: "وَسُيِّرَتِ ٱلۡجِبَالُ فَكَانَتۡ سَرَابًا", en: "“And the mountains are set in motion and become a mirage.”", ref: "Surah An-Naba (78:20)" },
        { ar: "وَتَكُونُ ٱلۡجِبَالُ كَٱلۡعِهۡنِ ٱلۡمَنفُوشِ", en: "“And the mountains will be like carded wool.”", ref: "Surah Al-Qari'ah (101:5)" },
        { ar: "وَإِذَا ٱلۡبِحَارُ سُجِّرَتۡ", en: "“And when the seas are set boiling.”", ref: "Surah At-Takwir (81:6)" },
        { ar: "يَوۡمَ تَكُونُ ٱلسَّمَآءُ كَٱلۡمُهۡلِ", en: "“The Day the sky will be like molten metal.”", ref: "Surah Al-Ma'arij (70:8)" },
        { ar: "فَإِذَا ٱنشَقَّتِ ٱلسَّمَآءُ فَكَانَتۡ وَرۡدَةٗ كَٱلدِّهَانِ", en: "“And when the heaven splits open and becomes rose-coloured like oil.”", ref: "Surah Ar-Rahman (55:37)" }
      ],
    ...
    },
    {
      ...
      ar: "تُمدّ الأرض وتُلقي ما في جوفها وتتخلّى: لا جبل، ولا معلَم، ولا ما يُستتر به.\n\nثم يحكي القرآن سؤالًا يُلقى في عالمٍ لم يبقَ فيه أحد: ﴿لِّمَنِ ٱلۡمُلۡكُ ٱلۡيَوۡمَۖ﴾. فلا مُجيب، فيأتي الجواب من السائل سبحانه: ﴿لِلَّهِ ٱلۡوَٰحِدِ ٱلۡقَهَّارِ﴾.",
      verses: [
        { ar: "وَإِذَا ٱلۡأَرۡضُ مُدَّتۡ • وَأَلۡقَتۡ مَا فِيهَا وَتَخَلَّتۡ", en: "“And when the earth is spread out, and casts out what is within it and becomes empty.”", ref: "Surah Al-Inshiqaq (84:3-4)" },
        { ar: "لِّمَنِ ٱلۡمُلۡكُ ٱلۡيَوۡمَۖ لِلَّهِ ٱلۡوَٰحِدِ ٱلۡقَهَّارِ", en: "“To whom belongs the sovereignty this Day? To Allah, the One, the Prevailing.”", ref: "Surah Ghafir (40:16)" }
      ],
      strength: "quran"
    },
    {
    ...
    {
      h: "And what comes next — the fifteen stages at the top of this page",
      hAr: "وما بعد ذلك — المراحلُ الخمس عشرة في أعلى الصفحة",
      plain: "In plain words: the world has ended and the people are standing. What happens next — the standing, the intercession, the settling of rights, the Scales, the Bridge — is the fifteen stages at the top of this page.\n\nSo this section is not a separate topic. It is the chapter that comes before them: the end of the world first, then the Day those stages describe.",
      plainAr: "بكلامٍ بسيط: انتهت الدنيا وقام الناس. وأمّا ما بعد ذلك — الموقفُ والشفاعةُ والقصاصُ والموازينُ والصراط — فهو المراحلُ الخمس عشرة في أعلى هذه الصفحة.\n\nفليس هذا القسمُ موضوعًا مستقلًّا، وإنما هو الفصلُ الذي يسبقها: نهايةُ الدنيا أوّلًا، ثم اليومُ الذي تصفه تلك المراحل.",
      ...
      more: { href: "#stages", up: true, en: "Back up to the fifteen stages", ar: "صعودًا إلى المراحل الخمس عشرة" },
...
const MINOR_SIGNS = {
  ...
  items: [
    ...
    { en: "The splitting of the moon, which Surah Al-Qamar opens with: “The Hour has drawn near, and the moon has split.”",
      ar: "انشقاق القمر، وقد افتُتحت به سورة القمر: ﴿ٱقۡتَرَبَتِ ٱلسَّاعَةُ وَٱنشَقَّ ٱلۡقَمَرُ﴾.",
      status: "happened",
    ...
    { h: "The awaited Mahdi — what is established, and what is not",
      ...
      en: "Almost everyone has heard of him, and almost nobody has been told which parts of what they heard have a chain behind them. So, in order.\n\n**WHAT IS IN THE TWO SAHIHS.** One piece, and it is the piece people usually attach to the Mahdi without realising it is the only strong part: **an army is sent against a man who has taken refuge at the Kaaba, and when they reach al-Bayda' — the open ground between Makkah and Madinah — the earth swallows them.** That is in Sahih Muslim, from Umm Salamah and from Hafsah رضي الله عنهما.\n\nNow read what that text does **not** say. It gives **no number**. It names **no country** they came from. And it does **not name the Mahdi at all** — it says **a man seeking refuge at the House**. Everything beyond that came later.\n\n**WHAT IS OUTSIDE THE TWO SAHIHS.** The narrations that name the Mahdi are in Sunan Abu Dawud, Jami at-Tirmidhi and Sunan Ibn Majah. They say he is from the family of the Prophet ﷺ, that his name matches his, and that he fills the earth with justice as it was filled with injustice (Abu Dawud 4282 and 4285). Umm Salamah's narration adds the detail that people come to a man **who does not want it**, and pledge allegiance to him between the Rukn and the Maqam (Abu Dawud 4286).\n\n**AND THE SCHOLARS DIFFER, GENUINELY.** Ibn Taymiyyah, Ibn Kathir, as-Suyuti and al-Albani held that the reports, taken together, reach a level that must be accepted. Ibn Khaldun examined the chains one by one in his Muqaddimah and found most of them weak. Both positions are real scholarship and neither is fringe. What is agreed is that **no single Mahdi narration is in al-Bukhari or Muslim.**\n\n**HE IS NOT ONE OF THE TEN.** The ten major signs on this page are the ten named in one hadith in Sahih Muslim. He is not among them, and this page will not add him to a list the text did not put him on.\n\n**AND THE TITLE ITSELF IS NOT HIS ALONE.** This quietly settles most of what has been built on the word, and it sits inside a hadith almost every Muslim has already heard. In al-Irbad ibn Sariyah's narration of the farewell exhortation, he صلى الله عليه وسلم said: **عَلَيْكُمْ بِسُنَّتِي وَسُنَّةِ الْخُلَفَاءِ الرَّاشِدِينَ الْمَهْدِيِّينَ مِنْ بَعْدِي** — hold to my sunnah and the sunnah of the rightly guided caliphs after me (Sunan Abu Dawud 4607, outside the two Sahihs, authenticated by al-Albani).\n\nRead the word in the middle. **Al-mahdiyyin** — **the guided ones.** Abu Bakr was a mahdi. Omar was a mahdi. Osman and Ali were mahdiyyin. It is a description Allah gives to a ruler He guides, not the name of a unique office belonging to one man at the end of time. The man at the end of time carries it because it is true of him — exactly as it was true of five men who are already buried.\n\nThat one word takes most of the weight off the question, and it explains something else: the earliest Muslims were not sitting and waiting for anybody. The mahdiyyin were in front of them.\n\n**AND THESE ARE NOT THE TWELVE IMAMS OF THE SHIA.** It has to be said plainly, because a reader who has heard the number used that way will assume it, and the assumption is wrong. The hadith of the twelve is **in both Sahihs** — al-Bukhari 7222 and Sahih Muslim, from Jabir ibn Samurah, who heard it sitting beside his father — and it was written down in our books before that doctrine existed. Three things in the wording rule the reading out:\n\n• **كُلُّهُمْ مِنْ قُرَيْشٍ — all of them from Quraysh.** Quraysh is the whole tribe. The hadith does not say **from my family**, or **from the people of my house**, or **from Ali**. The twelve imams are one narrow line of descent. If that were the meaning, the wording for it existed and was not used.\n\n• **لَا يَزَالُ الدِّينُ قَائِمًا ... أَوْ يَكُونَ عَلَيْكُمُ اثْنَا عَشَرَ خَلِيفَةً** — **the religion remains standing... or there will be over you twelve caliphs.** **Over you.** Ruling. And the religion standing **through** them. Eleven of the twelve imams never ruled anything at all, and the twelfth, by that doctrine's own account, never appeared. A hadith about rulers under whom the religion stays established cannot be describing men who held no authority. **Ibn Kathir argues exactly this**, and Ibn Hajar takes up the claim and rejects it in Fath al-Bari.\n\n• **The scholars who read it name real rulers** — the rightly guided, and after them men such as Mu'awiyah, Ibn az-Zubayr and Omar ibn Abd al-Aziz. Men who actually governed, in recorded history.\n\nSo the matching number is a later claim laid on a hadith that was already ours. That is the reason this page keeps it rather than avoiding it: **a text in both Sahihs is not surrendered because somebody else misuses it.**\n\n**WHERE HE FALLS IN THE ORDER — and this page calls it a reconstruction.** There is a reading, argued carefully, that he comes at the END of a period of Muslim strength rather than at its beginning: that a community rises, unites and rules first, and he is the last of its rulers rather than the man who starts it. Four texts are put together to build it, and every one of them is sound:\n\n• **Twelve rulers, all from Quraysh** — **Sahih al-Bukhari 7222, agreed upon.** Al-Bukhari's wording is **amir**, ruler; Muslim's is **khalifah**.\n\n• **The caliphate of prophethood is thirty years, then Allah gives the dominion to whom He wills** — Sunan Abu Dawud 4646 and 4647, outside the two Sahihs, authenticated by al-Albani. Counted from his death in 11 AH, thirty years lands exactly on al-Hasan's abdication in 41 AH, the Year of Unity. So the twelve cannot simply be the caliphs of history — history's caliphs run into the hundreds, and the rightly guided are five.\n\n• **The caliphate settling in the holy land** — يَا ابْنَ حَوَالَةَ إِذَا رَأَيْتَ الْخِلَافَةَ قَدْ نَزَلَتْ أَرْضَ الْمُقَدَّسَةِ — Sunan Abu Dawud 2535, outside the two Sahihs, authenticated by al-Albani.\n\n• **A secure truce with the Romans, a joint campaign, then their treachery and the Malhamah** — Sunan Abu Dawud 4292, from Dhu Mikhbar. The argument drawn from it is that a truce needs a single body able to make one, and that dozens of separate states cannot sign anything together. That inference is reasonable. It is still an inference, and it is not what the text says.\n\n**WHAT THIS PAGE WILL NOT DO WITH THEM.** The four texts are sound at the grades given. The **arrangement** of them into an order is a scholar's reconstruction, and calling it certain is a step past the evidence. The commentators have never agreed on who the twelve are: Ibn Hajar sets out the positions in Fath al-Bari and declines to settle it, al-Qurtubi held that they had not all appeared yet, and others counted them among rulers long dead. So this page reports the reading, names it as a reading, and refuses to turn it into a timetable.\n\n**BUT ONE THING IN IT HOLDS WHATEVER THE ORDER TURNS OUT TO BE**, because it does not rest on the reconstruction at all: on every reading, a working Muslim community exists before he does. That is not an inference — it is in the narrations themselves, and it is in the section “Will we rise again?” further down this page.",
      ar: "قد سمع به كلُّ أحدٍ تقريبًا، ولم يُخبَر أحدٌ تقريبًا أيُّ ما سمعه له إسناد. فلنُرتّب.\n\n**ما في الصحيحين.** موضعٌ واحد، وهو الذي يُعلّقه الناس بالمهديّ ولا يدرون أنه القويُّ وحده: **أنّ جيشًا يُبعث إلى رجلٍ عاذ بالبيت، فإذا كانوا بالبيداء — وهي ما بين مكّة والمدينة — خُسف بهم.** وهو في صحيح مسلم عن أمّ سلمة وعن حفصة رضي الله عنهما.\n\nثم انظر ما **لا** يقوله النصّ: ليس فيه **عدد**، ولا **بلدٌ** خرجوا منه، **ولا ذِكرٌ للمهديّ أصلًا** — وإنما فيه: **يَعُوذُ عَائِذٌ بِالْبَيْتِ**. وما وراء ذلك متأخّر.\n\n**وما خارج الصحيحين.** الروايات التي تسمّي المهديّ في سنن أبي داود وجامع الترمذي وسنن ابن ماجه، وفيها أنه من أهل بيت النبيّ ﷺ، وأنّ اسمه يواطئ اسمه، وأنه يملأ الأرض قسطًا وعدلًا كما مُلئت جورًا وظلمًا (أبو داود ٤٢٨٢ و٤٢٨٥). وفي حديث أمّ سلمة زيادةٌ لطيفة: أنّ الناس يأتون رجلًا **وهو كاره**، فيبايعونه بين الركن والمقام (أبو داود ٤٢٨٦).\n\n**واختلف أهل العلم اختلافًا حقيقيًّا.** فذهب ابن تيمية وابن كثير والسيوطي والألباني إلى أنّ الأحاديث بمجموعها تبلغ حدًّا يجب قبوله. ونظر ابن خلدون في «المقدّمة» في أسانيدها حديثًا حديثًا فضعّف أكثرها. والقولان لأهل علمٍ معتبَرين، وليس أحدهما شاذًّا. والمتّفق عليه أنّه **ليس في البخاريّ ولا مسلمٍ حديثٌ واحدٌ يسمّي المهديّ.**\n\n**وليس هو من العشر.** فالعلاماتُ العشر الكبرى في هذه الصفحة هي العشر المسمّاة في حديثٍ واحدٍ عند مسلم، وليس هو فيها، ولن تُدخله هذه الصفحة في قائمةٍ لم يضعه فيها النصّ.\n\n**وليس اللقبُ له وحده.** وهذا الموضعُ يرفع أكثرَ ما بُني على الكلمة، وهو في حديثٍ قد سمعه كلُّ مسلمٍ تقريبًا. ففي حديث العرباض بن سارية في موعظة الوداع قال صلى الله عليه وسلم: **عَلَيْكُمْ بِسُنَّتِي وَسُنَّةِ الْخُلَفَاءِ الرَّاشِدِينَ الْمَهْدِيِّينَ مِنْ بَعْدِي** (سنن أبي داود ٤٦٠٧، خارج الصحيحين، صحّحه الألباني).\n\nفانظر إلى الكلمة في وسطه: **المهديّين.** فأبو بكرٍ مهديّ، وعمرُ مهديّ، وعثمانُ وعليّ مهديّون. فهو وصفٌ يصف اللهُ به من يهديه من الولاة، لا اسمٌ لمنصبٍ ينفرد به رجلٌ واحدٌ في آخر الزمان. وإنما حمَله رجلُ آخر الزمان لأنه صادقٌ عليه، كما صدق على خمسةٍ قد دُفنوا.\n\nوهذه الكلمةُ وحدها ترفع أكثر الثِّقل عن المسألة، وتفسّر أمرًا آخر: أنّ الأوّلين لم يكونوا قاعدين ينتظرون أحدًا. فقد كان المهديّون بين أيديهم.\n\n**وليسوا هم الأئمةَ الاثني عشر عند الشيعة.** ولا بدّ من قوله صراحةً، لأنّ من سمع العدد يُستعمل على ذلك الوجه سيظنّه، والظنُّ خطأ. فحديثُ الاثني عشر **في الصحيحين** — البخاريّ ٧٢٢٢ ومسلم — عن جابر بن سمرة، سمعه وهو جالسٌ مع أبيه، وقد دُوّن في كتبنا قبل أن يوجد ذلك المذهب. وفي لفظه ثلاثةُ أمورٍ تُبطل تلك القراءة:\n\n• **كُلُّهُمْ مِنْ قُرَيْشٍ.** وقريشٌ القبيلةُ كلُّها. ولم يقل: من أهل بيتي، ولا من وَلَدِ عليّ. والأئمةُ الاثنا عشر نسبٌ واحدٌ ضيّق. ولو أُريد ذلك لكان لفظُه موجودًا، ولم يُستعمل.\n\n• **لَا يَزَالُ الدِّينُ قَائِمًا ... أَوْ يَكُونَ عَلَيْكُمُ اثْنَا عَشَرَ خَلِيفَةً.** **عليكم** — أي وُلاةً حاكمين. والدينُ قائمٌ **بهم**. وأحدَ عشرَ من أولئك الأئمة لم يَلُوا شيئًا قطّ، والثاني عشر لم يظهر أصلًا على قولهم. وحديثٌ في وُلاةٍ يقوم بهم الدينُ لا يكون في رجالٍ لم تكن لهم ولاية. **وبهذا احتجّ ابنُ كثير**، وتناول ابنُ حجرٍ الدعوى في «فتح الباري» فردّها.\n\n• **ومن قرأه من أهل العلم سمّى وُلاةً حقيقيّين** — الراشدين، ثم مثل معاوية وابن الزبير وعمر بن عبد العزيز. رجالٌ حكموا فعلًا في تاريخٍ مدوّن.\n\nفتوافقُ العدد دعوى متأخّرةٌ وُضعت على حديثٍ كان عندنا من قبلُ. ولهذا تُبقيه هذه الصفحةُ ولا تتحاماه: **فالنصُّ الذي في الصحيحين لا يُترك لأنّ غيرَنا أساء استعماله.**\n\n**وأين موضعُه من الترتيب — وتسمّيه هذه الصفحةُ تركيبًا.** ثمّ قراءةٌ حُرِّرت: أنّه يأتي في **آخر** مدّةٍ من قوّة المسلمين لا في أوّلها؛ أنّ جماعةً تقوم وتجتمع وتحكم أوّلًا، ثم يكون هو آخِرَ ولاتها لا مُبتدِئَها. ويُجمع لها أربعةُ نصوصٍ، وكلُّها ثابت:\n\n• **اثنا عشرَ أميرًا كلُّهم من قريش** — **صحيح البخاري ٧٢٢٢، وهو متّفقٌ عليه.** ولفظُ البخاريّ «أميرًا» ولفظُ مسلمٍ «خليفة».\n\n• **خلافةُ النبوّة ثلاثون سنةً ثم يؤتي اللهُ المُلكَ من يشاء** — سنن أبي داود ٤٦٤٦ و٤٦٤٧، خارج الصحيحين، صحّحه الألباني. ومن وفاته سنة ١١هـ تقع الثلاثون على تنازُل الحسن سنة ٤١هـ، عامَ الجماعة، على التمام. فلا يستقيم أن يكون الاثنا عشرَ خلفاءَ التاريخ، فإنّ خلفاء التاريخ بالمئات، والراشدين خمسة.\n\n• **نزولُ الخلافة الأرضَ المقدّسة** — يَا ابْنَ حَوَالَةَ إِذَا رَأَيْتَ الْخِلَافَةَ قَدْ نَزَلَتْ أَرْضَ الْمُقَدَّسَةِ — سنن أبي داود ٢٥٣٥، خارج الصحيحين، صحّحه الألباني.\n\n• **مصالحةُ الروم صلحًا آمنًا، ثم غزوٌ مشترك، ثم غدرُهم والملحمة** — سنن أبي داود ٤٢٩٢، عن ذي مِخبر. والمأخوذ منه أنّ الصلح يقتضي جهةً واحدةً تملك أن تصالح، وأنّ دولًا متفرّقةً لا توقّع شيئًا معًا. وهذا استنباطٌ وجيه، ولكنّه استنباطٌ، وليس هو نصَّ الحديث.\n\n**وما لا تصنعه هذه الصفحةُ بها.** النصوصُ الأربعة ثابتةٌ بالدرجات المذكورة. وأمّا **ترتيبُها** على هذا الوجه فإنّما هو تركيبُ ناظرٍ، وتسميتُه قطعيًّا تجاوزٌ للدليل. ولم يتّفق الشرّاح قطّ على من هم الاثنا عشر: فسرد ابنُ حجرٍ الأقوال في «فتح الباري» ولم يقطع، وذهب القرطبيّ إلى أنّهم لم يظهروا بعدُ، وعدّهم قومٌ فيمن مضى. فهذه الصفحةُ تنقل القراءة، وتسمّيها قراءةً، وتأبى أن تجعل منها روزنامة.\n\n**وفيها موضعٌ يبقى على كلّ تقديرٍ للترتيب**، لأنه لا يقوم على التركيب أصلًا: فعلى كلّ قولٍ، ثمّ جماعةٌ مسلمةٌ عاملةٌ قبلَه. وليس هذا استنباطًا، بل هو في نفس الأخبار، وهو في قسم «هل نعود؟» أسفلَ هذه الصفحة.",
      ...
      ref: "Sahih Muslim, Book of Tribulations and the Portents of the Last Hour — Umm Salamah and Hafsah, on the army swallowed at al-Bayda'; Sunan Abu Dawud 4282, 4285 and 4286 for the Mahdi narrations; Sunan Abu Dawud 4607 for the rightly guided being called mahdiyyin; Sahih al-Bukhari 7222 and Sahih Muslim, Book of Government, for the twelve rulers of Quraysh; Sunan Abu Dawud 4646 and 4647 for the thirty years; Sunan Abu Dawud 2535 and 4292; Ibn Hajar, Fath al-Bari, on who the twelve are; Ibn Khaldun, Al-Muqaddimah, on the chains",
      refAr: "صحيح مسلم، كتاب الفتن وأشراط الساعة — عن أمّ سلمة وحفصة، في الجيش المخسوف به بالبيداء؛ وسنن أبي داود ٤٢٨٢ و٤٢٨٥ و٤٢٨٦ في أخبار المهديّ؛ وسنن أبي داود ٤٦٠٧ في وصف الراشدين بالمهديّين؛ وصحيح البخاري ٧٢٢٢ وصحيح مسلم، كتاب الإمارة، في الاثني عشر من قريش؛ وسنن أبي داود ٤٦٤٦ و٤٦٤٧ في الثلاثين سنة؛ وسنن أبي داود ٢٥٣٥ و٤٢٩٢؛ وابن حجر في «فتح الباري» فيمن هم الاثنا عشر؛ وابن خلدون في «المقدّمة» في الأسانيد",
      strength: "hadith",
      notEstablished: "Said constantly and established by nothing:\n\n• **A number for the army.** \"Forty thousand\" and other figures are not in the Sahih Muslim text, which gives no number at all.\n\n• **A country they come from.** The text says only that they reach al-Bayda'. Naming a modern state as their origin is an addition, and it is the kind of addition that gets people killed.\n\n• **A date, a year, or a generation.** Every century has produced people certain it was theirs, and every one of them was wrong.\n\n• **A named living person.** More than one man has been declared the Mahdi in history — including in the seizure of the Grand Mosque in 1979, which ended with hundreds dead inside the Haram itself. This is not a harmless guess.\n\n• **That believing in him replaces working.** Nothing in any of these narrations says that.\n\n• **A fixed number of rulers before him.** The twelve are established; who they are has never been agreed on. Building a countdown out of them is a reading, not a text.\n\n• **That he is certainly the last caliph.** No narration says it. It is drawn from the order of events — and Isa عليه السلام leads the people after him in any case.\n\n• **A war, a year, or a named country that begins it.** Reading the politics of the day into the narrations has been done in every generation, always with that morning's news in hand, and it has been wrong every time. The texts name no state and fix no date.",
      notEstablishedAr: "ممّا يُقال دائمًا ولا يقوم عليه دليل:\n\n• **عددٌ للجيش.** فـ«أربعون ألفًا» وغيرها ليست في نصّ مسلم، وليس فيه عددٌ البتّة.\n\n• **بلدٌ يخرجون منه.** والنصّ إنما فيه أنهم يبلغون البيداء. وتسميةُ دولةٍ قائمةٍ اليوم زيادةٌ، وهي من الزيادات التي تُسفك بها الدماء.\n\n• **تاريخٌ أو سنةٌ أو جيل.** فما من قرنٍ إلا وفيه من أيقن أنه قرنُه، وقد أخطؤوا جميعًا.\n\n• **شخصٌ حيٌّ بعينه.** فقد ادُّعيت هذه الدعوى لغير واحدٍ في التاريخ، ومنها واقعةُ الحرم سنة ١٣٩٩هـ التي انتهت بمئاتٍ من القتلى في المسجد الحرام نفسه. وليس هذا ظنًّا لا يضرّ.\n\n• **أنّ الإيمان به يُغني عن العمل.** وليس في شيءٍ من هذه الأخبار ذلك.\n\n• **عددٌ معيّنٌ من الولاة قبله.** فالاثنا عشرَ ثابتون، وأمّا من هم فلم يُتّفق عليه قطّ. وبناءُ تقويمٍ على ذلك قراءةٌ لا نصّ.\n\n• **أنّه قطعًا آخرُ الخلفاء.** ليس في الأخبار ذلك، وإنما يُؤخذ من ترتيب الوقائع، وعيسى عليه السلام يؤمّ الناسَ بعده على كلّ حال.\n\n• **حربٌ أو سنةٌ أو دولةٌ مسمّاةٌ يبتدئ بها الأمر.** فتنزيلُ سياسة اليوم على الأخبار صنيعٌ تكرّر في كلّ جيلٍ وصحيفةُ الصباح في اليد، وقد أخطأ في كلّ مرّة. والنصوصُ لا تسمّي دولةً ولا تحدّد تاريخًا." },

    { h: "Swords and horses at the end of time — what the narrations say, and what they do not",
      hAr: "السيوف والخيل في آخر الزمان — ما تقوله الأخبار وما لا تقوله",
      en: "A question asked far more often than it is answered, and it deserves a straight reply: the end-times narrations mention swords, horses, bows and shields. Does that mean the machines stop — that something destroys what people have built, and we go back to fighting the way our grandfathers did?\n\n**WHAT THE NARRATIONS ACTUALLY SAY.** They do name those things. The clearest is this: **سَيُوقِدُ الْمُسْلِمُونَ مِنْ قِسِيِّ يَأْجُوجَ وَمَأْجُوجَ وَنُشَّابِهِمْ وَأَتْرِسَتِهِمْ سَبْعَ سِنِينَ** — the Muslims will burn the bows, arrows and shields of Ya'juj and Ma'juj for seven years (Sunan Ibn Majah 4076, from an-Nawwas ibn Sam'an, outside the two Sahihs, authenticated by al-Albani).\n\nNow read it slowly, because this is the narration people reach for. The bows and shields in it belong to **Ya'juj and Ma'juj**, not to the Muslims. And they are being burned as **firewood**. It does not say the Muslims fought with them, and it does not say anybody had lost anything.\n\n**AND WHAT NO NARRATION SAYS AT ALL.** Not one text — not in the Quran, not in the two Sahihs, not in the four Sunan — says that the machines stop, that the knowledge is lost, that a weapon destroys what was built, or that the world is returned by force to an earlier state. That sentence is not in the religion. It is an inference somebody drew from the vocabulary of the narrations, and **an inference is not a text.** This site does not print one as though it were the other.\n\n**THE TWO READINGS, AND BOTH ARE HELD BY PEOPLE OF KNOWLEDGE.**\n\n• **The literal reading** — that the means genuinely revert, whether by exhaustion, by collapse, or by something not described. Nothing forbids it. The Hour is preceded by upheaval, and the narrations were not obliged to describe our century to us.\n\n• **The idiomatic reading** — that he صلى الله عليه وسلم described war in the words his listeners owned, as the Quran describes riding beasts without that being a ruling against every other way of travelling. On this reading a sword in the narration means fighting, the way **the pen** means writing.\n\nNeither reading is certain, and this page will not pretend one is. What is worth noticing is that **the practical instruction is identical under both**, which is the useful part and the part worth taking away.\n\n**WHAT IS COMMANDED EITHER WAY.** The Prophet صلى الله عليه وسلم climbed the minbar, recited **and prepare against them whatever you are able of power**, and then said three times: **أَلَا إِنَّ الْقُوَّةَ الرَّمْيُ** — indeed, the power is shooting (Sahih Muslim, Book of Government, from Uqbah ibn Amir). He also said: **مَنْ عَلِمَ الرَّمْيَ ثُمَّ تَرَكَهُ فَلَيْسَ مِنَّا** — whoever learns archery and then abandons it is not of us (Sahih Muslim, same book). And of horses: **الْخَيْلُ فِي نَوَاصِيهَا الْخَيْرُ إِلَى يَوْمِ الْقِيَامَةِ** — good is in the forelocks of horses until the Day of Resurrection (Sahih al-Bukhari 2849).\n\nRead that last one again, because it settles the practical question on its own. **Until the Day of Resurrection.** The value he put on the skill was not tied to whether it was still the decisive weapon. So: yes — learn to shoot, learn to ride, keep the body strong. It is a sunnah with its own reward, it needs no prophecy to justify it, and it does not depend on which reading of the narrations turns out to be right.\n\n**AND THE OTHER HALF, WHICH IS EASY TO DROP.** The same verse says **whatever you are able** — and when he named the decisive capability, he named the one that decided battles in **his** century. He did not hand down a permanent list. A community that reads **the power is shooting** as **arrows only** has kept the word and lost the instruction. The Golden Age page argues this at length under **why a religion site is talking about chips and servers**, and it is the same hadith doing the work there.\n\n**A NOTE ON THE SWITCH IN SOMEONE ELSE'S HAND.** People raise a related worry: that the devices we depend on can be reached, shut off or disabled by whoever built them. As a religious claim about the end of time it has no text behind it and this page will not dress it as one. **As a worldly concern it is real, it is documented, and it is already argued properly on this site** — from sovereignty and from being consumers rather than makers, on the Golden Age page. It needs no prophecy to stand up, which is exactly why it is stronger there.",
      ar: "سؤالٌ يُسأل أكثرَ ممّا يُجاب، ويستحقّ جوابًا صريحًا: أخبارُ آخر الزمان تذكر السيوف والخيل والقِسيّ والتِّرَسة. أفيعني ذلك أنّ الآلاتِ تتوقّف — أنّ شيئًا يُتلف ما بناه الناس، فنعود إلى القتال كما كان أجدادُنا يقاتلون؟\n\n**ما تقوله الأخبارُ فعلًا.** إنّها تذكرها بأسمائها. وأصرحُها: **سَيُوقِدُ الْمُسْلِمُونَ مِنْ قِسِيِّ يَأْجُوجَ وَمَأْجُوجَ وَنُشَّابِهِمْ وَأَتْرِسَتِهِمْ سَبْعَ سِنِينَ** (سنن ابن ماجه ٤٠٧٦، عن النوّاس بن سمعان، خارج الصحيحين، صحّحه الألباني).\n\nثم اقرأه على مهلٍ، فإنّه الخبرُ الذي يُفزع إليه. فالقِسيُّ والتِّرَسةُ فيه **ليأجوج ومأجوج** لا للمسلمين. وهي تُوقَد **حطبًا**. وليس فيه أنّ المسلمين قاتلوا بها، ولا أنّ أحدًا فقد شيئًا.\n\n**وما لا يقوله خبرٌ واحد.** ليس في نصٍّ واحد — لا في القرآن، ولا في الصحيحين، ولا في السنن الأربعة — أنّ الآلات تتوقّف، أو أنّ العلم يُفقَد، أو أنّ سلاحًا يُتلف ما بُني، أو أنّ الدنيا تُردّ قسرًا إلى حالٍ سابقة. هذه الجملةُ ليست من الدين. وإنما هي استنباطٌ استنبطه أحدٌ من ألفاظ الأخبار، **والاستنباطُ ليس نصًّا.** ولا يطبع هذا الموقعُ أحدَهما مكان الآخر.\n\n**والقراءتان، وكلتاهما لأهل علم.**\n\n• **القراءةُ على الظاهر** — أنّ الوسائل ترجع حقيقةً، إمّا بإنهاكٍ أو بانهيارٍ أو بما لم يُوصَف. ولا مانع منه. فالساعةُ تتقدّمها أهوال، ولم تكن الأخبارُ ملزَمةً بأن تصف لنا قرنَنا.\n\n• **القراءةُ على عُرف المخاطَبين** — أنّه صلى الله عليه وسلم وصف القتال بما تملكه ألفاظُ سامعيه، كما يذكر القرآنُ الركوبَ على الدوابّ من غير أن يكون ذلك حكمًا على كلّ ما سواه. وعلى هذا فالسيفُ في الخبر هو القتالُ، كما أنّ **القلم** هو الكتابة.\n\nوليست إحداهما قطعيّةً، ولن تتظاهر هذه الصفحةُ بذلك. والذي يستحقّ الالتفات أنّ **العملَ واحدٌ على القراءتين جميعًا**، وهو المهمّ وهو الذي يُؤخذ.\n\n**وما هو مأمورٌ به على كلّ حال.** صعد النبيُّ صلى الله عليه وسلم المنبر فقرأ ﴿وَأَعِدُّواْ لَهُم مَّا ٱسۡتَطَعۡتُم مِّن قُوَّةٖ﴾ ثم قال ثلاثًا: **أَلَا إِنَّ الْقُوَّةَ الرَّمْيُ** (صحيح مسلم، كتاب الإمارة، عن عقبة بن عامر). وقال: **مَنْ عَلِمَ الرَّمْيَ ثُمَّ تَرَكَهُ فَلَيْسَ مِنَّا** (صحيح مسلم، الكتاب نفسه). وقال في الخيل: **الْخَيْلُ فِي نَوَاصِيهَا الْخَيْرُ إِلَى يَوْمِ الْقِيَامَةِ** (صحيح البخاري ٢٨٤٩).\n\nوأعِد الأخيرَ، فإنّه يفصل في العمليّ وحدَه. **إلى يوم القيامة.** فلم يُعلِّق قيمةَ المهارة على بقائها السلاحَ الحاسم. فنعم: تعلَّم الرميَ، وتعلَّم الركوب، وأبقِ البدنَ قويًّا. سنّةٌ لها أجرُها، ولا تحتاج إلى نبوءةٍ تسوّغها، ولا تتوقّف على أيّ القراءتين صحّت.\n\n**والشطرُ الآخر، ويسهل إسقاطُه.** فالآيةُ نفسُها تقول ﴿مَّا ٱسۡتَطَعۡتُم﴾ — وحين سمّى القوّةَ الحاسمة سمّى ما كان يحسم المعارك في **قرنه هو**. ولم يُنزِل قائمةً دائمة. والأمّةُ التي تقرأ «إنّ القوّةَ الرميُ» أي: السهامَ وحدها، قد حفظت اللفظَ وأضاعت الأمر. وفي صفحة العصر الذهبيّ تحريرُ هذا تحت «لماذا يتكلّم موقعٌ دينيّ عن المعالجات والخوادم»، وهو الحديثُ نفسُه يعمل هناك.\n\n**وكلمةٌ في المفتاح الذي بيد غيرنا.** يذكر الناسُ همًّا قريبًا من هذا: أنّ الأجهزة التي نعتمد عليها يمكن أن تُبلَغ أو تُطفَأ أو تُعطَّل بيد من صنعها. أمّا بوصفه دعوى دينيّةً في آخر الزمان فلا نصّ عليه، ولن تُلبسه هذه الصفحةُ لَبوسَ النصّ. **وأمّا بوصفه همًّا دنيويًّا فهو حقيقيّ وموثّق، وهو محرَّرٌ في هذا الموقع أصلًا** — من جهة السيادة، ومن جهة كوننا مستهلِكين لا صانعين، في صفحة العصر الذهبيّ. ولا يحتاج إلى نبوءةٍ ليقوم، ولذلك هو هناك أقوى.",
      quote: "الْخَيْلُ فِي نَوَاصِيهَا الْخَيْرُ إِلَى يَوْمِ الْقِيَامَةِ",
      status: "disputed",
      when: "No date, and none is possible — because the question itself is not a dated one. It asks what a whole class of narrations means, not when a single event lands.\n\nWhat is worth adding is why the answer matters more than it looks. A reader who concludes that the tools are going away has been handed a reason to stop caring about them: why learn to build the thing, why fix the thing, why compete at the thing, if it is all coming down anyway. **That is the waiting mindset arriving through a side door**, and it does the same damage as the front one. The Guidance page has the whole argument.\n\nSo the entry above refuses the inference not because the literal reading is impossible, but because the inference has a cost and no text behind it.",
      whenAr: "لا تاريخ، ولا يمكن أن يكون — لأنّ المسألةَ نفسَها ليست مؤرَّخة. فهي في معنى جنسٍ من الأخبار، لا في وقتِ واقعةٍ بعينها.\n\nوالذي يستحقّ أن يُضاف أنّ الجوابَ أهمُّ ممّا يبدو. فالقارئُ الذي ينتهي إلى أنّ الأدوات زائلةٌ قد أُعطي عذرًا في أن يزهد فيها: فلِمَ يتعلّم صنعتَها، ولِمَ يُصلحها، ولِمَ ينافس فيها، وكلُّها إلى زوال؟ **وهذا هو عقلُ الانتظار داخلًا من بابٍ جانبيّ**، وضررُه ضررُ الباب الأوّل. وفي صفحة التوجيه تحريرُ ذلك كلِّه.\n\nفإنّما رَدَّ ما فوقُ الاستنباطَ لا لأنّ الظاهر ممتنع، بل لأنّ الاستنباط له كُلفةٌ وليس وراءه نصّ.",
      ref: "Sunan Ibn Majah 4076 — an-Nawwas ibn Sam'an; Sahih Muslim, Book of Government — Uqbah ibn Amir, on shooting; Sahih al-Bukhari 2849 — Abdullah ibn Omar, on horses; Surah Al-Anfal (8:60)",
      refAr: "سنن ابن ماجه ٤٠٧٦ — عن النوّاس بن سمعان؛ وصحيح مسلم، كتاب الإمارة — عن عقبة بن عامر في الرمي؛ وصحيح البخاري ٢٨٤٩ — عن عبد الله بن عمر في الخيل؛ وسورة الأنفال (٨:٦٠)",
      strength: "hadith",
      notEstablished: "Said with confidence and resting on nothing:\n\n• **That a weapon, a war or a disaster destroys the world's technology before the Hour.** No text says it. Not one.\n\n• **That the Muslims of that time fight with swords because nothing else is left.** The narration people cite for this has Ya'juj and Ma'juj's own bows being burned as firewood, which is not the same claim at all.\n\n• **That preparing with what is decisive today is somehow against the sunnah.** The verse says **whatever you are able**, and he named the decisive weapon of his own century when he explained it.\n\n• **That any of this is a reason to stop building.** Even if the literal reading were certain, the man holding a sapling at the end of the world was told to plant it.",
      notEstablishedAr: "ممّا يُقال بثقةٍ ولا يقوم عليه شيء:\n\n• **أنّ سلاحًا أو حربًا أو كارثةً تُتلف تقنيةَ العالم قبل الساعة.** لا نصّ عليه. ولا واحد.\n\n• **أنّ مسلمي ذلك الزمان يقاتلون بالسيوف لأنّه لم يبقَ سواها.** والخبرُ الذي يُستشهد به فيه أنّ قِسيَّ يأجوج ومأجوج أنفسِهم تُوقَد حطبًا، وليست هذه تلك الدعوى.\n\n• **أنّ الإعدادَ بما هو حاسمٌ اليوم مخالفٌ للسنّة.** والآيةُ ﴿مَّا ٱسۡتَطَعۡتُم﴾، وقد سمّى حين فسّرها سلاحَ قرنِه الحاسم.\n\n• **أنّ في شيءٍ من هذا عذرًا في ترك البناء.** ولو صحّ الظاهرُ قطعًا، فإنّ صاحبَ الفسيلة عند قيام الساعة قد أُمر بغرسها." },
    ...
    { h: "Al-harj — the killing where neither side knows what it was about",
      ...
      ref: "Sahih Muslim, Book of Tribulations and the Portents of the Last Hour, Hadith 2908 — Abu Hurairah; Sahih al-Bukhari, Book of Knowledge, Hadith 85 — the gesture of the hand",
      refAr: "صحيح مسلم، كتاب الفتن وأشراط الساعة، حديث ٢٩٠٨ — عن أبي هريرة؛ وصحيح البخاري، كتاب العلم، حديث ٨٥ — وفيه تحريفُ اليد",
      strength: "hadith" },
    ...
    { h: "The Euphrates uncovering a mountain of gold",
      ...
      more: { href: "#treasure",
        en: "A closer look — the two other narrations, where it may be, why the whole world would fight over it, and what we are told to do — has its own section further down this page",
        ar: "نظرةٌ أقرب — الروايتان الأخريان، وأين قد يكون، ولماذا يقتتل العالمُ كلُّه عليه، وما أُمرنا به — في قسمٍ خاصٍّ أسفلَ هذه الصفحة" } },
