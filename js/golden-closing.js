...
const GOLDEN_CLOSING = {
  ...
  sections: [
    ...
    },
    {
      ...
      bodyAr: "وإذا أردتَ أن تعرف ما يُقدّره الناس حقًّا فلا تنظر في كلامهم، بل انظر أين يضعون أموالهم.\n\nقد يكسب المغنّي في ليلةٍ واحدةٍ ما يكسبه الجرّاح في سنةٍ كاملة. ويكسب اللاعب في أسبوعٍ واحدٍ ما يكفي لتشغيل قسمٍ كاملٍ في مستشفى. ويُعرف الممثّل في كلّ بيتٍ على وجه الأرض، ولا يعرف أحدٌ اسم المرأة التي طوّرت الدواء الذي تعيش به أمُّه. وقد يُسمّي شابٌّ أربعين من المشاهير ولا يُسمّي عالمًا من علماء الشريعة حيًّا واحدًا، ولا باحثًا مسلمًا في العلوم، ولا رجلًا بنى شيئًا.\n\nوهذا انقلاب، ولم يقع علينا، بل نحن بنيناه. فكلُّ ساعةٍ تمنحها لأحدٍ صوتٌ تُدلي به له، وقد أدلينا بهذه الأصوات بالمليارات.\n\nوهذا ما لا يُقال للشباب، فليُقَل هنا صريحًا:\n\nليس المؤثِّر فوقك. وليس أغنى منك لأنه خيرٌ منك أو أذكى أو أحبّ إلى الله، وإنما هو أغنى منك لأنك أنت أعطيتَه ساعاتك. وهذه هي القصّة كلّها، ليس فيها غير هذا. ولستَ جمهوره، بل أنت سلعته: يبيع انتباهك للمعلن ويأخذ المال. وكلُّ دقيقةٍ تنفقها في المشاهدة دقيقةٌ تُودَع في حسابه وتُسحب من حسابك، ولا تستطيع شراء دقيقةٍ واحدةٍ بأيّ ثمن.\n\nفإذا جلستَ في الثانية بعد منتصف الليل تشاهد رجلًا لن تلقاه يتنعّم بعيشٍ لن تناله، فافهم الصفقة على وجهها: هو يُدفع له مقابل وقتك أنت. وأنت الذي يدفع، بالعملة الوحيدة التي ستُسأل عنها: «عن عمره فيمَ أفناه».\n\nثم تأتي الحلقة المفرغة. تقارن ثلاثاءك العاديّ بثلاثين ثانيةً صُوّرت في المحاولة العاشرة، ثم نُقّحت وأُضيفت إليها المؤثّرات ونُشرت، من حياةٍ لا ترى باطنها. وتخسر هذه المقارنة في كلّ مرّة، لأنها صُنعت لتخسرها. فتشعر بالصَّغار، فتعود إلى الهاتف تطلب فيه ما يُنسيك ذلك الشعور. هذه هي الحلقة، وليست مصادفة، بل هي المنتَج يعمل على وجهه الصحيح.\n\nوثمّة أمرٌ آخر ليس بالهيّن: ويتخلّل ذلك كلَّه استخفافٌ يسيرٌ دائم، يسقط عليك قطرةً قطرة: جملةٌ في فيلم، ونكتةٌ في مسلسل، وتعليقٌ تحت كلّ ما هو إسلاميّ، وشخصيّةٌ كُتبت ليُضحَك عليها لأنها تصلّي. فنتشرّبه ونضحك معه ونقول: إنما هو فيلم. وقد وصف الله هذا الموقف بكلماتٍ يكاد القارئ لا يُتمّها في نفَسٍ واحد.",
      quote: {
