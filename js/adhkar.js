...
const ADHKAR = [
  ...
  },
  {
    ...
    arabic: "قُلۡ هُوَ ٱللَّهُ أَحَدٌ … قُلۡ أَعُوذُ بِرَبِّ ٱلۡفَلَقِ … قُلۡ أَعُوذُ بِرَبِّ ٱلنَّاسِ",
  ...
  },
  {
    ...
    arabic: "ٱللَّهُ لَآ إِلَٰهَ إِلَّا هُوَ ٱلۡحَيُّ ٱلۡقَيُّومُۚ …",
  ...
  },
  {
    ...
    arabic: "حَسۡبُنَا ٱللَّهُ وَنِعۡمَ ٱلۡوَكِيلُ",
  ...
  },
  {
    ...
    virtueAr: "هذه الكلمات في القرآن، قالها يونس عليه السلام في الظلمات — سورة الأنبياء (٢١:٨٧)، وقال الله بعدها: ﴿فَٱسۡتَجَبۡنَا لَهُۥ وَنَجَّيۡنَٰهُ مِنَ ٱلۡغَمِّۚ وَكَذَٰلِكَ نُـۨجِي ٱلۡمُؤۡمِنِينَ﴾. وأما الحديث المشهور أنه لم يدعُ بها مسلمٌ في شيءٍ قط إلا استجاب الله له فرواه الترمذي وصحّحه الألباني، وليس في البخاري ولا مسلم، ونُبيّن ذلك.",
