...
const MIRACLES = {
  ...
  "6": [{
    ...
    verse: "وَمَن يُرِدْ أَن يُضِلَّهُۥ يَجْعَلْ صَدْرَهُۥ ضَيِّقًا حَرَجًۭا كَأَنَّمَا يَصَّعَّدُ فِى ٱلسَّمَآءِ",
  ...
  "16": [{
    ...
    verse: "وَأَلْقَىٰ فِى ٱلْأَرْضِ رَوَٰسِىَ أَن تَمِيدَ بِكُمْ",
    verseEn: "And He has cast into the earth firmly set mountains, lest it shift with you",
    says: "Two words are doing the work. أَلْقَى — cast, thrown down INTO the earth, not set upon it. And رَوَاسِيَ — anchors, the same root as a ship's mooring. Read plainly, a mountain here is something driven into the ground and holding, not a heap piled on the surface. Surah An-Naba adds the other half of the picture: أَوْتَادًا, stakes — and most of a stake is the part you cannot see.",
    ...
    grade: "strong",
    caution: "Be careful with the second half. أَن تَمِيدَ بِكُمْ is about the earth being steady underfoot; it is NOT a claim that mountains prevent earthquakes, and the biggest earthquakes happen in exactly the mountain belts. Do not stretch it that way — the stake is the strong part of this card.",
  ...
  "21": [{
    ...
    verse: "أَوَلَمْ يَرَ ٱلَّذِينَ كَفَرُوٓا۟ أَنَّ ٱلسَّمَٰوَٰتِ وَٱلْأَرْضَ كَانَتَا رَتْقًۭا فَفَتَقْنَٰهُمَا ۖ وَجَعَلْنَا مِنَ ٱلْمَآءِ كُلَّ شَىْءٍ حَىٍّ",
  ...
  "24": [{
    ...
    verse: "أَوْ كَظُلُمَٰتٍۢ فِى بَحْرٍۢ لُّجِّىٍّۢ يَغْشَىٰهُ مَوْجٌۭ مِّن فَوْقِهِۦ مَوْجٌۭ مِّن فَوْقِهِۦ سَحَابٌۭ ۚ ظُلُمَٰتٌۢ بَعْضُهَا فَوْقَ بَعْضٍ إِذَآ أَخْرَجَ يَدَهُۥ لَمْ يَكَدْ يَرَىٰهَا",
  ...
  "25": [{
    ...
    verse: "وَهُوَ ٱلَّذِى مَرَجَ ٱلْبَحْرَيْنِ هَٰذَا عَذْبٌۭ فُرَاتٌۭ وَهَٰذَا مِلْحٌ أُجَاجٌۭ وَجَعَلَ بَيْنَهُمَا بَرْزَخًۭا وَحِجْرًۭا مَّحْجُورًۭا",
    ...
    says: "مَرَجَ is to let loose side by side. The two bodies of water are released against each other and meet — and between them is a بَرْزَخ, a partition. Ar-Rahman 19-20 says the same and adds لَا يَبْغِيَانِ: neither overruns the other. So: they meet, and they keep their identity.",
  ...
  "36": [{
    ...
    verse: "وَٱلشَّمْسُ تَجْرِى لِمُسْتَقَرٍّۢ لَّهَا ۚ ذَٰلِكَ تَقْدِيرُ ٱلْعَزِيزِ ٱلْعَلِيمِ",
    ...
    says: "The sun runs — تَجْرِي, a continuous motion of its own — toward a مُسْتَقَرّ, a place or time of settling. Two verses later: each of them, in an orbit, is swimming. The sun is given its own travel, not merely a nightly circuit around the earth.",
    saysAr: "الشمسُ **تَجْرِي** — جريانٌ مستمرٌّ لها هي — إلى **مُسْتَقَرٍّ** أي موضعِ استقرارٍ أو وقتِه. وبعدها بآيتين: **وَكُلٌّ فِي فَلَكٍ يَسْبَحُونَ**. فجُعل للشمس سيرُها الخاصُّ بها، لا مجرّدُ دورةٍ ليليّةٍ حول الأرض.",
  ...
  "51": [{
    ...
    verse: "وَٱلسَّمَآءَ بَنَيْنَٰهَا بِأَيْي۟دٍۢ وَإِنَّا لَمُوسِعُونَ",
    ...
    classicalAr: "ولا بدّ من قول هذا صريحًا. فـ**مُوسِع** في العربية يكثر بمعنى ذي السَّعة والقدرة والجِدَة — كما في قوله تعالى في البقرة: **عَلَى الْمُوسِعِ قَدَرُهُ**. وقد قرأ كثيرٌ من المفسّرين الآية: بنينا السماء بقوّةٍ وإنّا لذَوو سَعةٍ وقدرة. وهي قراءةٌ عربيّةٌ صحيحةٌ قديمة. ومعنى التوسيع قائمٌ في اللغة أيضًا، غير أنه ليس الوجهَ الوحيد، ومن جزم بأنه الوحيدُ لم يفتح معجمًا.",
  ...
  "57": [{
    ...
    verse: "وَأَنزَلْنَا ٱلْحَدِيدَ فِيهِ بَأْسٌۭ شَدِيدٌۭ وَمَنَٰفِعُ لِلنَّاسِ",
  ...
  "86": [{
    ...
    verse: "وَٱلسَّمَآءِ وَٱلطَّارِقِ ۝ وَمَآ أَدْرَىٰكَ مَا ٱلطَّارِقُ ۝ ٱلنَّجْمُ ٱلثَّاقِبُ",
  ...
  "96": [{
    ...
    verse: "كَلَّا لَئِن لَّمْ يَنتَهِ لَنَسْفَعًۢا بِٱلنَّاصِيَةِ ۝ نَاصِيَةٍۢ كَٰذِبَةٍ خَاطِئَةٍۢ",
