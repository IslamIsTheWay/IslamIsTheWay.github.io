      ...
      items: [
        {
          ...
          exampleAr: "وليس الترتيبُ من ترتيب أهل العلم، بل نصّ عليه القرآنُ مرّتين داخل آيتي المواريث نفسِهما: ففي النساء ١١ و١٢ تُذكر الأنصبةُ ثم يُقال ﴿مِنۢ بَعۡدِ وَصِيَّةٖ يُوصِي بِهَآ أَوۡ دَيۡنٍۗ﴾. فذكر سبحانه الأنصبة وقدّم عليها اثنين في الجملة نفسها.\n\nوأثرُ ذلك عمليًّا هو الذي تُخطئ فيه الأُسرُ أكثر: فدَينُ الأب ليس شأنًا خاصًّا بالورثة يقضونه لاحقًا أو يُسقطونه في صمت، وإنما هو حقٌّ في التركة؛ فمن قسم قبل قضائه فكلُّ نصيبٍ قسمه خطأ.",
          ...
          proofAr: "يُوصِيكُمُ ٱللَّهُ فِيٓ أَوۡلَٰدِكُمۡۖ ... مِنۢ بَعۡدِ وَصِيَّةٖ يُوصِي بِهَآ أَوۡ دَيۡنٍۗ ءَابَآؤُكُمۡ وَأَبۡنَآؤُكُمۡ لَا تَدۡرُونَ أَيُّهُمۡ أَقۡرَبُ لَكُمۡ نَفۡعٗاۚ فَرِيضَةٗ مِّنَ ٱللَّهِۗ",
      ...
      items: [
        {
          ...
          proofAr: "وَلَكُمۡ نِصۡفُ مَا تَرَكَ أَزۡوَٰجُكُمۡ إِن لَّمۡ يَكُن لَّهُنَّ وَلَدٞۚ فَإِن كَانَ لَهُنَّ وَلَدٞ فَلَكُمُ ٱلرُّبُعُ ... وَلَهُنَّ ٱلرُّبُعُ مِمَّا تَرَكۡتُمۡ إِن لَّمۡ يَكُن لَّكُمۡ وَلَدٞۚ فَإِن كَانَ لَكُمۡ وَلَدٞ فَلَهُنَّ ٱلثُّمُنُ مِمَّا تَرَكۡتُمۚ",
      ...
      items: [
        {
          ...
          exampleAr: "والخطوةُ التي تُسقطها الأُسر هي الثانية: يأخذون التركة فيقسمونها على الأولاد ﴿لِلذَّكَرِ مِثۡلُ حَظِّ ٱلۡأُنثَيَيۡنِۚ﴾، ثم يعطون الأمَّ شيئًا على وجه الإحسان. وليس ذلك نصيبها؛ فنصيبُها مقدَّمٌ ومقدَّر. والعملُ على غير الترتيب يُخرج عددًا يبدو كريمًا وهو ناقص.",
        ...
        },
        {
          ...
          proofAr: "وَلۡيَخۡشَ ٱلَّذِينَ لَوۡ تَرَكُواْ مِنۡ خَلۡفِهِمۡ ذُرِّيَّةٗ ضِعَٰفًا خَافُواْ عَلَيۡهِمۡ فَلۡيَتَّقُواْ ٱللَّهَ وَلۡيَقُولُواْ قَوۡلٗا سَدِيدًا",
          ...
          noteAr: "وأعد النظر في آيةِ ﴿وَلۡيَخۡشَ﴾، فقد وُضعت بين آيات المواريث قصدًا: فليست تقول «أنصفوا اليتامى»، وإنما تقول: تصوّر أنهم أولادُك تركتهم ضعافًا، ثم اعمل من هذا الموضع. فالحكمُ يُلزمك بأن تبادل مكانك بمكان من قد تظلمه.",
          link: "#sd-self",
        ...
        },
        {
          ...
          proofAr: "إِنِ ٱمۡرُؤٌاْ هَلَكَ لَيۡسَ لَهُۥ وَلَدٞ وَلَهُۥٓ أُخۡتٞ فَلَهَا نِصۡفُ مَا تَرَكَۚ وَهُوَ يَرِثُهَآ إِن لَّمۡ يَكُن لَّهَا وَلَدٞۚ ... وَإِن كَانُوٓاْ إِخۡوَةٗ رِّجَالٗا وَنِسَآءٗ فَلِلذَّكَرِ مِثۡلُ حَظِّ ٱلۡأُنثَيَيۡنِۗ يُبَيِّنُ ٱللَّهُ لَكُمۡ أَن تَضِلُّواْۗ",
      ...
      items: [
        {
          ...
          exampleAr: "وثَمَّ أمرٌ رابع، وليس حجاجًا وإنما هو مراجعة: أنّ القرآن افتتح البابَ كلَّه بتقرير أنّ النساء يرثن أصلًا، وقرّره في مجتمعٍ لم يكنّ يرثن فيه: ﴿لِّلرِّجَالِ نَصِيبٞ مِّمَّا تَرَكَ ٱلۡوَٰلِدَانِ وَٱلۡأَقۡرَبُونَ وَلِلنِّسَآءِ نَصِيبٞ مِّمَّا تَرَكَ ٱلۡوَٰلِدَانِ وَٱلۡأَقۡرَبُونَ مِمَّا قَلَّ مِنۡهُ أَوۡ كَثُرَۚ نَصِيبٗا مَّفۡرُوضٗا﴾.\n\nفاقرأها في مقابل ما قبلها تتبيّن الوجهةُ بلا لبس. وبهذا يظهر أنّ الشكوى الصادقة في أكثر أُسرنا ليست في النسبة أصلًا، وإنما في أنّ البنات لا يُعطَين شيئًا — والآيةُ التي تحرّم ذلك هي الآيةُ التي يُنقل منها ذكرُ النسبة.",
          ...
          proofAr: "لِّلرِّجَالِ نَصِيبٞ مِّمَّا تَرَكَ ٱلۡوَٰلِدَانِ وَٱلۡأَقۡرَبُونَ وَلِلنِّسَآءِ نَصِيبٞ مِّمَّا تَرَكَ ٱلۡوَٰلِدَانِ وَٱلۡأَقۡرَبُونَ مِمَّا قَلَّ مِنۡهُ أَوۡ كَثُرَۚ نَصِيبٗا مَّفۡرُوضٗا",
        ...
        },
        {
          ...
          proofAr: "تِلۡكَ حُدُودُ ٱللَّهِۚ وَمَن يُطِعِ ٱللَّهَ وَرَسُولَهُۥ يُدۡخِلۡهُ جَنَّٰتٖ تَجۡرِي مِن تَحۡتِهَا ٱلۡأَنۡهَٰرُ ... وَمَن يَعۡصِ ٱللَّهَ وَرَسُولَهُۥ وَيَتَعَدَّ حُدُودَهُۥ يُدۡخِلۡهُ نَارًا",
