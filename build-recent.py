...
AREAS = [
    ...
    dict(id="treasure", icon="⛰️", paths=["js/treasure.js"],
         title="The mountain of gold",
         blurb="What the Prophet ﷺ said about the Euphrates uncovering a mountain of gold; where it could be — the river itself, or the melting ice of the North; why the whole world would fight over it even knowing the hadith; and what we are told to do. The hadith is marked as certain, and every reading is marked as a reading.",
         href="judgement.html#treasure", cta="Read it"),
